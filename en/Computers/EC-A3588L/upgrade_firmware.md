...
The EC-A3588L enclosure has no reserved Recovery button, so there is no hardware way to enter Loader mode.
...
[EC-A3588L firmware]: https://community.t-firefly.com/en/doc/download/161

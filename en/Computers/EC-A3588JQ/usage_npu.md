...
Run yolov5 demo on the EC-A3588JQ as follows:
```shell
...
#### Run on EC-A3588JQ NPU connected to the PC

RKNN Toolkit2 runs on the PC and connects to the EC-A3588JQ through the PC's USB. RKNN Toolkit2 transfers the RKNN model to the NPU device of EC-A3588JQ to run, and then obtains the inference results, performance information, etc. from the EC-A3588JQ


* First prepare EC-A3588JQ environment: update librknnrt.so and run rknn_server

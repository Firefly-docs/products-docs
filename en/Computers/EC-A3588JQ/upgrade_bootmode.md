...
The EC-A3588JQ is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

EC-A3588JQ has a flexible startup mode. Generally, the EC-A3588JQ development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://en.t-firefly.com/doc/download/161.html)


## Upgrade method
EC-A3588JQ supports firmware update through the following two methods:
...
EC-A3588JQ has three startup modes:

...
## RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto EC-A3588JQ.
...
```
#### Deploy And Run The RKLLM Model On EC-A3588JQ.
...
./build-linux.sh
```
##### Running Inference On EC-A3588JQ

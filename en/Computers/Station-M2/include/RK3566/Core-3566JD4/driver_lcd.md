...
![](../../img/Station-M2/lcd_interface.jpg)

## Config Configuration

In ROC-RK3566-PC SDK, the default configuration file `kernel/arch/arm64/configs/firefly_defconfig` of Station-M2 has already set the LCD-related configuration. If you modify it yourself, please pay attention to it. The following configuration is added:
```

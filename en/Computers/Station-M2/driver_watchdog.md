...
Station-M2 has a internal watchdog and a external watchdog. The model of the external watchdog is PC9202.
...
3. Now <font color=red>Station-M2 v1.0</font> version, external watchdog cannot be closed in software way after it is enabled, you need to cut the power

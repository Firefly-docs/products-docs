...
* ROC-RK3568-PCSE development board
* Firmware
* host computer
* TYPE-C data cable
...
2. Press and hold the earphone hole on EC-R3568PC with a pin tool
...
<img alt="" src="../../../rk356x_img/EC-R3568PC/maskrom_test_points.jpg" width="700">
</center>
...
1. Disconnect the device from the power supply
2. Press and hold the Recovery hole on EC-R3568PC with a pin tool
3. The device is plugged into the power supply and powered on
...
[EC-R3568PC firmware]: https://community.t-firefly.com/en/doc/download/162

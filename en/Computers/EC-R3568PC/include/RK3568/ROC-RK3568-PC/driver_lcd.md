...
Under ROC-RK3568-PCSE SDK, the default configuration file `kernel/arch/arm64/configs/firefly_defconfig` of EC-R3568PC has already set the LCD-related configuration. If you modify it yourself, please pay attention to it. The following configuration is added:
```
...
ROC-RK3568-PCSE SDK has MIPI DSI DTS file:
...
### Pin Configuration
ROC-RK3568-PCSE SDK has EDP DSI DTS file: `kernel/arch/arm64/boot/dts/rockchip/rk3568-firefly-roc-pc-edp_M156X40.dts`, we can see the following statement from this file:
```
{
    ...
    edp_panel: edp-panel {

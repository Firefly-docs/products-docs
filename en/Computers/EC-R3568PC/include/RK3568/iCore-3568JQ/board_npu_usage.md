...
Run demo on the ROC-RK3568-PCSE as follows:
```shell
...
#### Run on ROC-RK3568-PCSE NPU connected to the PC

RKNN Toolkit2 runs on the PC and connects to the ROC-RK3568-PCSE through the PC's USB. RKNN Toolkit2 transfers the RKNN model to the NPU device of ROC-RK3568-PCSE to run, and then obtains the inference results, performance information, etc. from the ROC-RK3568-PCSE


* First prepare ROC-RK3568-PCSE environment: update librknnrt.so and run rknn_server

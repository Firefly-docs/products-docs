...
1. ROC-RK3568-PCSE Connect the device and host with TYPE-C data cable;
...
![](../../../rk356x_img/EC-R3568PC/otg_interface.jpg)

### Network the ADB

* `Setting` -> `Developer Option` -> `ADB over network`

check the EC-R3568PC IP address, Use command under the PC:

...
<font color=#ff0000>**Note:** The default baud rate of ROC-RK3568-PCSE is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
ROC-RK3568-PCSE serial port connection diagram:

<center>

<img alt="" src="../../../rk356x_img/EC-R3568PC/debug_connection.jpg" width="800">
</center>

## Parameter Setting

ROC-RK3568-PCSE use the following serial parameters:

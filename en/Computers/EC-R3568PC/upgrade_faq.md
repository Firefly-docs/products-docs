...
**A:** The ROC-RK3568-PCSE has three boot modes:
...
Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/162#other_536), and install it into the system as follows for easy invocation:

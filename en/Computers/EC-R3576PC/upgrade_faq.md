...
**A:** The EC-R3576PC has three boot modes:
...
The EC-R3576PC does not expose a MaskRom key on the enclosure. You need to open the host, press and hold the MaskRom key on the mainboard, and then power on
<center>

...
Run yolov5 demo on the EC-R3576PC as follows:
```shell
...
#### Run on EC-R3576PC NPU connected to the PC

RKNN Toolkit2 runs on the PC and connects to the EC-R3576PC through the PC's USB. RKNN Toolkit2 transfers the RKNN model to the NPU device of EC-R3576PC to run, and then obtains the inference results, performance information, etc. from the EC-R3576PC


* First prepare EC-R3576PC environment: update librknnrt.so and run rknn_server

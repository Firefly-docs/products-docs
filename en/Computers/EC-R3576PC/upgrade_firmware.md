...
* [Firmware](https://community.t-firefly.com/en/doc/download/254)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/254). There are two types of firmware files:
...
2. Press and hold the MaskRom hole on EC-R3576PC with a pin tool

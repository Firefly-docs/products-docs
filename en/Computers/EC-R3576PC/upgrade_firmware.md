...
* [Firmware](https://community.t-firefly.com/en/doc/download/229)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/229). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/229), extract, and then run the DriverInstall.exe inside . 
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/229)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/229), And install it into the system as follows for easy invocation:
...
* [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/229)

Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/229), And install it into the system as follows for easy invocation:

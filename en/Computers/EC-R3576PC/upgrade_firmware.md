...
* [Firmware](https://en.t-firefly.com/doc/download/229.html)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://en.t-firefly.com/doc/download/229.html). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://en.t-firefly.com/doc/download/229.html#other_11), extract, and then run the DriverInstall.exe inside . 
...
* [Linux_Upgrade_Tool](https://en.t-firefly.com/doc/download/229.html#other_502)

Download [Linux_Upgrade_Tool](https://en.t-firefly.com/doc/download/229.html#other_502), And install it into the system as follows for easy invocation:
...
* [Linux_adb_fastboot](https://en.t-firefly.com/doc/download/229.html#other_565)

Download [Linux_adb_fastboot](https://en.t-firefly.com/doc/download/229.html#other_565), And install it into the system as follows for easy invocation:

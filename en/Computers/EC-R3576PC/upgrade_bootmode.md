...
The EC-R3576PC is installed with the one kind of operating system by default. If users want to run other operating systems, they need to download the corresponding firmware to the mainboard.

EC-R3576PC has a flexible startup mode. Generally, the EC-R3576PC development board will not turn brick unless the hardware is damaged.
...
## Upgrade method
EC-R3576PC supports firmware update through the following two methods:
...
EC-R3576PC has three startup modes:

...
In order to facilitate user development, roc-3399-pc-plus introduces two channels such as UART0 and UART4 (reuse with SPI1) on the double-row extension interface of the board. 
...
GPS [wireless module](module_wireless.md) will occupy UART0, so GPS function should be disabled when using UART0 as ordinary serial port.

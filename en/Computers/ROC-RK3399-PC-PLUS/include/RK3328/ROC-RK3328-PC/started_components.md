...
[ROC-RK3328-PC], the first credit card sized and affordable open source main board honored by Firefly, features:

![](../../../rk3399_img/ROC-RK3399-PC-PLUS/hw_board_interface_top_zh_CN.jpg)
...
- Connectivity
	...
	+ 2.4G WIFI and Bluetooth V4.2 combo module
    + 1 x IR Receiver Module, supports self-defined IR remote
    + 26 pin expansion interface, contains GPIO, I2S, I2C, UART, PWM , DEBUG , SARADC
- Display
...
[ROC-RK3328-PC] standard kit contains the following items:

- ROC-RK3328-PC main board
- USB Type-C cable
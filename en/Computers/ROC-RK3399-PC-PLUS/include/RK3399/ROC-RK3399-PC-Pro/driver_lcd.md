...
ROC-RK3399-PC-PLUS development board supports two LCD screen interfaces by default, one is MIPI (Maximum resolution support 2560x1600@60fps), the other is EDP(Maximum resolution support 2K@60fps). The positions of interfaces on the board are shown as follows:
...
A backlight interface is set outside the ROC-RK3399-PC-PLUS development board to control the backlight of the screen.

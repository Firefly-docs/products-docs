...
**A:** The ROC-RK3576-PC has three boot modes:
...
![AndroidTool upgrade tool interface](../../../rk3576_img/common/upgrade_firmware_androidtool_zh.png)
</center>
...
The ROC-RK3576-PC does not expose a MaskRom key on the enclosure. You need to open the host, disconnect the power supply, press and hold the MaskRom key on the ROC-RK3576-PC mainboard and then power on. Release the key after a few seconds.

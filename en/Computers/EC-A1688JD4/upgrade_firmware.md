...
1. Download the official SDK package (can be downloaded directly from the Firefly [download page](https://www.t-firefly.com/doc/download/250.html)), which includes 4 compressed packages:

...
* When flashing, AIBOX-PRO-3588 will format the internal storage device, please back up important data first.
...
## Put AIBOX-PRO-3588 into Force Recovery Mode
* Ensure that AIBOX-PRO-3588 is powered off
* Connect AIBOX-PRO-3588 and PC using TypeC
* Press and hold down AIBOX-PRO-3588 Recovery-Key
* AIBOX-PRO-3588 power on
* Release AIBOX-PRO-3588 Recovery-Key
* Check AIBOX-PRO-3588 Recovery Mode
    * use `lsusb` comand, AIBOX-PRO-3588 is in Force Recovery Mode if you see the message: `Bus <bbb> Device <ddd>: ID 0955: <nnnn> Nvidia Corp.`

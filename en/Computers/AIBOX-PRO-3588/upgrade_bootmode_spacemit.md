...
The AIBOX-PRO-3588 comes pre-installed with Linux. If the user wants to run other operating systems, the corresponding firmware needs to be flashed onto the motherboard.

The AIBOX-PRO-3588 offers flexible boot options. Generally, unless there is hardware damage, the AIBOX-PRO-3588 development board will not become bricked.
...
* [Download](https://en.t-firefly.com/doc/download/333.html)

## Upgrade Method

AIBOX-PRO-3588 supports firmware upgrades via the following methods:
...
AIBOX-PRO-3588 Load the system from the following storage:
...
AIBOX-PRO-3588 has the following boot modes:

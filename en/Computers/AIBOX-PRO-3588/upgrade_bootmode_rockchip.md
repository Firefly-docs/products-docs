...
The AIBOX-PRO-3588 is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIBOX-PRO-3588 has a flexible startup mode. Generally, the AIBOX-PRO-3588 development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://en.t-firefly.com/doc/download/333.html)


## Upgrade method
AIBOX-PRO-3588 supports firmware update through the following two methods:
...
AIBOX-PRO-3588 has three startup modes:

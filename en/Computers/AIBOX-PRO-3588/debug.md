...
You can use an RS232 to USB adapter to connect AIBOX-PRO-3588 to a PC for serial port debugging:

![](../../../aibox_img/AIBOX-PRO-3588/rs232_connection.png)

### Serial parameter configuration

AIBOX-PRO-3588 uses the following serial port parameters:
...
**Note:** The default baud rate for AIBOX-PRO-3588 is 115200.
...
AIBOX-PRO-3588 DEBUG port:

![](../../../aibox_img/AIBOX-PRO-3588/debug_connection.png)

...
* AIBOX PRO
* [Firmware](https://community.t-firefly.com/en/doc/download/414)
* host computer
* Type-C Cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/414). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/414), extract, and then run the DriverInstall.exe inside . 
...
<center>
<img alt="" src="../../../aibox_img/AIBOX-PRO/upgrade_firmware_androidtool_zh.png" width="800">
</center>
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/414)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/414), And install it into the system as follows for easy invocation:
...
<center>
<img alt="" src="../../../aibox_img/AIBOX-PRO/AIBOX-PRO-OTG.png" width="700">
</center>
...
<center>
<img alt="" src="../../../aibox_img/AIBOX-PRO/upgrade_firmware_new_equipment.jpg" width="800">
</center>
...
<center>
<img alt="" src="../../../aibox_img/AIBOX-PRO/maskrom.png" width="700">
</center>

The device will then enter MaskRom mode.

<center>
<img alt="" src="../../../aibox_img/AIBOX-PRO/upgrade_maskrom_zh.png" width="800">
</center>
...
<center>
<img alt="" src="../../../aibox_img/AIBOX-PRO/upgrade_firmware_erase_flash_zh.png" width="800">
</center>

...
The AIBOX-PRO is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIBOX-PRO has a flexible startup mode. Generally, the AIBOX-PRO development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/420.html)


## Upgrade method
AIBOX-PRO supports firmware update through the following two methods:
...
AIBOX-PRO has three startup modes:

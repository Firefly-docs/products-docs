...
This section will show you how to use watchdog on AIO-3576C. 

## DTS configuration

The watchdog node of AIO-3576C defined in `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi`, as showm below:

```
 wdt: watchdog@2ace0000 {
	  compatible = "snps,dw-wdt";
	  reg = <0x0 0x2ace0000 0x0 0x100>;
	  clocks = <&cru 168>, <&cru 167>;

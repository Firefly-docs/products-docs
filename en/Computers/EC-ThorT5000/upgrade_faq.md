...
The firmware package can be obtained from the Firefly [Download Page](https://community.t-firefly.com/en/doc/download/346).

## Q: How to put the device into Recovery mode?

**A:** Follow these steps:

* Power off the EC-ThorT5000 first
* Connect the OTG port of the EC-ThorT5000 to the PC using a Type-C cable
* Press and hold the Recovery key of the EC-ThorT5000
* Power on the EC-ThorT5000
* Release the Recovery key of the EC-ThorT5000

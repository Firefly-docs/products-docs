...
EC-ThorT5000 development BOARD uses TT8563RH as RTC(*Real Time Clock*), TT8563RH is a low power CMOS real-time Clock/calendar chip, it provides a programmable Clock output, an interrupt Output and a power down detector, all addresses and data are passed serially through the I2C bus interface.
...
EC-ThorT5000 has a capacitor to supply power to the RTC as shown in the following figure to ensure that the RTC runs in a short time.

![](../../../nvidia_img/EC-ThorT5000/usage_rtc_capacitor.jpg)
...
Linux provides three user-space call interfaces. The corresponding path in the EC-ThorT5000 development board is:

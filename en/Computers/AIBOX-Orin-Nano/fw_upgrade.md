...
AIBOX-Orin Nano uses TF card to upgrade firmware, users need to strictly follow the steps below.
...
(3) Insert the TF card into the TF card slot of AIBOX-Orin Nano, and then turn on the power;

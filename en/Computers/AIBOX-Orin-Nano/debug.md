...
You can use an RS232 to USB adapter to connect AIBOX-OrinNano to a PC for serial port debugging:

![](../../../aibox_img/AIBOX-Orin-Nano/rs232_connection.png)

### Serial parameter configuration

AIBOX-Orin-Nano uses the following serial port parameters:
...
![](../../../aibox_img/debug_set_MobaXterm1.PNG)
![](../../../aibox_img/debug_set_MobaXterm2.PNG)
...
**Note:** The default baud rate for AIBOX-Orin-Nano is 115200.
...
AIBOX-OrinNano DEBUG port:

![](../../../aibox_img/AIBOX-Orin-Nano/debug_connection.png)

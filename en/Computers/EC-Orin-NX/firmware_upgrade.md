...
![](../../../bm1688_img/EC-Orin-NX/RecoveryKey.png)
...
You can directly download it from Firefly [Download Page](https://en.t-firefly.com/doc/download/233.html)

After downloading, perform tar decompression:
```
tar xf orin-nx-16g.tar.gz
```
or 
```
tar xf orin-nx-8g.tar.gz
```
...
[Download](https://en.t-firefly.com/doc/download/233.html)
<br>

...
<font color=#ff0000>**Note:** The default baud rate of IHC-3308GW is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
IHC-3308GW serial port connection diagram:

![](../../../rk3308_img/IHC-3308GW/debug_connection.jpg)

## Parameter Setting

IHC-3308GW use the following serial parameters:

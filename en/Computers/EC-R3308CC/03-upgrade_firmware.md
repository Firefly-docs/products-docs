...
* Tool: [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/102)

### Install RK USB drive

Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/102), extract, and then run the DriverInstall.exe inside .
...
* Connect the device and the host with the Type-C data cable
...
Download [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/102). AndroidTool defaults to display in Chinese. We need to change it to English. Open `config.ini` with an text editor (like notepad). The starting lines are:
...
1. Use metal tweezers to connect and hold the two test points as shown in the following figure on EC-R3308CC (as shown in the figure below).
1. Plug the device into the power supply.
1. Wait a moment, then loosen the tweezers.

<center>

<img alt="" src="../../../rk3308_img/EC-R3308CC/maskrom_test_points.png" width="700">
</center>
...
* Tool : [upgrade_tool_xxx (version number)](https://community.t-firefly.com/en/doc/download/102)


### Upgrade_tool

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/102), And install it into the system as follows for easy invocation:
...
[EC-R3308CC firmware]: https://community.t-firefly.com/en/doc/download/102
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/102#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/102#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/102#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/102#linux_12

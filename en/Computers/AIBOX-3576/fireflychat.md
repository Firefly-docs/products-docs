...
## Installation
Note: The system firmware of AIBOX-3576 has preconfigured FireflyChat and imported the basic model. You can use it directly.If FireflyChat does not exist in the firmware, you can download the corresponding [AI firmware](https://community.t-firefly.com/en/doc/download/page/id/241.html) or install FireflyChat yourself.

You need to obtain the required installation package from the [Download Center](https://community.t-firefly.com/en/doc/download/page/id/241.html) to install FireflyChat. There are two installation packages, which are `fireflychat_x.x.x_arm64.deb` and `libfirefly-ai_x.x.x_arm64.deb`.
...
Users can obtain the model files (.rkllm) provided by the Firefly team from the LLM model resource in the [Download Center](https://community.t-firefly.com/en/doc/download/page/id/241.html).
...
[Download Center]: https://community.t-firefly.com/en/doc/download/page/id/241.html
...
<img alt="" src="../../../aibox_img/fireflychat.png" width="800">
</center>
...
You need to obtain the required installation package from the [Download Center](https://community.t-firefly.com/en/doc/download/268) to install FireflyChat. There are two installation packages, which are `fireflychat_x.x.x_arm64.deb` and `libfirefly-ai_x.x.x_arm64.deb`.
...
Users can obtain the model files (.rkllm) provided by the Firefly team from the LLM model resource in the [Download Center](https://community.t-firefly.com/en/doc/download/268).
...
[Download Center]: https://community.t-firefly.com/en/doc/download/268
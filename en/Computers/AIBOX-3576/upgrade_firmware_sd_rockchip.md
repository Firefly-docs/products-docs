...
* USB Card Reader 
* MIrcoSD card
* [**SD_Firmware_Tool**](https://community.t-firefly.com/en/doc/download/page/id/241.html#other_499)
## Operation Steps
...
* Choose firmware we want to upgrade into the AIBOX-3576
* Click  button `Create` to make it and wait until it is finshed


<center>

![](../../../aibox_img/AIBOX-3576/upgrade_firmware_sd_tool_zh.png)

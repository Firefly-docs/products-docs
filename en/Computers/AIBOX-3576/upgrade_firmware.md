...
* AIBOX-3576
* [Firmware](https://community.t-firefly.com/en/doc/download/268)
* host computer
* Type-C Cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/268). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/268), extract, and then run the DriverInstall.exe inside . 
...
<img alt="" src="../../../aibox_img/AIBOX-3576/upgrade_firmware_androidtool_zh.png" width="800">
</center>
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/268)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/268), And install it into the system as follows for easy invocation:
...
<img alt="" src="../../../aibox_img/AIBOX-3576/upgrade_firmware_new_equipment.jpg" width="800">
</center>
...
<img alt="" src="../../../aibox_img/AIBOX-3576/upgrade_firmware_erase_flash_zh.png" width="800">
</center>
...
<img alt="" src="../../../aibox_img/AIBOX-3576/upgrade_firmware_download_fail.png" width="800">
</center>

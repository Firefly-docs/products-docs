...
This article describes how to upgrade the firmware file on the host to the flash memory of AIBOX-3576 through the Type-C Cable. When upgrading, you need to choose the appropriate upgrade mode according to the host operating system and firmware type.

## Preparatory Tools

* AIBOX-3576
* [Firmware](https://community.t-firefly.com/en/doc/download/page/id/241.html)
* host computer
* Type-C Cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/page/id/241.html). There are two types of firmware files:
...
### Loader mode
AIBOX-3576 only support software way enter the Loader mode.

#### Software way into Loader mode

Type-C data cable is connected, use the command in the serial debugging terminal:

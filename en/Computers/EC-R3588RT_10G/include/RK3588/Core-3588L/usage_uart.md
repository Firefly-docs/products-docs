...
EC-R3588RT_10G The following figure shows the serial port of the hardware version：

![](../../../rk3588_img/EC-R3588RT_10G/usage_uart_interface.png)

## DTS config

File path `kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588l.dtsi`
There is one M.2 SATA interface on the development board EC-R3588RT_10G 

...
EC-R3588RT_10G has one RS232 interfaces and one RS485 interface

The serial interface diagram of the EC-R3588RT_10G development board is as follows:

![](../../../rk3588_img/EC-R3588RT_10G/usage_uart_interface.jpg)
...
Users can use different host's USB-to-serial adapters to send and receive data to the serial port of the development board according to different interfaces. For example, the debugging steps of RS485 are as follows(EC-R3588RT_10G RS485 is half-duplex and requires gpio to control transmission and reception):

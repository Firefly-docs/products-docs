...
The EC-R3588RT_10G is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

EC-R3588RT_10G has a flexible startup mode. Generally, the EC-R3588RT_10G development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://en.t-firefly.com/doc/download/207.html)


## Upgrade method
EC-R3588RT_10G supports firmware update through the following two methods:
...
EC-R3588RT_10G has three startup modes:

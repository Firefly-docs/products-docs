...
The firmware package can be obtained from the Firefly [Download Page](https://community.t-firefly.com/en/download/234).

## Q: How to put the device into Recovery mode?

**A:** Follow these steps:

* Power off the AIO-OrinNano first
* Connect the OTG port of the AIO-OrinNano to the PC using a Type-C cable
* Press and hold the Recovery key of the AIO-OrinNano
* Power on the AIO-OrinNano
* Release the Recovery key of the AIO-OrinNano

...
![](../../../rk3399_img/Station-P1-Pro/spi_interface.jpg)
...
The hardware connection between Station P1 Pro and W25Q128FV is shown in the following table:

![](../../../rk3399_img/Station-P1-Pro/spi_hardware_connection.jpg)
...
* **spi-max-frequency :** set the highest frequency used by spi here. Station P1 Pro supports up to 48000000.
...
Linux provides a SPI user interface with limited functionality. If IRQ or other kernel driver interfaces are not required, consider using `spidev` interface to write user-level programs to control SPI devices. The corresponding path in the Station P1 Pro development board is `/dev/spidev0.0`.

...
<font color=#ff0000>**Note:** The default baud rate of Station P1 Pro is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
Station P1 Pro serial port connection diagram:

![](../../../rk3399_img/Station-P1-Pro/debug_connection.jpg)

## Parameter Setting

Station P1 Pro use the following serial parameters:

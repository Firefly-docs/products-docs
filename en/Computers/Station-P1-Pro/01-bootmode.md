...
The Station P1 Pro is installed with the Android operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

Station P1 Pro has a flexible startup mode. Generally, the Station P1 Pro development board will not turn brick unless the hardware is damaged.
...
Station P1 Pro supports firmware update through the following two methods:
...
Station P1 Pro  has three startup modes:

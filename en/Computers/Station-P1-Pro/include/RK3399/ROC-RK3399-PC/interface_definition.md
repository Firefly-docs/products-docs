...
## Station-P1-Pro interface definition

Station-P1-Prois a mini PC motherboard, the size is only the size of a small mobile phone, but it provides a rich interface, including:

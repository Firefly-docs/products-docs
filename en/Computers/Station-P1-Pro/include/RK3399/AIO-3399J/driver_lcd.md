...
The Station-P1-Pro development board is equipped with two LCD screen interfaces, one is EDP and the other is LVDS. The positions of the interfaces on the board are as follows:
...
Station-P1-Pro SDK has LVDS DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399-firefly-aio-lvds.dts, we can see the following statement from this file:
```
/ {

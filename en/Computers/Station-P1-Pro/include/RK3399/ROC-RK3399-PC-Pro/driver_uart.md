...
In order to facilitate user development, Station P1 Pro introduces two channels such as UART4 (reuse with SPI1) on the double-row extension interface of the board. 

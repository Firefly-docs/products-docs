...
**Note: Since the  the Hardware iteration version of Station P1 Pro is [ROC-RK3399-PC Pro](https://wiki.t-firefly.com/en/ROC-RK3399-PC-Pro/started.html), so the compilation method of software is consistent. Finally the generated firmware, such as ROC-RK3399-PC-Pro_xxx.img is compatible with Station P1 Pro.**

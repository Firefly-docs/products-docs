...
The EC-R3588SPC is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

EC-R3588SPC has a flexible startup mode. Generally, the EC-R3588SPC development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/182)


## Upgrade method
EC-R3588SPC supports firmware update through the following two methods:
...
EC-R3588SPC has three startup modes:

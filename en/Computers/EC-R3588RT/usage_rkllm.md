...
## RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto EC-R3588RT.
...
```
#### Deploy And Run The RKLLM Model On EC-R3588RT.
...
./build-linux.sh
```
##### Running Inference On EC-R3588RT

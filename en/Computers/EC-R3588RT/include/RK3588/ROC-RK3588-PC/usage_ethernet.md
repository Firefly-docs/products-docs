...
Currently EC-R3588RT only supports 1 Gigabit port (Ethernet0), but a second Gigabit port (Ethernet1) can be extended via the 164 Pin interface.  


![](../../../rk3588_img/EC-R3588RT/usage_ethernet_interface.jpg)

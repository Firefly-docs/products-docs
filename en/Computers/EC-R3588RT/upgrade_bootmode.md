...
The EC-R3588RT is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

EC-R3588RT has a flexible startup mode. Generally, the EC-R3588RT development board will not turn brick unless the hardware is damaged.
...
## Upgrade method
EC-R3588RT supports firmware update through the following two methods:
...
EC-R3588RT has three startup modes:

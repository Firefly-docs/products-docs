...
![](../../../rk3576_img/EC-R3576PC-FD/upgrade_recovery.jpg)

* Connect to the power supply.
* About two seconds later, release the `RECOVERY` button.


##### CAM-3576Q38 as an example:

* CAM-3576Q38 does not able to enter loader mode in hardware way
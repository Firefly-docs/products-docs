...
## ROC-RK3576-PC Displays the configuration of the interface

 ROC-RK3576-PC  There are three display output interfaces, namely HDMI, Display Port and MIPI DSI, which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* HDMI/ Display Port/ MIPI DSI 

![](../../../rk3576_img/EC-R3576PC-FD/usage_display_interface.jpg)   
...
ROC-RK3576-PC There are two MIPI DSI display output interfaces, both support DPHY2.0 and 4 Lane data output, and can output up to 2560x1600@120Hz (depending on the connected Portx).
...
* DSI interface
![](../../../rk3576_img/EC-R3576PC-FD/usage_display_mipi_v2_interface.png)

...
* [Firmware](https://en.t-firefly.com/doc/download/231.html)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://en.t-firefly.com/doc/download/231.html). There are two types of firmware files:

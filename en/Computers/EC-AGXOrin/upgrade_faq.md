...
The firmware package can be obtained from the Firefly [Download Page](https://community.t-firefly.com/en/download/348).

## Q: How to put the device into Recovery mode?

**A:** Follow these steps:

* Power off the EC-AGXOrin first
* Connect the OTG port of the EC-AGXOrin to the PC using a Type-C cable
* Press and hold the Recovery key of the EC-AGXOrin
* Power on the EC-AGXOrin
* Release the Recovery key of the EC-AGXOrin

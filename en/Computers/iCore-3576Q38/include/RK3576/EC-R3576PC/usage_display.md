...
## EXT-iCore-3576Q38 Displays the configuration of the interface
 ...
 EXT-iCore-3576Q38  There are three display output interfaces, namely HDMI, Display Port , which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* HDMI/ Display Port/ MIPI DSI 

![](../../../rk3576_img/iCore-3576Q38/usage_display_interface.png)

...
* [Firmware](https://en.t-firefly.com/doc/download/142.html)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://en.t-firefly.com/doc/download/142.html). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://en.t-firefly.com/doc/download/142.html#other_11), extract, and then run the DriverInstall.exe inside . 
...
You can also download [AndroidTool](https://en.t-firefly.com/doc/download/142.html#other_500) separately, unzip it, and run `RKDevTool.exe` in the `RKDevTool_Release_v2.xx` directory (note that if you are running Windows 7/8, you need to right-click and select Run as administrator), as shown below:
...
* [Linux_Upgrade_Tool](https://en.t-firefly.com/doc/download/142.html#other_502)

Download [Linux_Upgrade_Tool](https://en.t-firefly.com/doc/download/142.html#other_502), And install it into the system as follows for easy invocation:
...
* [Linux_adb_fastboot](https://en.t-firefly.com/doc/download/142.html#other_565)

Download [Linux_adb_fastboot](https://en.t-firefly.com/doc/download/142.html#other_565), And install it into the system as follows for easy invocation:
...
![](../../../rk3588_img/EC-R3588SPC-FD/upgrade_otg_interface.jpg)

* Press the `RECOVERY` button on the device and hold.
![](../../../rk3588_img/EC-R3588SPC-FD/upgrade_recovery_reset.jpg)
...
[EC-R3588SPC-FD firmware]: https://en.t-firefly.com/doc/download/142.html
[Androidtool_xxx (version number)]: https://en.t-firefly.com/doc/download/142.html#windows_12
[Release_DriverAssistant.zip]: https://en.t-firefly.com/doc/download/142.html#windows_341
[Linux_Upgrade_Tool]: https://en.t-firefly.com/doc/download/142.html#linux_12
[upgrade_tool_xxx (version number)]: https://en.t-firefly.com/doc/download/142.html#linux_12

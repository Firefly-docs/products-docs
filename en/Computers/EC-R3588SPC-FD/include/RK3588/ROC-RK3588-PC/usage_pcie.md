...
## Introduction
There is one PCIe3.0 x 4 interface on the EC-R3588SPC-FD development board, as shown in the figure:
...
The PCIe3.0 x 4 interface on the EC-R3588SPC-FD development board uses the `PCIe Gen3 x 4 lane` set of resources of the RK3588.
### DTS configuration

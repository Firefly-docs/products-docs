...
## Introduction
There are 1 SATA ports and 1 M.2 SATA port on the ROC-RK3588S-PC development board.

![](../../../rk3588_img/EC-R3588SPC-FD/usage_sata_interface.jpg)
![](../../../rk3588_img/EC-R3588SPC-FD/usage_sata2_interface.jpg)
...
The 1 SATA ports and 1 M.2 SATA port on the ROC-RK3588S-PC development board are all ports extended by the `USB3.0` expansion chip.
### DTS configuration

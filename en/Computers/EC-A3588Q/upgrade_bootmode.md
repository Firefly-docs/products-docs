...
The EC-A3588Q is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

EC-A3588Q has a flexible startup mode. Generally, the EC-A3588Q development board will not turn brick unless the hardware is damaged.
...
## Upgrade method
EC-A3588Q supports firmware update through the following two methods:
...
EC-A3588Q has three startup modes:

...
Run yolov5 demo on the EC-A3588Q as follows:
```shell
...
#### Run on EC-A3588Q NPU connected to the PC

RKNN Toolkit2 runs on the PC and connects to the EC-A3588Q through the PC's USB. RKNN Toolkit2 transfers the RKNN model to the NPU device of EC-A3588Q to run, and then obtains the inference results, performance information, etc. from the EC-A3588Q


* First prepare EC-A3588Q environment: update librknnrt.so and run rknn_server

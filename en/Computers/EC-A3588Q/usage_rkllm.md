...
## RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto EC-A3588Q.
...
```
#### Deploy And Run The RKLLM Model On EC-A3588Q.
...
./build-linux.sh
```
##### Running Inference On EC-A3588Q

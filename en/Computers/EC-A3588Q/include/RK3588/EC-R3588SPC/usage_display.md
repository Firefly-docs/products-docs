...
## EC-A3588Q Displays the configuration of the interface
 ...
 EC-A3588Q  There are two display output interfaces, namely HDMI and Display Port , which can achieve Dual-screen simultaneous display/exclusive display. The interface diagram is as follows:
...
## EC-A3588Q  Dual scene configuration

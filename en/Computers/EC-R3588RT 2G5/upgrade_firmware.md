...
* [Firmware](https://community.t-firefly.com/en/doc/download/233)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/233). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/233), extract, and then run the DriverInstall.exe inside . 
...
You can also download [AndroidTool](https://community.t-firefly.com/en/doc/download/233) separately, unzip it, and run `RKDevTool.exe` in the `RKDevTool_Release_v2.xx` directory (note that if you are running Windows 7/8, you need to right-click and select Run as administrator), as shown below:
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/233)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/233), And install it into the system as follows for easy invocation:
...
* [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/233)

Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/233), And install it into the system as follows for easy invocation:
...
The EC-R3588RT_2G5 enclosure has no reserved Recovery button, so there is no hardware way to enter Loader mode.
...
[EC-R3588RT_2G5 firmware]: https://community.t-firefly.com/en/doc/download/233
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/233#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/233#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/233#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/233#linux_12

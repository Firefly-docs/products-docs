...
**A:** The AIO-3576JD4 has three boot modes:
...
The AIO-3576JD4 does not expose a MaskRom key on the enclosure. You need to open the host, disconnect the power supply, press and hold the MaskRom key on the mainboard and then power on. Release the key after a few seconds.

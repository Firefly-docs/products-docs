...
This section provides three RAG deployment cases that can be deployed on AIBOX-1684, namely FireflyChat, ChatDoc-TPU and LangChain-Chatchat-TPU.
...
The CLIP-TPU project implements the TPU algorithm transplantation of CLIP, and users can use this project to verify the actual performance of CLIP on AIBOX-1684.

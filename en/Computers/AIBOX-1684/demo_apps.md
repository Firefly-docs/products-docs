...
After obtaining the installation package, transfer it to AIBOX-1684 and run the following command to install it:
...
After obtaining the model file, transfer it to AIBOX-1684 and run the following command to import it:

...
ROC-RK3568-PC-SE SDK has MIPI DSI DTS file:`kernel/arch/arm64/boot/dts/rockchip/rk3566-roc-pc-mipi101_M101014_BE45_A1.dts`,we would take the dsi0 configuration as an example to introduce the related LCD driver.
...
```
After the MIPI is powered on or off, it needs to send initialization or exit instructions to make it work normally. For the list of initialization and exit instructions, please refer to `kernel/arch/arm64/boot/dts/rockchip/rk3566-roc-pc-mipi101_M101014_BE45_A1.dts`, the list is as follows:

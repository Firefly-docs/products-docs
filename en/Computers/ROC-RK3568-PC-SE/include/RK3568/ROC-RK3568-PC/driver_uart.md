...
ROC-RK3568-PC-SE supports UART、RS232、RS485 interfaces. They are UART9, two RS232 and one RS485, which are located on the dual expansion interface and RJ45 interface respectively. The serial port interface diagram is as follows:

![](../../img/ROC-RK3568-PC-SE/uart_interface.jpg)

...
ROC-RK3568-PC-SE SDK has MIPI DSI DTS file:`rk3568-firefly-itx-3568q-mipi101_M101014_BE45_A1.dts`, this file is a MIPI_DSI1+HDMI screen configration, MIPI_DSI0 is disabled by default, we would take the dsi1 configuration as an example to introduce the related LCD driver.

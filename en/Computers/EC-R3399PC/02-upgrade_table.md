...
EC-R3399PC is installed with Android7.1(industry) system by default. 

EC-R3399PC may officially support multiple systems, so it is possible to upgrade firmware for different systems.
...
EC-R3399PC upgraded Android7.1(industry) firmware by default when it is delivered, and the customer needs to upgrade Android10.0 firmware for example:

...
AIO-3399C SDK has LVDS DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399pro-firefly-aioc-lvds-HSX101H40C.dts, we can see the following statement from this file:
```
/ {
        model = "AIO-3399C 10.1 inches LVDS HSX101H40C (Android)";
...
The AIO-3399C development board has an external backlight interface to control the screen backlight, as shown in the following figure:
...
### DTS configuration
#### Pin configuration
AIO-3399C SDK has EDP DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399pro-firefly-aioc-edp.dts, from this file we can see the following statement:
```
{
        panel: panel {

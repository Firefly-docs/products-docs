...
* Station P1 Pro development board
* Firmware
* Host computer
* Type-C data cable
...
4. Use metal tweezers to connect and hold the two test points as shown in the following figure on Station P1 Pro (as shown in the figure below).
5. Plug the device into the power supply.
6. Wait a moment, then loosen the tweezers.

<center>

<img alt="" src="../../../rk3399_img/Station-P1-Pro/maskrom_test_points.jpg" width="700">
</center>
...
2. Press and hold the MaskRom hole on Station-P1-Pro with a pin tool
...
[Station P1 Pro firmware]: https://community.t-firefly.com/en/doc/download/145
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/145#other_343
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/145#windows_341

...
The firmware package can be obtained from the Firefly [Download Page](https://community.t-firefly.com/en/download/237).

## Q: How to put the device into Recovery mode?

**A:** Follow these steps:

* Power off the AIBOX-OrinNX first
* Connect the OTG port of the AIBOX-OrinNX to the PC using a Type-C cable
* Press and hold the Recovery key of the AIBOX-OrinNX
* Power on the AIBOX-OrinNX
* Release the Recovery key of the AIBOX-OrinNX

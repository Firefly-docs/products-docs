...
* When flashing, AIBOX-Orin NX will format the internal storage device, please back up important data first.
* Orin NX power supply need **12V/5A**
* Orin NX carrier board hardware at least **V1.2**

## Download fireflyFlash.tbz2
[Download](https://community.t-firefly.com/en/download/237)
...
## Put AIBOX-Orin NX into Force Recovery Mode
* Ensure that AIBOX-Orin NX is powered off
* Connect AIBOX-Orin NX and PC using TypeC
* Press and hold down AIBOX-Orin NX Recovery-Key
* AIBOX-Orin NX power on
* Release AIBOX-Orin NX Recovery-Key
* Check AIBOX-Orin NX Recovery Mode
    * use `lsusb` comand, AIBOX-Orin NX is in Force Recovery Mode if you see the message: `Bus <bbb> Device <ddd>: ID 0955: <nnnn> Nvidia Corp.`

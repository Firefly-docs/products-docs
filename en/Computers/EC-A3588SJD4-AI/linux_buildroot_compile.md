...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rk3588_defconfig # u-boot configuration file
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rockchip_linux_defconfig # kernel configuration file
# Kernel dts
export RK_KERNEL_DTS=rk3588-firefly-aio-3588sjd4-ai.dts # dts file
# Buildroot config
export RK_CFG_BUILDROOT=rockchip_rk3588_defconfig # Buildroot configuration
# Recovery config

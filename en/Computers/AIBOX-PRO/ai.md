...
The RKLLM SDK helps users quickly deploy large language models onto AIBOX-PRO.
...
```
##### 3.1.2 Deploy And Run The RKLLM Model On AIBOX-PRO.
...
./build-linux.sh
```
###### 3.1.2.3 Running Inference On AIBOX-PRO
...
In addition to the above artificial intelligence algorithms,see [rknn_model_zoo](https://github.com/airockchip/rknn_model_zoo) for more examples.AIBOX-PRO also supports large language models. For information on deploying large language models, please refer to the [Large Language Model](usage_llm_rockchip.md) section.
...
![](../../../aibox_img/AIBOX-PRO/npu_development_process_en.png)

...
This article describes how to upgrade the firmware file on the host to the flash memory of AIBOX-3588 through the Type-C Cable. When upgrading, you need to choose the appropriate upgrade mode according to the host operating system and firmware type.

## Preparatory Tools

* AIBOX-3588
* [Firmware](https://community.t-firefly.com/en/doc/download/292.html#other_705)
* host computer
* Type-C Cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/292.html#other_705). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/292.html#other_11), extract, and then run the DriverInstall.exe inside . 
...
![](../../../aibox_img/AIBOX-3588/upgrade_firmware_install_rk_usb.jpg)
</center>
...
![](../../../aibox_img/AIBOX-3588/upgrade_firmware_androidtool_zh.png)

### Linux Operating System

There is no need to install device driver under Linux.

* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/292.html#other_502)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/292.html#other_502), And install it into the system as follows for easy invocation:
...
* [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/292.html#other_565)

Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/292.html#other_565), And install it into the system as follows for easy invocation:
...
![](../../../aibox_img/AIBOX-3588/upgrade_firmware_new_equipment.jpg)
...
![](../../../aibox_img/AIBOX-3588/upgrade_firmware_erase_flash_zh.png)

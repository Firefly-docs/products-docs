...
The AIBOX-3588 is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIBOX-3588 has a flexible startup mode. Generally, the AIBOX-3588 development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/292.html#other_705)


## Upgrade method
AIBOX-3588 supports firmware update through the following two methods:
...
AIBOX-3588 has three startup modes:

...
## Installation
Note: The system firmware of AIBOX-3588 has preconfigured FireflyChat and imported the basic model. You can use it directly.If FireflyChat does not exist in the firmware, you can download the corresponding [AI firmware](https://community.t-firefly.com/en/doc/download/292.html#other_705) or install FireflyChat yourself.

You need to obtain the required installation package from the [Download Center](https://community.t-firefly.com/en/doc/download/292.html#other_705) to install FireflyChat. There are two installation packages, which are `fireflychat_x.x.x_arm64.deb` and `libfirefly-ai_x.x.x_arm64.deb`.
...
After obtaining the model file, transfer it to AIBOX-3588 and run the following command to import it:
...
[Download Center]: https://community.t-firefly.com/en/doc/download/292.html#other_705
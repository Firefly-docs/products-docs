...
**A:** AIBOX-3588S has three boot modes:
...
![AndroidTool flashing tool interface](../../../aibox_img/AIBOX-3588S/upgrade_firmware_androidtool_zh.png)
</center>
...
![Flashing failure message](../../../aibox_img/AIBOX-3588S/upgrade_firmware_download_fail.png)
</center>
...
If the device cannot enter Loader mode, you can force entry into MaskRom mode: press and hold the MaskRom button first, and then power on the device. The device will then enter MaskRom mode.

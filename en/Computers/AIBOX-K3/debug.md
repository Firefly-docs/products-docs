...
You can use an RS232 to USB adapter to connect AIBOX-K3 to a PC for serial port debugging:

<center>

<img alt="" src="../../../aibox_img/AIBOX-K3/rs232_connection.png" width="700">
</center>

### Serial parameter configuration

AIBOX-K3 uses the following serial port parameters:
...
**Note:** The default baud rate for AIBOX-K3 is 115200.

...
RK3328 has 12 Timers (timer0-timer11), 12 Secure Timers (stimer0~stimer11) and 2 Timers (pmutimer0~pmutimer1), we mainly use Timers (timer0-timer11) clock frequency is 24MHZ, working mode There are `free-running` and `user-defined count` modes.

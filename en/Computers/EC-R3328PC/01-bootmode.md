...
The EC-R3328PC is installed with the Android operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

EC-R3328PC has a flexible startup mode. Generally, the EC-R3328PC development board will not turn brick unless the hardware is damaged.
...
[Firmware download link](https://en.t-firefly.com/doc/download/77.html)

## Upgrade method

EC-R3328PC supports firmware update through the following two methods:
...
EC-R3328PC  has three startup modes:

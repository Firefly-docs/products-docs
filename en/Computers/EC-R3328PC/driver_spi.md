...
![](../../../rk3399_img/EC-R3328PC/spi_interface.jpg)
...
The hardware connection between EC-R3328PC and W25Q128FV is shown in the following table:

![](../../../rk3399_img/EC-R3328PC/spi_hardware_connection.jpg)
...
* **spi-max-frequency :** set the highest frequency used by spi here. EC-R3328PC supports up to 48000000.
...
Linux provides a SPI user interface with limited functionality. If IRQ or other kernel driver interfaces are not required, consider using `spidev` interface to write user-level programs to control SPI devices. The corresponding path in the EC-R3328PC development board is `/dev/spidev0.0`.

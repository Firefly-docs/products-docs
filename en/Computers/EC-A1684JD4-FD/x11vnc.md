...
## Debian
EC-A1684JD4 FD has installed the xfce4 desktop and configured the x11vnc related environment by default. The user directly executes the following command to wait for the connection:

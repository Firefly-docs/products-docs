...
AIBOX-1684X uses TF card to upgrade firmware, users need to strictly follow the steps below.
...
(3) Insert the TF card into the TF card slot of AIBOX-1684X, and then turn on the power;

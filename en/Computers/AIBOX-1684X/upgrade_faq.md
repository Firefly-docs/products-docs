...
## Q: What firmware upgrade methods does the AIBOX-1684X support?

**A:** The AIBOX-1684X upgrades the firmware via a TF card:
...
1. During the upgrade, the working indicator flashes alternately between blue and green, which means the upgrade is in progress.
2. If the upgrade is successful, the working indicator turns green and keeps flashing.
3. If the upgrade fails, the working indicator goes out.

...
* Note: The ROC-RK3568-PC is installed with the Android operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.You can go to the [Firmware download page](https://en.t-firefly.com/doc/download/94.html) to download more firmware.


![](../../../rk356x_img/working_mode_en.png)

**ROC-RK3568-PC is classified according to the working mode and can be divided into two working modes:**

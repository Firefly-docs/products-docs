...
This method needs to burn the unified firmware twice. For the first time, directly burn the repair firmware [RK356x_NorFlash2eMMC-Loader_xxx.img](https://en.t-firefly.com/doc/download/94.html#other_480) provided by Firefly under Maskrom, the firmware will automatically erase Nor-Flash and switch to the loader mode of EMMC. 

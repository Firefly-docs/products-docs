...
Currently EC-A3588JD4 only supports 1 Gigabit port (Ethernet0), but a second Gigabit port (Ethernet1) can be extended via the 164 Pin interface.  


![](../../../rk3588_img/EC-A3588JD4/usage_ethernet_interface.jpg)

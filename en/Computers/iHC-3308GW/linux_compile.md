...
* Download the root file system: [Ubuntu root file system (64-bit)](https://community.t-firefly.com/en/doc/download/92.html#other_528), put it under the SDK path

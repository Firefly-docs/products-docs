...
* Tool: [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/92)

### Install RK USB drive

Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/92), extract, and then run the DriverInstall.exe inside .
...
Download [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/92). AndroidTool defaults to display in Chinese. We need to change it to English. Open `config.ini` with an text editor (like notepad). The starting lines are:
...
* Tool : [upgrade_tool_xxx (version number)](https://community.t-firefly.com/en/doc/download/92)


### Upgrade_tool

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/92), And install it into the system as follows for easy invocation:
...
[IHC-3308GW firmware]: https://community.t-firefly.com/en/doc/download/92
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/92#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/92#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/92#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/92#linux_12

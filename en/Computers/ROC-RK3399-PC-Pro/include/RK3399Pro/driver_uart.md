...
ROC-RK3399-PC-Pro supports SPI bridge/extension functions of four enhanced serial ports (UART), namely UART1, UART2, RS232, and RS485. Each UART has a 256-byte FIFO buffer for data receiving and sending. Among them:
...
The serial interface diagram of the ROC-RK3399-PC-Pro development board is as follows:

![](../../../rk3399_img/ROC-RK3399-PC-Pro/uart_interface.jpg)

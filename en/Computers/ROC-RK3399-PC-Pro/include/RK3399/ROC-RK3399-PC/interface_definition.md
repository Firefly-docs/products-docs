...
## ROC-RK3399-PC-Pro interface definition

ROC-RK3399-PC-Prois a mini PC motherboard, the size is only the size of a small mobile phone, but it provides a rich interface, including:

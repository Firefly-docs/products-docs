...
ROC-RK3399-PC-Pro SDK has LVDS DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399-firefly-aioc-lvds.dts, we can see the following statement from this file:
```
/ {
...
ROC-RK3399-PC-Pro The development board has an external backlight interface to control the screen backlight, as shown in the figure below:
...
### DTS configuration
#### Pin configuration
ROC-RK3399-PC-Pro SDK has EDP DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399-firefly-aioc-edp.dts, from this file we can see the following statement:
```
edp_panel: edp-panel {
    /* config 2 */
...
### TX configuration
#### Pin configuration
ROC-RK3399-PC-Pro SDK has mipi DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399-firefly-aioc-mipi.dts, from this file we can see the following statement:
```
power_ctr: power_ctr {
...
```
### TX/RX configuration
Due to the different external pins, ROC-RK3399-PC-Pro is TX, ROC-RK3399-PC-Pro(AI) is TX/RX, please refer to the schematic diagram for details. Therefore, DTS configuration is also slightly different, please refer to kernel/arch/arm64/boot/dts/rockchip/rk3399-firefly-aioc-ai-mipi.dts for details.
#### Configure mipi display timing
Because the interface used in ROC-RK3399-PC-Pro(AI) is DSI1, you need to configure both the timings of DSI and DSI1 before you can use:
```
&dsi {
    ...
    status = "okay";

...
This tutorial introduces how to compile programs for EC-A8550JD4.

## Local Compile

EC-A8550JD4 runs Ubuntu system, so you can use apt to install tools on device for software development:
```bash
sudo apt update

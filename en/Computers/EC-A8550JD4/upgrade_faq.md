...
While the device is running normally, connect the download port of the device with the PC through Type-A to Tyep-C USB cable, then run this command on the device terminal or debug console:

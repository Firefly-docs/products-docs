...
EC-A1684XJD4 FD does not have a graphics card chip, and the HDMI output part of the main control does not use the standard framebuffer driver. When it is shipped from the factory, it is not displayed when it is connected to HDMI.

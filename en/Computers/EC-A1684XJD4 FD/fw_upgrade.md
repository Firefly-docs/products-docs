...
EC-A1684XJD4 FD uses TF card to upgrade firmware, users need to strictly follow the steps below.
...
(3) Insert the TF card into the TF card slot of EC-A1684XJD4 FD, and then turn on the power;

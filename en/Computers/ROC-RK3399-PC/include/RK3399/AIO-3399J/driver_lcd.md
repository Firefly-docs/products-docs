...
The ROC-RK3399-PC development board is equipped with two LCD screen interfaces, one is EDP and the other is LVDS. The positions of the interfaces on the board are as follows:
...
ROC-RK3399-PC SDK has LVDS DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399-firefly-aio-lvds.dts, we can see the following statement from this file:
```
/ {

...
The NVIDIA chip includes 7 groups of GPIO controllers, each controlling 32 GPIOs, corresponding to the Linux device nodes as follows:
...
Among them, AIO-OrinNano supports the expansion of a set of GPIO interfaces (I2C extended GPIO):

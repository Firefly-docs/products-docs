...
![](../../../bm1688_img/EC-Orin Nano/vnc-01.png)

(3) Enter the `$bm1688_ip:0` address of EC-Orin Nano:

![](../../../bm1688_img/EC-Orin Nano/ubuntu-vnc-02.png)

(4) Click the circular button next to the linaro username, select xfce, and enter the username and password, both are `linaro`:

![](../../../bm1688_img/EC-Orin Nano/ubuntu-vnc-03.png)

(5) Successfully enter the xfce4 desktop:

![](../../../bm1688_img/EC-Orin Nano/ubuntu-vnc-04.png)
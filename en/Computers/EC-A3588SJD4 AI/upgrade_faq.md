...
**A:** The AIO-3588SJD4-AI has three boot modes:
...
The AIO-3588SJD4-AI enclosure does not expose a MaskRom key. You need to open the host, press and hold the MaskRom key on the core board, and then power on the device
<center>

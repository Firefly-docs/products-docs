...
The firmware package can be obtained from the Firefly [Download Page](https://community.t-firefly.com/en/download/233).

## Q: How to put the device into Recovery mode?

**A:** Follow these steps:

* Power off the AIO-OrinNX first
* Connect the OTG port of the AIO-OrinNX to the PC using a Type-C cable
* Press and hold the Recovery key of the AIO-OrinNX
* Power on the AIO-OrinNX
* Release the Recovery key of the AIO-OrinNX

...
Go to [SD Firmware Tool Download Page](https://community.t-firefly.com/en/doc/download/63#other_125) to download `SD_Firmware_Tool` and unzip it.
...
1. Download the SD card maker tool: [SD_Firmware_Tool](https://community.t-firefly.com/en/doc/download/63#other_125)

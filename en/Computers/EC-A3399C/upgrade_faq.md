...
**A:** The EC-A3399C has three boot modes:
...
The EC-A3399C computer does not expose a MaskRom button on the enclosure. You need to open the enclosure and find the two test points on the AIO-3399C motherboard as shown in the figure below. Short-circuit the two test points with metal tweezers and keep them connected, then power on the device. After a moment, release the tweezers, and the device will enter MaskRom mode.

<center>

<img alt="" src="../../../rk3399_img/AIO-3399C/maskrom_test_points.jpg" width="700">
</center>
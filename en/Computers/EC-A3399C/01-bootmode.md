...
The EC-A3399C is installed with the Android operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

EC-A3399C has a flexible startup mode. Generally, the EC-A3399C development board will not turn brick unless the hardware is damaged.
...
[Firmware download link](https://en.t-firefly.com/doc/download/55.html)

## Upgrade method

EC-A3399C supports firmware update through the following two methods:
...
EC-A3399C  has three startup modes:

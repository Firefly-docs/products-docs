...
<font color=#ff0000>**Note:** The default baud rate of EC-A3399C is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
EC-A3399C serial port connection diagram:

![](../../../rk3399_img/EC-A3399C/debug_connection.jpg)

## Parameter Setting

EC-A3399C use the following serial parameters:

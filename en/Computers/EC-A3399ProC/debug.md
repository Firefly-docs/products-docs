...
<font color=#ff0000>**Note:** The default baud rate of EC-A3399ProC is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
EC-A3399ProC serial port connection diagram:


<center>

<img alt="" src="../../../rk3399_img/EC-A3399ProC/debug_connection.jpg" width="800">
</center>


## Parameter Setting

EC-A3399ProC use the following serial parameters:

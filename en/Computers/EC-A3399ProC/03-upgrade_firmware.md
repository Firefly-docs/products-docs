...
* EC-A3399ProC development board
* Firmware
* Host computer
* Type-C data cable
...
4. Use metal tweezers to connect and hold the two test points as shown in the following figure on EC-A3399ProC (as shown in the figure below).
...
2. Press and hold the MaskRom hole on EC-A3399ProC with a pin tool
...
[EC-A3399ProC firmware]: https://community.t-firefly.com/en/doc/download/76

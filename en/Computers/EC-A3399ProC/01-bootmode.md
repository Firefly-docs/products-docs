...
The EC-A3399ProC is installed with the Android operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

EC-A3399ProC has a flexible startup mode. Generally, the EC-A3399ProC development board will not turn brick unless the hardware is damaged.
...
EC-A3399ProC supports firmware update through the following two methods:
...
EC-A3399ProC  has three startup modes:

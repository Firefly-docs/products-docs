...
<font color=#ff0000>**Note:** The default baud rate of EC-R3588RT_2G5 is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
EC-R3588RT_2G5 serial port connection diagram:

![](../../../rk3588_img/EC-R3588RT_2G5/debug_connection.jpg)

## Parameter Setting

EC-R3588RT_2G5 use the following serial parameters:

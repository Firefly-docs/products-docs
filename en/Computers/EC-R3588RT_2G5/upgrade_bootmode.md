...
The EC-R3588RT_2G5 is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

EC-R3588RT_2G5 has a flexible startup mode. Generally, the EC-R3588RT_2G5 development board will not turn brick unless the hardware is damaged.
...
## Upgrade method
EC-R3588RT_2G5 supports firmware update through the following two methods:
...
EC-R3588RT_2G5 has three startup modes:

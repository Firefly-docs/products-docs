# HDMI-IN  
EC-R3588RT_2G5 has an HDMI-IN interface, which supports the standard HDMI2.0 protocol, It  supports the following features：  
...
![](../../../rk3588_img/EC-R3588RT_2G5/usage_hdmiin_interface.jpg)  

Currently, there are APK and command methods to debug HDMI-IN functions.

## Android uses HDMI-IN

By default, the Android system of EC-R3588RT_2G5 have two APKs,one named **Live Tv**, another named **RockchipCamera2**,as shown below:
![](../../../rk3588_img/common/usage_hdmiin_rk3588_apk.png)  

Directly click on the APK to display the video input of HDMI-IN, and the audio input of HDMI-IN will be output from the EC-R3588RT_2G5 headphone, HDMI, Display Port and other interfaces.

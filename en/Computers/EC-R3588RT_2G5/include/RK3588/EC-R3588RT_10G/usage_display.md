...
## EC-R3588RT_2G5 Displays the configuration of the interface
 ...
 EC-R3588RT_2G5  There are two display output interfaces, namely HDMI and Display Port , which can achieve Dual-screen simultaneous display/exclusive display. The interface diagram is as follows:
...
## EC-R3588RT_2G5  Dual scene configuration

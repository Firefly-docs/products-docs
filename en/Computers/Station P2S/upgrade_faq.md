...
**A:** The ROC-RK3568-PC-SE has three boot modes:
...
Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/180#other_536), and install it into the system as follows for easy invocation:
...
The ROC-RK3568-PC-SE has an on-board Recovery key and MaskRom test points. If the device can enter Loader mode, there is generally no need to enter MaskRom mode. When the bootloader is damaged and the device cannot enter Loader mode, you can forcibly enter MaskRom mode as follows:

* Disconnect the power adapter and open the enclosure to expose the mainboard
* Short-circuit the `GND` and `D0` pads of the MaskRom test points with tweezers or a wire, and keep them shorted
* Connect the power. After about two seconds, remove the short-circuit. The device will enter MaskRom mode

The location of the MaskRom test points is shown below:

<center>

<img alt="" src="../../../rk356x_img/ROC-RK3568-PC-SE/maskrom_test_points.jpg" width="800">
</center>

The short-circuit pads (GND / D0) are shown below:

<center>

<img alt="" src="../../../rk356x_img/ROC-RK3568-PC-SE/maskrom_test_points_flash.jpg" width="800">
</center>

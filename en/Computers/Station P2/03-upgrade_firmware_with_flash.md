...
<img alt="" src="../../../rk356x_img/Station-P2/nor_flash-position.jpg" width="700">
</center>
...
If you enter Maskrom mode through ["How to enter MaskRom mode"](03-upgrade_firmware.md), then if you want to burn the entire firmware, please refer to Figure 1 below.And pay attention to the following steps:

...
2. Press and hold the earphone hole on Station-P2 with a pin tool
...
1. Use metal a tweezer to short and hold the two test points as shown in the following figure on Station-P2 (as shown in the figure below).
1. Plug in the power supply.
1. Wait a few seconds, stop shorting.

<center>

<img alt="" src="../../../rk356x_img/Station-P2/maskrom_test_points.jpg" width="700">
</center>
...
1. Disconnect the device from the power supply
2. Press and hold the Recovery hole on Station-P2 with a pin tool
3. The device is plugged into the power supply and powered on
...
[Station-P2 firmware]: https://community.t-firefly.com/en/doc/download/107

...
**A:** The ROC-RK3568-PC has three boot modes:
...
Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/107#other_536), and install it into the system as follows for easy invocation:

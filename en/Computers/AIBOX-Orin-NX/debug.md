...
You can use an RS232 to USB adapter to connect AIBOX-OrinNX to a PC for serial port debugging:

![](../../../aibox_img/AIBOX-Orin-NX/rs232_connection.png)

### Serial parameter configuration

AIBOX-Orin-NX uses the following serial port parameters:
...
**Note:** The default baud rate for AIBOX-Orin-NX is 115200.
...
AIBOX-OrinNX DEBUG port:

![](../../../aibox_img/AIBOX-Orin-NX/debug_connection.png)

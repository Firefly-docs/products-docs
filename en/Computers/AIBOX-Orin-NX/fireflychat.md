...
## Installation
Note: The system firmware of AIBOX-Orin NX has preconfigured FireflyChat and imported the basic model. You can use it directly.If FireflyChat does not exist in the firmware, you can download the corresponding [AI firmware]() or install FireflyChat yourself.
...
After obtaining the installation package, transfer it to AIBOX-Orin NX and run the following command to install it:
...
After obtaining the model file, transfer it to AIBOX-Orin NX and run the following command to import it:

...
ROC-RK3568-PC-SE The Ubuntu MINIMAL system is based on the Ubuntu 64bit system. Currently, we mainly maintain Ubuntu 20.04. Compared with Ubuntu Desktop, it has the following features:
...
For more introduction, please refer to ["Firefly Ubuntu User Manual"](/en/docs/software/os-guide/Ubuntu-Debian/ubuntu-debian)
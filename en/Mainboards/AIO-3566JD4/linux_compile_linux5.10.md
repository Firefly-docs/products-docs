...
Download Firefly_Linux_SDK sub-volume compressed package: [rk356x_linux5.10_release_20241220_v1.4.0c](http://en.t-firefly.com/doc/download/123.html#other_378), follow the README document:
...
# device tree name
RK_KERNEL_DTS_NAME="rk3566-firefly-aiojd4"
# ramdisk image
...
Under `device/rockchip/rk3566_rk3568/` , in addition to firefly_rk3566_aio-3566-jd4_ubuntu_defconfig, there are other configuration files that come with different accessories
...
* Download: [Ubuntu rootfs(64-bit)](http://en.t-firefly.com/doc/download/123.html#other_379)，put in SDK path
...
MACHINE=aio-3566-jd4-kernel5-10 bitbake core-image-minimal-xfce
MACHINE=aio-3566-jd4-kernel5-10 bitbake core-image-x11
MACHINE=aio-3566-jd4-kernel5-10 bitbake core-image-sato
```
...
```bash
MACHINE=aio-3566-jd4-kernel5-10 bitbake core-image-weston
```
...
```bash
MACHINE=aio-3566-jd4-kernel5-10 bitbake core-image-minimal -c clean
MACHINE=aio-3566-jd4-kernel5-10 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=aio-3566-jd4-kernel5-10 bitbake linux-rockchip
        
# u-boot
MACHINE=aio-3566-jd4-kernel5-10 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=aio-3566-jd4-kernel5-10 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=aio-3566-jd4-kernel5-10 bitbake rockchip-librga
        
# See more compilation objects
MACHINE=aio-3566-jd4-kernel5-10 bitbake -s
```
...
```bash
MACHINE=aio-3566-jd4-kernel5-10 bitbake <target> <paramater>
# e.g
MACHINE=aio-3566-jd4-kernel5-10 bitbake u-boot-rockchip -c clean
MACHINE=aio-3566-jd4-kernel5-10 bitbake u-boot-rockchip
```
...
Under `device/rockchip/rk3566_rk3568/` , in addition to firefly_rk3566_aio-3566-jd4_buildroot_defconfig, there are other configuration files that come with different accessories

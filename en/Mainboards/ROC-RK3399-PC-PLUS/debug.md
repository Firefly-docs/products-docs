...
<font color=#ff0000>**Note:** The default baud rate of ROC-RK3399-PC-PLUS is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
ROC-RK3399-PC-PLUS serial port connection diagram:

![](../../../rk3399_img/ROC-RK3399-PC-PLUS/debug_connection.jpg)

## Parameter Setting

ROC-RK3399-PC-PLUS use the following serial parameters:

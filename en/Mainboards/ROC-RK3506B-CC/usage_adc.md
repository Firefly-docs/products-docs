...
The ROC-RK3506B-CC development board has two kinds of AD interface, respectively: Temperature Sensor and Successive Approximation Register. Among them:
...
### Configure DTS nodes
The SAR-ADC nodes of ROC-RK3506B-CC defined in `kernel/arch/arm/boot/dts/rk3502.dts` file, as showm below:

...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rk3506_defconfig # u-boot configuration file
# Kernel defconfig
export RK_KERNEL_DEFCONFIG= # kernel configuration file
# Kernel dts
export RK_KERNEL_DTS=rk3506b-firefly-roc-rk3506b-cc # dts file
# Buildroot config
export RK_CFG_BUILDROOT=rockchip_rk3506_defconfig # Buildroot configuration
# Recovery config

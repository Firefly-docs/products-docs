...
The Face-RK3399 development board has an RTC (Real Time Clock) integrated into the RK808. The main functions are Clock, calendar, alarm Clock, periodic interrupt, dual channel 32KHz Clock output.
...
Starting from Face-RK3399 V2, the RTC uses an external HYM8563 RTC chip. The chip runs on the I2C7 bus, and the board uses a farad capacitor for backup power.
...
Linux provides three user-space call interfaces. The corresponding path in the Face-RK3399 development board is:

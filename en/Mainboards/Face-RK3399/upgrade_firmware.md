...
* You can find the compiled unified [Face-RK3399 firmware](http://en.t-firefly.com/doc/download/66.html#other_223) here, download it and unpack it. You can also refer to the instructions for compiling firmware to compile by yourself.
...
* Tool: [AndroidTool_Release_v2.63](http://en.t-firefly.com/doc/download/66.html#other_220)

#### Install RK USB drive

Download [Release_DriverAssistant.zip](http://en.t-firefly.com/doc/download/66.html#other_218), extract, and then run the `DriverInstall.exe` inside .
...
Download [AndroidTool](http://en.t-firefly.com/doc/download/66.html#other_220). AndroidTool defaults to display in Chinese. We need to change it to English. Open `config.ini` with an text editor (like notepad). The starting lines are:
...
Download [Linux_Upgrade_Tool](http://en.t-firefly.com/doc/download/66.html#other_219), And install it into the system as follows for easy invocation:

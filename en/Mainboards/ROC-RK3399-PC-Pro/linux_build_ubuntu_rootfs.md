...
The ROC-RK3399-PC Pro Ubuntu root file system is based on Ubuntu base 16.04. Users can go to [ubuntu cdimg](http://cdimage.ubuntu.com/ubuntu-base/releases/16.04/release/) to download, choose to download `ubuntu-base-16.04.1-base-arm64.tar.gz`.

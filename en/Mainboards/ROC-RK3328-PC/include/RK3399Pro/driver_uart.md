...
ROC-RK3328-PC supports SPI bridge/extension functions of four enhanced serial ports (UART), namely UART1, UART2, RS232, and RS485. Each UART has a 256-byte FIFO buffer for data receiving and sending. Among them:
...
The serial interface diagram of the ROC-RK3328-PC development board is as follows:

...
## ROC-RK3328-PC interface definition

ROC-RK3328-PCis a mini PC motherboard, the size is only the size of a small mobile phone, but it provides a rich interface, including:

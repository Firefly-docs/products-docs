...
**Note :** the ROC-RK3328-PC motherboard does not carry the mipi_dsi interface by default, and the hardware needs to be modified if this function is needed. Please refer to [LCD driver section](http://wiki.t-firefly.com/ROC-RK3328-PC/driver_lcd.md) for details.
...
![](../../../rk3399_img/ROC-RK3328-PC/module_display_mipi_connection.en.jpg)
...
* **Note:** the voltage jumper in the figure below should use 12V.
![](../../../rk3399_img/ROC-RK3328-PC/module_display_lvds.en.png)
...
![](../../../rk3399_img/ROC-RK3328-PC/module_display_edp.en.jpg)

### Connection methods

**Note:** the voltage jumper in the figure below will use 5V, and a wrong connection to 12V will burn the screen chip

![](../../../rk3399_img/ROC-RK3328-PC/module_display_edp_connection.en.png)
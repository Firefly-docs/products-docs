...
* Connect the VCC, GND, TX and RX of the module to 3.3V, GND, RX and TX of ROC-RK3328-PC **UART?**(<font color = "red">the corresponding node is `/dev/tty*`</font>) respectively. Pay attention to avoid<font color="red"> burning the module </font> due to wrong connection of VCC, GND, TX and RX.

...
The dts configuration reference in the Android SDK: `kernel/arch/arm64/boot/dts/rockchip/rk3566-roc-pc.dtsi`
...
Linux provides three user-space call interfaces. The corresponding path in the ROC-RK3566-PC development board is:

...
Download Firefly_Linux_SDK sub-volume compressed package: [rk356x_linux5.10_release_20241220_v1.4.0c](http://en.t-firefly.com/doc/download/93.html#other_378), follow the README document:
...
```bash
./build.sh firefly_rk3566_roc-rk3566-pc_ubuntu_defconfig
```
...
# device tree name
RK_KERNEL_DTS_NAME="rk3566-firefly-roc-pc"
# ramdisk image
...
Under `device/rockchip/rk3566_rk3568/` , in addition to firefly_rk3566_roc-rk3566-pc-mipi_ubuntu_defconfig, there are other configuration files that come with different accessories
...
* Download: [Ubuntu rootfs(64-bit)](http://en.t-firefly.com/doc/download/93.html#other_379)，put in SDK path
...
```bash
MACHINE=roc-rk3566-pc-kernel5-10 bitbake core-image-minimal
MACHINE=roc-rk3566-pc-kernel5-10 bitbake core-image-minimal-xfce
MACHINE=roc-rk3566-pc-kernel5-10 bitbake core-image-x11
MACHINE=roc-rk3566-pc-kernel5-10 bitbake core-image-sato
```
...
```bash
MACHINE=roc-rk3566-pc-kernel5-10 bitbake core-image-weston
```
...
```bash
MACHINE=roc-rk3566-pc-kernel5-10 bitbake core-image-minimal -c clean
MACHINE=roc-rk3566-pc-kernel5-10 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=roc-rk3566-pc-kernel5-10 bitbake linux-rockchip
        
# u-boot
MACHINE=roc-rk3566-pc-kernel5-10 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=roc-rk3566-pc-kernel5-10 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=roc-rk3566-pc-kernel5-10 bitbake rockchip-librga
        
# See more compilation objects
MACHINE=roc-rk3566-pc-kernel5-10 bitbake -s
```
...
```bash
MACHINE=roc-rk3566-pc-kernel5-10 bitbake <target> <paramater>
# e.g
MACHINE=roc-rk3566-pc-kernel5-10 bitbake u-boot-rockchip -c clean
MACHINE=roc-rk3566-pc-kernel5-10 bitbake u-boot-rockchip
```
...
### Related overview
The Yocto Project is an open source collaborative project focused on embedded Linux® operating system development that provides a flexible toolset and development environment that allows embedded device developers worldwide to share technologies, software stacks, configurations and tools for creating these customizations Best Practices for Linux Imaging Collaboration. For more information about the Yocto Project, please refer to the official Yocto Project website:[www.yoctoproject.org/](https://www.yoctoproject.org/). The Yocto Project home page has the [Yocto Project Reference Manual](https://docs.yoctoproject.org/current/ref-manual/index.html) and the [Yocto Project Overview](https://docs.yoctoproject.org/) and other related documents describe in detail how to build the system.
...
```bash
./build.sh firefly_rk3566_roc-rk3566-pc_buildroot_defconfig
```
...
Under `device/rockchip/rk3566_rk3568/` , in addition to firefly_rk3566_roc-rk3566-pc_buildroot_defconfig, there are other configuration files that come with different accessories

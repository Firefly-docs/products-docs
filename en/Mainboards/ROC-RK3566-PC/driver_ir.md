...
The infrared transceiver sensor IR (next to the LED lamp) is used on the development ROC-RK3566-PC to realize the remote control function, and the infrared receiver is connected at the IR interface.This paper mainly describes how to configure the infrared remote control on the development board.

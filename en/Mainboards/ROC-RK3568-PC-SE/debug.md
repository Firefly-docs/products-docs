...
<font color=#ff0000>**Note:** The default baud rate of ROC-RK3568-PC-SE is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
ROC-RK3568-PC-SE serial port connection diagram:

![](../../img/ROC-RK3568-PC-SE/debug_connection.jpg)

## Parameter Setting

ROC-RK3568-PC-SE use the following serial parameters:

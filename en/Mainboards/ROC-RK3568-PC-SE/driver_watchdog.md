...
ROC-RK3568-PC-SE has a internal watchdog and a external watchdog. The model of the external watchdog is PC9202.
...
3. Now <font color=red>ROC-RK3568-PC-SE v1.0</font> version, external watchdog cannot be closed in software way after it is enabled, you need to cut the power

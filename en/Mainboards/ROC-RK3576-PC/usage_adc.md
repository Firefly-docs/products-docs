...
The ROC-RK3576-PC development board has two kinds of AD interface, respectively: Temperature Sensor and Successive Approximation Register. Among them:
...
### Configure DTS nodes
The SAR-ADC nodes of ROC-RK3576-PC defined in `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi` file, as showm below:
...
Compile the kernel, upgrade the kernel to ROC-RK3576-PC development board, and then plug out the fan, the kernel log information will be printed as follows:

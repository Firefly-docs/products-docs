...
<font color=#ff0000>**Note:** The default baud rate of ROC-RK3576-PC is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
ROC-RK3576-PC serial port connection diagram:

![](../../../rk3576_img/ROC-RK3576-PC/debug_connection.jpg)

## Parameter Setting

ROC-RK3576-PC use the following serial parameters:

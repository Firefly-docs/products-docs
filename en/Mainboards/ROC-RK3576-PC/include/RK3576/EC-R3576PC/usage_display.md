...
## ROC-RK3576-PC Displays the configuration of the interface
 ...
 ROC-RK3576-PC  There are three display output interfaces, namely HDMI, Display Port , which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* HDMI/ Display Port/ MIPI DSI 

![](../../../rk3576_img/ROC-RK3576-PC/usage_display_interface.png)

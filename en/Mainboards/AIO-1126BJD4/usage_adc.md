...
The CORE-1126BJD4 development board has two types of AD interfaces: Temperature Sensor and Successive Approximation ADC. Specifically:
...
### Configure DTS nodes
The SAR-ADC nodes of CORE-1126BJD4 defined in `kernel-6.1/arch/arm64/boot/dts/rockchip/rv1126b.dtsi` file, as showm below:

...
ROC-RK3568-PC SDK has MIPI DSI DTS file:`kernel/arch/arm64/boot/dts/rockchip/rk3566-roc-pc-mipi101_M101014_BE45_A1.dts`,we would take the dsi0 configuration as an example to introduce the related LCD driver.

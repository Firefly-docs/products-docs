...
* Compile
    ...
    ./FFTools/mkupdate/mkupdate.sh -l rk3568_firefly_roc_pc-userdebug
    ```
<font color="red">Note:The ROC-RK3568-PC  hardware version must be V1.3 and later to support the use of HDMI-TO-MIPI_CSI drive board.</font>

## Manually compile ROC-RK3568-PC Android 11.0

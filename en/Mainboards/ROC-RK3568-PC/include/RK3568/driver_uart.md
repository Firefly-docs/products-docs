...
ROC-RK3568-PC supports UART、RS232、RS485 interfaces
* UARTx2
* RS485x2
* RS232x2
...
The serial interface diagram of the ROC-RK3568-PC development board is as follows:

![](../../img/ROC-RK3568-PC/uart_interface.png)
...
As you can see, enabling the node in the `kernel/arch/arm64/boot/dts/rockchip/rk3568-firefly-roc-pc.dtsi` file is available. In addition, SPI1 node needs to be enabled because SPI to UART serial port module used by our board is attached to SPI1. As follows:

...
ROC-RK3588-RT has one RS232 interfaces and one RS485 interface

The serial interface diagram of the ROC-RK3588-RT development board is as follows:

![](../../../rk3588_img/ROC-RK3588-RT/usage_uart_interface.jpg)
...
Users can use different host's USB-to-serial adapters to send and receive data to the serial port of the development board according to different interfaces. For example, the debugging steps of RS485 are as follows(ROC-RK3588-RT RS485 is half-duplex and requires gpio to control transmission and reception):

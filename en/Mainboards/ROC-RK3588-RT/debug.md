...
<font color=#ff0000>**Note:** The default baud rate of ROC-RK3588-RT is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
ROC-RK3588-RT serial port connection diagram:

![](../../../rk3588_img/ROC-RK3588-RT/debug_connection.jpg)

## Parameter Setting

ROC-RK3588-RT use the following serial parameters:

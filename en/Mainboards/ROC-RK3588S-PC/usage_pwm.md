...
The PWM driver of ROC-RK3588S-PC is `kernel-5.10/drivers/pwm/pwm-rockchip.c`
...
Add the PWM DTS configuration in the DTS source file `kernel-5.10/arch/arm64/boot/dts/rockchip/rk3588-firefly-demo.dtsi`, as shown below:

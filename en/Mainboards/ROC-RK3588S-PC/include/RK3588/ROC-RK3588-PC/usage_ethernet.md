...
Currently ROC-RK3588S-PC only supports 1 Gigabit port (Ethernet0), but a second Gigabit port (Ethernet1) can be extended via the 164 Pin interface.  


![](../../../rk3588_img/ROC-RK3588S-PC/usage_ethernet_interface.jpg)

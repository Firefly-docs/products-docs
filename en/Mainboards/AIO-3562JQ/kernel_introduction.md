...
[Linux Development](linux_compile_linux5.10.md)
...
./build.sh xxxx_defconfig
# Compile kernel
./build.sh extboot
```
The output file is `SDK/kernel/extboot.img`

## Burning

Refer to [Upgrade Partition Image](03-upgrade_firmware.md#upgrade-partition-image)
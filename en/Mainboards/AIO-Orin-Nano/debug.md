...
The AIO-OrinNano can be connected to a PC using a Type-C cable for serial port debugging:

![](../../../bm1688_img/AIO-Orin Nano/type-c_connection.png)
...
![](../../../bm1688_img/AIO-Orin Nano/debug_switch.png)
...
The AIO-Orin Nano uses the following serial port parameters:
...
**Note:** The default baud rate for AIO-Orin Nano is 115200.
...
AIO-OrinNano DEBUG port:

![](../../../bm1688_img/AIO-Orin Nano/debug_connection.png)

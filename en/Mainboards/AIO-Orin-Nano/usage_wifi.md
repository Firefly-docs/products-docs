...
AIO-Orin Nano supports wireless WIFI, and the default name of the network card in the system is `wlanx` or `wlPxp1s0` (depending on different wifi modules). Taking `wlan0` as an example:

...
The AIO-Orin Nano features an HDMI interface (supports 4K\@60fps) and a MIPS DSI interface (maximum output capability of 1440P (2560 \* 1440)@60fps,[The interface location is shown in the figure](interface_definition.html#zheng-ji-jie-kou-ding-yi)  。
...
After booting, the AIO-Orin Nano does not have a built-in desktop environment and only runs a display program:

...
AIO-Orin Nano uses a TF card to upgrade the firmware, and users must strictly follow the steps below.
...
(3) Insert the TF card into the TF card slot of the AIO-Orin Nano, then power on;

...
The AIO-OrinNX can be connected to a PC using a Type-C cable for serial port debugging:

![](../../../bm1688_img/AIO-Orin NX/type-c_connection.png)
...
![](../../../bm1688_img/AIO-Orin NX/debug_switch.png)
...
The AIO-Orin NX uses the following serial port parameters:
...
**Note:** The default baud rate for AIO-Orin NX is 115200.
...
AIO-OrinNX DEBUG port:

![](../../../bm1688_img/AIO-Orin NX/debug_connection.png)

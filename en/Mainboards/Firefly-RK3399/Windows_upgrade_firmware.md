...
This article describes how to burn the firmware file on the host computer to the flash memory of the Firefly-RK3399 development board through Type-C数据线. When upgrading, you need to choose an appropriate upgrade method according to the host operating system and firmware type.
...
[Firefly-RK3399 firmware]: http://en.t-firefly.com/doc/download/3.html
[Androidtool_xxx (version number)]: http://en.t-firefly.com/doc/download/3.html#other_343

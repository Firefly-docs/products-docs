...
**Note :** the Firefly-RK3399 motherboard does not carry the mipi_dsi interface by default, and the hardware needs to be modified if this function is needed. Please refer to [LCD driver section](http://wiki.t-firefly.com/Firefly-RK3399/driver_lcd.md) for details.
...
* **Note:** the voltage jumper in the figure below should use 12V.
![](../../../rk3399_img/Firefly-RK3399/module_display_lvds.en.png)
...
![](../../../rk3399_img/Firefly-RK3399/module_display_edp_connection.en.png)
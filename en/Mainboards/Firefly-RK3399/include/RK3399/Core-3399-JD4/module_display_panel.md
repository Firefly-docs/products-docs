...
**Note:** the Firefly-RK3399 motherboard does not carry the mipi_dsi interface by default, and the hardware needs to be modified if this function is needed. Please refer to [LCD driver section](https://wiki.t-firefly.com/en/Core-3399-JD4/driver_lcd.html) for details.
...
![](../../../rk3399_img/Firefly-RK3399/module_display_lvds_new.jpg)


## 7.85 inch EDP LCD module

Note: The default Firefly-RK3399 motherboard does not have a mipi_dsi interface. If you need this function, you need to modify the hardware. For details, please refer to [LCD Driver Chapter](driver_lcd.md)

 ...
 **Note: ROC-RK3399-PC power supply and debugging interface are Type-C0 interface. When connected to the USB power supply of the computer, because the current is too small, the development board cannot bring up some peripherals, which causes abnormal startup.**
...
check the ROC-RK3399-PC IP address, Use command under the PC:

...
## Introduction
There's a SAR ADC (Successive Approximation Register Analog Digital Converter) in AIO-3128C development, with three 10 bits channels (0/1/2):
...
You need to add a new node to aio-3128c.dts,  with status set to "okay":
```
&adc {
    status = "okay";

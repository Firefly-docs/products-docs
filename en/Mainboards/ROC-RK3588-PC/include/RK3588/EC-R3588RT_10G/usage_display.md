...
## ROC-RK3588-PC Displays the configuration of the interface
 ...
 ROC-RK3588-PC  There are two display output interfaces, namely HDMI and Display Port , which can achieve Dual-screen simultaneous display/exclusive display. The interface diagram is as follows:
...
## ROC-RK3588-PC  Dual scene configuration

...
## ROC-RK3588-PC Displays the configuration of the interface
 ...
 ROC-RK3588-PC  There are three display output interfaces, namely HDMI, Display Port and MIPI DSI, which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* HDMI0/ HDMI1/ Display Port 
![](../../../rk3588_img/ROC-RK3588-PC/usage_display_interface.png)  

* MIPI DSI0/ MIPI DSI1
![](../../../rk3588_img/ROC-RK3588-PC/usage_display_dsi_interface.png) 

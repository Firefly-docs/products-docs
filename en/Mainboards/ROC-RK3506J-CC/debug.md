...
<font color=#ff0000>**Note:** The default baud rate of ROC-RK3506J-CC is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
ROC-RK3506J-CC serial port connection diagram:

![](../../../rk3506_img/ROC-RK3506J-CC/debug_connection.jpg)

## Parameter Setting

ROC-RK3506J-CC use the following serial parameters:
...
![](../../../rk3506_img/common/debug_find_com.jpg)
...
![](../../../rk3506_img/common/debug_set_moba_xterm1.png)
![](../../../rk3506_img/common/debug_set_moba_xterm2.png)

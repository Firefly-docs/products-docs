...
AIC (Android in Container) means runing Android inside a container on Linux. RK3506 Linux can use docker to run Android and support running multiple Androids at the same time.
...
One RK3506 using AIC running two Genshin Impact with highest graphic setting at the same time can reach 35+ fps:
![](../../../rk3506_img/common/aic_ys_performance.png)
## Rockit AVS
...
![](../../../rk3506_img/avs_yuviewtool_preview.png)

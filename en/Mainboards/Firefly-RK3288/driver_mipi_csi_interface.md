...
* CIF_PWR corresponds to GPIO7_B4 pin on Firefly-RK3288:

![](../../../rk3288_img/Firefly-RK3288/mipi_csi_2.png)

* MIPI_PWR and MIPI_RST correspond to GPIO3_B2 and GPIO3_B0 pins on Firefly-RK3288, the default of which is high level:
...
![](../../../rk3288_img/Firefly-RK3288/mipi_csi_7.png)

In the development board, except for CIF_POWER and DVP_POWER which shall be set on DTS and driver, the other pins shall be set on cam_board.xml.
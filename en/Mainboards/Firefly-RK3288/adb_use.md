...
1. Connect the device and host with Micro USB data cable;
2. On the development board running Android, select Settings-> USB, and then check the Connect to PC option.
3. Install the adb driver and commands based on your system.
...
check the Firefly-RK3288 IP address, Use command under the PC:
...
Then go to [adb download](http://www.t-firefly.com/share/index/index/id/6afafdf7c54b8eb95e81156d94e54db5.html) to download `adb.zip`, uncompress it to `C:\adb` to ease later use.

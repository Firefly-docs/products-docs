...
There is a DVP camera interface on the Firefly-RK3288-Reload development board. This article will introduce how to make the camera work properly, using OV5640 as an example.

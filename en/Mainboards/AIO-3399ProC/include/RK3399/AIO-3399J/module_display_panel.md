...
**Note :** the AIO-3399ProC motherboard does not carry the mipi_dsi interface by default, and the hardware needs to be modified if this function is needed. Please refer to [LCD driver section](https://wiki.t-firefly.com/en/AIO-3399J/driver_lcd.html) for details.
...
![](../../../rk3399_img/AIO-3399ProC/module_display_lvds_old.en.jpg)

* New version wiring diagram:

![](../../../rk3399_img/AIO-3399ProC/module_display_lvds_new.en.jpg)

...
## AIO-3399ProC interface definition

AIO-3399ProCis a mini PC motherboard, the size is only the size of a small mobile phone, but it provides a rich interface, including:

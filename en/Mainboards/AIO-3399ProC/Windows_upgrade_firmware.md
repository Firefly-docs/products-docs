...
This article describes how to burn the firmware file on the host computer to the flash memory of the AIO-3399ProC development board through Type-C数据线. When upgrading, you need to choose an appropriate upgrade method according to the host operating system and firmware type.
...
[AIO-3399ProC firmware]: http://en.t-firefly.com/doc/download/69.html

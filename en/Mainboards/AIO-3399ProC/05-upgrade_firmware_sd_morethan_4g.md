...
Go to [SD Firmware Tool Download Page](http://en.t-firefly.com/doc/download/69.html#other_125) to download `SD_Firmware_Tool` and unzip it.

### Run `SD_Firmware_Tool.exe`
![](../../../rk3399_img/sdfirmwaretool.en.jpg)

1. Download the SD card maker tool: [SD_Firmware_Tool](http://en.t-firefly.com/doc/download/69.html#other_125)

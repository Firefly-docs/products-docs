...
<font color=#ff0000>**Note:** The default baud rate of AIO-3576C is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
AIO-3576C serial port connection diagram:

![](../../../rk3576_img/AIO-3576C/debug_connection.jpg)

## Parameter Setting

AIO-3576C use the following serial parameters:

...
AIO-3576C has a LVDS display output interface，and resolution can support up to 2K by TTL to LVDS .
...
AIO-3576C  Hardware reserve an eDP display output interface 40Pin / 30Pin (default hardware used as HDMI function) :

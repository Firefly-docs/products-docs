...
## AIO-3576C Displays the configuration of the interface
 ...
 AIO-3576C  There are three display output interfaces, namely HDMI, Display Port , which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* HDMI/ Display Port/ MIPI DSI 

![](../../../rk3576_img/AIO-3576C/usage_display_interface.png)

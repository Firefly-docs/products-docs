...
## Introduction
AIO-3399J development board has 4 PWMs, namely PWM0 ~ PWM3. 4 PWMs use for EDP backlight, MIPI backlight, VDDLOG power supply , infrared IR.


This chapter describes how to configure PWM.

The PWM driver of AIO-3399J is `kernel/drivers/pwm/pwm-rockchip.c`

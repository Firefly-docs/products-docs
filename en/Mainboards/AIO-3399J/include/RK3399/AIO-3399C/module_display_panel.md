...
**Note :** the AIO-3399J motherboard does not carry the mipi_dsi interface by default, and the hardware needs to be modified if this function is needed. Please refer to [LCD driver section](http://wiki.t-firefly.com/AIO-3399J/driver_lcd.md) for details.
...
* **Note:** the voltage jumper in the figure below should use 12V.
![](../../../rk3399_img/AIO-3399J/module_display_lvds.en.png)

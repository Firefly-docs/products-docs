...
In order to facilitate user development, AIO-3399J introduces two channels such as UART4 (reuse with SPI1) on the double-row extension interface of the board. 

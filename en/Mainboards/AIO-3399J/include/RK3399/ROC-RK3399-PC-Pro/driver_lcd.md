...
AIO-3399J development board supports two LCD screen interfaces by default, one is MIPI (Maximum resolution support 2560x1600@60fps), the other is EDP(Maximum resolution support 2K@60fps). The positions of interfaces on the board are shown as follows:
...
A backlight interface is set outside the AIO-3399J development board to control the backlight of the screen.

...
* USB Card Reader 
* MIrcoSD card
* [**SD_Firmware_Tool**](https://community.t-firefly.com/en/doc/download/304)
#### Operation Steps
...
* Choose firmware we want to upgrade into the GS1-N1
* Click  button `Create` to make it and wait until it is finshed


<center>

![](../../../gs1-n2_img/GS1-N1/rockchip_upgrade_firmware_sd_tool.png)

...
AIO-3568J supports  UART3, UART5(disabled by default, Serial port and SPI multiplexing), RS232(UART9), and RS485(UART0). Each UART has a 256-byte FIFO buffer for data receiving and sending. Among them:
...
* UART
![](../../img/IPC-M10R800-A3568J/uart1_interface.jpg)
* RS232
![](../../img/IPC-M10R800-A3568J/rs232_interface.jpg)
* RS485
![](../../img/IPC-M10R800-A3568J/rs485_interface.jpg)

...
Under AIO-3568J SDK, the default configuration file `kernel/arch/arm64/configs/firefly_defconfig` of IPC-M10R800-A3568J has already set the LCD-related configuration. If you modify it yourself, please pay attention to it. The following configuration is added:
```
...
AIO-3568J SDK has MIPI DSI DTS file:
...
### Pin Configuration
AIO-3568J SDK has EDP DSI DTS file: `kernel/arch/arm64/boot/dts/rockchip/rk3568-firefly-roc-pc-edp_M156X40.dts`, we can see the following statement from this file:
```
{
    ...
    edp_panel: edp-panel {

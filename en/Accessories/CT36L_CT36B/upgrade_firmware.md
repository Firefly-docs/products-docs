...
## Preparation tools
* CT36L/CT36B
* [Firmware](https://en.t-firefly.com/doc/download/214.html)
* Host
* Good USB data cable

## Prepare firmware
The firmware can be obtained by compiling the SDK, or you can download the public version firmware (unified firmware) from [Resource Download](https://en.t-firefly.com/doc/download/214.html). There are generally two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://en.t-firefly.com/doc/download/214.html#other_663), unzip it, and then run DriverInstall.exe inside. In order for all devices to use updated drivers, please select `Driver Uninstall` first, and then select `Driver Installation`.
...
* [Linux_Upgrade_Tool](https://en.t-firefly.com/doc/download/214.html#other_665) tool

Download [Linux_Upgrade_Tool](https://en.t-firefly.com/doc/download/214.html#other_665), and install it into the system as follows for easy calling:

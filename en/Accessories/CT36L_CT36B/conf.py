...
project = 'CT36L Manual'
_project_filename = 'CT36L_Manual'
copyright = '2022, Firefly Team'
author = 'Firefly Team'
...
html_theme_options = {
    ...
    'product_regula_lang': 'Spec',
    'logo_href':'http://wiki.t-firefly.com/en/',
    #'download_show':'True',
    #'download_name':'Resource download',
    #'download_href':'http://www.t-firefly.com/doc/download/page/id/3.html'
    'sidebar_ext_show': True,
    'sidebar_ext':[


        {'name':'Resource download','href':'https://community.t-firefly.com/en/doc/download/214.html'},
    ]
}

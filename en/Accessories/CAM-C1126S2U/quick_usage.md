...
1. Click to download Windows host computer tool: [ArcAICameraSetup](https://community.t-firefly.com/en/doc/download/99) .
...
1. Click to download Android host computer APP tool: [Android APK](https://community.t-firefly.com/en/doc/download/99).

...
Download Firefly_Linux_SDK sub-volume compressed package: [Linux SDK](https://community.t-firefly.com/en/doc/download/99)
...
* Download: [Debian rootfs(32-bit)](https://community.t-firefly.com/en/doc/download/99)，put in SDK path

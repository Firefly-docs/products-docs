...
Download Firefly_Linux_SDK sub-volume compressed package: [Linux SDK](https://community.t-firefly.com/en/doc/download/86.html)
...
* Download: [Debian rootfs(32-bit)](https://community.t-firefly.com/en/doc/download/86.html)，put in SDK path

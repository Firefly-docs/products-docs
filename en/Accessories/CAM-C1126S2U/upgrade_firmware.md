...
* CAM-C1126S2U development board
* [Firmware](https://community.t-firefly.com/en/doc/download/99)
* host computer
* TYPE-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/99). There are two types of firmware files:
...
<img alt="" src="../../../rv1126_img/common/upgrade_firmware_androidtool_zh.png" width="800">
</center>
...
* Use TYPE-C 数据线 to connect one end to the host and the other end to the development board
...
<img alt="" src="../../../rv1126_img/common/upgrade_firmware_new_equipment.jpg" width="800">
</center>
...
1. Disconnect the power supply of the device
2. Use tweezers to short the two test points on CAM-C1126S2U (both as shown in the figure below)
3. Plug the device into the power supply and power it on

* The following are the two test points on CAM-C1126S2U
<center>

<img alt="" src="../../../rv1126_img/CAM-C1126S2U/upgrade_maskrom_test_points_core.png" width="800">
</center>
...
<img alt="" src="../../../rv1126_img/common/upgrade_firmware_erase_flash_zh.png" width="800">
</center>
...
1. Get device partition table information
   ...
   <img alt="" src="../../../rv1126_img/common/upgrade_tools_get_partition.png" width="800">
   </center>
   ...
   <img alt="" src="../../../rv1126_img/common/upgrade_tools_get_partition_ok.png" width="800">
   </center>
...
2. Export device partition table information
   ...
   <img alt="" src="../../../rv1126_img/common/upgrade_tools_export_config.png" width="800">
   </center>
...
3. Load device partition table information
   ...
   <img alt="" src="../../../rv1126_img/common/upgrade_tools_load_config.png" width="800">
   </center>
...
<img alt="" src="../../../rv1126_img/common/upgrade_firmware_download_fail.png" width="800">
</center>

[烧写须知]: 02-upgrade_table.md
[CAM-C1126S2U firmware]: https://community.t-firefly.com/en/doc/download/99
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/99#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/99#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/99#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/99#linux_12

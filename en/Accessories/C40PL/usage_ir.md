...
C40PL is equipped with an IR infrared mainboard. And it is equipped with a photosensitive sensor to identify daytime scenes and nighttime scenes. The following uses IPC firmware for testing.

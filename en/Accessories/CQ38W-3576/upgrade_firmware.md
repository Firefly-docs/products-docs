...
* [Firmware](https://community.t-firefly.com/en/doc/download/342)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/342). There are two types of firmware files:
...
<img alt="" src="../../../rk3576_img/CQ38W-3576/upgrade_maskrom_key.jpg" width="800">
</center>

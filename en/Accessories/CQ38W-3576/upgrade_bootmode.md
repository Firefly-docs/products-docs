...
The CQ38W-3576 is installed with the one kind of operating system by default. If users want to run other operating systems, they need to download the corresponding firmware to the mainboard.

CQ38W-3576 has a flexible startup mode. Generally, the CQ38W-3576 development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/342)


## Upgrade method
CQ38W-3576 supports firmware update through the following two methods:
...
CQ38W-3576 has three startup modes:

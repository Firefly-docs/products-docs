# RK3588/RK3588S/RK3576 - Artificial Intelligence Algorithm Deployment
> **Scope:** This guide applies to the RK3588/RK3588S/RK3576 main modules installed on the RK182X development kit. It does not describe running these workloads on the RK1820/RK1828 accelerator module.
RK182X Developer Kit supports the deployment of a range of mainstream artificial intelligence algorithms, including but not limited to the following categories of algorithms:
...
In addition to the above artificial intelligence algorithms,see [rknn_model_zoo](https://github.com/airockchip/rknn_model_zoo) for more examples.RK182X Developer Kit also supports large language models. For information on deploying large language models, please refer to the [Large Language Model](usage_llm_rockchip.md) section.

## 1.1 NPU Usage
The RK3588/RK3588S/RK3576 main modules provide a built-in NPU with processing performance of up to 6 TOPS. To use this NPU, download the [RKNN SDK](https://github.com/airockchip/rknn-toolkit2). The RKNN SDK provides C++/Python programming interfaces for deploying RKNN models exported by RKNN-Toolkit2. The overall RKNN workflow has three main parts: model conversion, model evaluation, and board-side deployment and execution.

![](../../../gs1-n2_img/npu_development_process_en.png)

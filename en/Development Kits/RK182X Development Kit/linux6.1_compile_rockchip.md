...
### Rootfs
* Download rootfs here [Debian rootfs(64-bit) Kernel6.1](https://community.t-firefly.com/en/doc/download/140.html), please use rootfs under kernel-6.1 folder.
...
### Rootfs
* Download rootfs here [Ubuntu rootfs(64-bit) Kernel6.1](https://community.t-firefly.com/en/doc/download/140.html), please use rootfs under kernel-6.1 folder.
* Decompress rootfs and create a symbolic link

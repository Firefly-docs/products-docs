...
The dts configuration reference in the Android SDK: `kernel/arch/arm64/boot/dts/rockchip/rk3566-firefly-aiojd4.dtsi`
```
&i2c2 {
    status = "okay";
...
Linux provides three user-space call interfaces. The corresponding path in the AIO-3566JD4 development board is:

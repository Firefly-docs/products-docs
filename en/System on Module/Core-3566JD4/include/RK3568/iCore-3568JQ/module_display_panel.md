...
The official MIPI firmware default support MIPI_DSI1 + HDMI display, MIPI screen connected to AIO-3566JD4 MIPI_DSI1 interface. Below is the link to the firmware: [Firmware link](https://en.t-firefly.com/doc/download/109.html#other_531)

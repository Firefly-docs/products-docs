...
This USB-to-ttl-serial module is based on CP2104, powered via MicroUSB, features a 3-pin header output, onboard three LEDs for status indication, and measures just 25×15.5mm.
...
## 3. Resource Download
[Firefly USB to UART Module (driver)](https://www.silabs.com/software-and-tools/usb-to-uart-bridge-vcp-drivers)

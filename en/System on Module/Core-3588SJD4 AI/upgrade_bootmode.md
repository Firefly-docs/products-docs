...
The AIO-3588SJD4-AI is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIO-3588SJD4-AI has a flexible startup mode. Generally, the AIO-3588SJD4-AI development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/323)


## Upgrade method
AIO-3588SJD4-AI supports firmware update through the following two methods:
...
AIO-3588SJD4-AI has three startup modes:

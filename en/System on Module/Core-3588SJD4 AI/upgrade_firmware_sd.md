...
* USB Card Reader 
* MIrcoSD card
* [**SD_Firmware_Tool**](https://community.t-firefly.com/en/doc/download/337.html#other_499)
## Operation Steps
...
* Choose firmware we want to upgrade into the AIO-3588SJD4-AI
* Click  button `Create` to make it and wait until it is finshed


<center>

![](../../../rk3588_img/common/upgrade_firmware_sd_tool_zh.png)

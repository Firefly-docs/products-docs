...
* Tool: [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/67)
...
Download [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/67). AndroidTool defaults to display in Chinese. We need to change it to English. Open `config.ini` with an text editor (like notepad). The starting lines are:
...
* Tool : [upgrade_tool_xxx (version number)](https://community.t-firefly.com/en/doc/download/67)


### Upgrade_tool

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/67), And install it into the system as follows for easy invocation:
...
[Core-3308Y firmware]: https://community.t-firefly.com/en/doc/download/67
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/67#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/67#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/67#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/67#linux_12

...
The Core-3308Y is installed with the Buildroot operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

Core-3308Y has a flexible startup mode. Generally, the Core-3308Y development board will not turn brick unless the hardware is damaged.
...
## Upgrade method
Core-3308Y supports firmware update through the following two methods:
...
In addition, Core-3308Y supports downloading system codes from the Type-C data cable interface.

## Boot mode

Core-3308Y has three startup modes:

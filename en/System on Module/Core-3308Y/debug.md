...
<font color=#ff0000>**Note:** The default baud rate of Core-3308Y is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
Core-3308Y serial port connection diagram:

![](../../../rk3308_img/Core-3308Y/debug_connection.jpg)

## Parameter Setting

Core-3308Y use the following serial parameters:

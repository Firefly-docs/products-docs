...
<font color=#ff0000>**Note:** The default baud rate of ICORE-1126BQ38 is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
ICORE-1126BQ38 serial port connection diagram:

![](../../../rv1126b_img/ICORE-1126BQ38/debug_connection.jpg)

## Parameter Setting

ICORE-1126BQ38 use the following serial parameters:

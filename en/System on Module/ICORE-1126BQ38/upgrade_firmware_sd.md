...
* USB Card Reader 
* MIrcoSD card
* [**SD_Firmware_Tool**](https://community.t-firefly.com/en/doc/download/377.html#other_499)
## Operation Steps
...
* Choose firmware we want to upgrade into the ICORE-1126BQ38
* Click  button `Create` to make it and wait until it is finshed


<center>

![](../../../rv1126b_img/common/upgrade_firmware_sd_tool_zh.png)

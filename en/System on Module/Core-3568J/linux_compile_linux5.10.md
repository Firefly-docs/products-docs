...
Download Firefly_Linux_SDK sub-volume compressed package: [rk356x_linux5.10_release_20241220_v1.4.0c](http://en.t-firefly.com/doc/download/89.html#other_378), follow the README document:
...
Under `device/rockchip/rk3566_rk3568/` , in addition to firefly_rk3568_aio-3568j_ubuntu_defconfig, there are other configuration files that come with different accessories
...
```bash
MACHINE=aio-3568j-kernel5-10 bitbake core-image-minimal
MACHINE=aio-3568j-kernel5-10 bitbake core-image-minimal-xfce
MACHINE=aio-3568j-kernel5-10 bitbake core-image-x11
MACHINE=aio-3568j-kernel5-10 bitbake core-image-sato
```
...
```bash
MACHINE=aio-3568j-kernel5-10 bitbake core-image-weston
```
...
```bash
MACHINE=aio-3568j-kernel5-10 bitbake core-image-minimal -c clean
MACHINE=aio-3568j-kernel5-10 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=aio-3568j-kernel5-10 bitbake linux-rockchip
        
# u-boot
MACHINE=aio-3568j-kernel5-10 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=aio-3568j-kernel5-10 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=aio-3568j-kernel5-10 bitbake rockchip-librga
        
# See more compilation objects
MACHINE=aio-3568j-kernel5-10 bitbake -s
```
...
```bash
MACHINE=aio-3568j-kernel5-10 bitbake <target> <paramater>
# e.g
MACHINE=aio-3568j-kernel5-10 bitbake u-boot-rockchip -c clean
MACHINE=aio-3568j-kernel5-10 bitbake u-boot-rockchip
```
...
```bash
./build.sh firefly_rk3568_aio-3568j_buildroot_defconfig
```
...
Under `device/rockchip/rk3566_rk3568/` , in addition to firefly_rk3568_aio-3568j_buildroot_defconfig, there are other configuration files that come with different accessories

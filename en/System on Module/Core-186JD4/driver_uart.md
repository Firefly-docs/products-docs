...
The device file for RS485 is `/dev/ttyS4`. Run the following commands on the device (**Note: Before running the commands, the RS485 send function must be enabled, as AIO-186JD4 has a GPIO switch to toggle RS485 between send and receive states.**):

...
The configuration file : *aio-rk1808-jd4-ubuntu.mk*
```
./build.sh aio-rk1808-jd4-ubuntu.mk
# The file path:`device/rockchip/rk1808/aio-rk1808-jd4-ubuntu.mk`
```
...
**Note:** `aio-rk1808-jd4-ubuntu.mk` is configuration file after compiled ubuntu firmware. At the same time, users can also generate new configuration files by referring to this configuration to adapt the firmware they need.
...
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=firefly_rk1808_ubuntu_defconfig          Compile the kernel configuration file
...
export RK_PACKAGE_FILE=rk1808-ubuntu-package-file                   Packaging configuration file

# rootfs image path
export RK_ROOTFS_IMG=ubuntu_rootfs/rk1808_ubuntu18.04_rootfs.img    The root file system image path
```

**<font color=#ff0000 >Attention, very important ! !</font>**

*  [Download the Ubuntu root filesystem image](http://en.t-firefly.com/doc/download/page/id/73.html)
*  Put the resulting image in the specified directory in SDK:

```
// Unpack
7z x rk1808-ubuntu18.04-rootfs.7z

// The root directory of sdk
mkdir ubuntu_rootfs
mv rk1808-ubuntu18.04-rootfs.img ubuntu_rootfs/

// Modify aio-rk1808-jd4-ubuntu.mk
vim device/rockchip/rk1808/aio-rk1808-jd4-ubuntu.mk

// Change the RK_ROOTFS_IMG property to the ubuntu file system image path(ubuntu_xxxx_npu_rootfs.img)
RK_ROOTFS_IMG=ubuntu_rootfs/rk1808-ubuntu18.04-rootfs.img
```
...
1. [Download the Ubuntu root filesystem image](http://en.t-firefly.com/doc/download/page/id/73.html)
...
`parameter.txt` contains firmware partition information is very important. You can find some `parameter.txt` files in `device/rockchip/rk1808` directory. The following is introduced with `parameter-ubuntu.txt` as an example:

# CORE-1808-JD4 brief introduction
- [core-1808-jd4](core-1808-jd4.md)
# Tutorial
- [User manual](started.md)
- [Serial debuge  ](debug.md)
# Upgrade Firmware
...
- [Compiling drivers](linux_compile_driver.md)
# Accessories
- [Conversion module](module_transform.md)
- [Screen module](module_display.md)
- [Camera module](module_camera.md)
- [Wireless module](module_wireless.md)
- [[Power adapter](https://www.firefly.store/products/12v-2a-power-adapter)](module_power_adapter.md)
# NPU Development Guide
- [NPU Brief Introduction to Development](npu_intro.md)
- [RKNN Toolkit](npu_rknn_toolkit.md)
- [RKNN API](npu_rknn_api.md)
# FAQs
# Hardware resources

...
1. Connect the device and host with Dual male USB data cale;
...
<img alt="" src="../../../rk3288_img/AIO-3288J/adb_connection.png" width="700">
</center>
...
check the AIO-3288J IP address, Use command under the PC:
...
First, please reference [Install RK USB driver](upgrade_firmware.md#windows) to get the driver ready.

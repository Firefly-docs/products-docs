...
## RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto ITX-3588J .
...
```
#### Deploy And Run The RKLLM Model On ITX-3588J .
...
./build-linux.sh
```
##### Running Inference On ITX-3588J 

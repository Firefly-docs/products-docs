...
## ITX-3588J  Displays the configuration of the interface
 ...
 ITX-3588J   There are two display output interfaces, namely HDMI and Display Port , which can achieve Dual-screen simultaneous display/exclusive display. The interface diagram is as follows:
...
## ITX-3588J   Dual scene configuration

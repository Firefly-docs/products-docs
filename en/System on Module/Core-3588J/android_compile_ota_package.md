...
```
In the `rockdev/Image-rk3588_firefly_itx_3588j/` directory, find the corresponding firmware and burn it to the machine, then the machine can carry out the full package upgrade and the difference package upgrade,put 'update.zip' into /sdcard/ and restart the full package as prompted.
...
Refer to [OTA Documentation](https://community.t-firefly.com/en/doc/download/140.html#other_549) to setup the sever.
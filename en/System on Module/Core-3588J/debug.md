...
<font color=#ff0000>**Note:** The default baud rate of ITX-3588J  is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
ITX-3588J  serial port connection diagram:

![](../../../rk3588_img/Core-3588J/debug_connection.jpg)

## Parameter Setting

ITX-3588J  use the following serial parameters:

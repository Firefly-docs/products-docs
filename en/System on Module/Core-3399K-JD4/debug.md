...
<font color=#ff0000>**Note:** The default baud rate of Core-3399-JD4 is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
Core-3399-JD4 serial port connection diagram:


<center>

<img alt="" src="../../../rk3399_img/Core-3399-JD4/debug_connection.jpg" width="800">
</center>


## Parameter Setting

Core-3399-JD4 use the following serial parameters:

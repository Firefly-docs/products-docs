...
## Introduction
SPI is a high-speed, full-duplex, synchronous serial communication interface for connecting microcontrollers, sensors, storage devices, etc. Core-3399-JD4 SPI leads to a SPI2(reusable GPIO) for external use. The Core-3399-JD4 development board provides the SPI2 (single chip optional) interface, and the specific position is as follows:


<center>

<img alt="" src="../../../rk3399_img/Core-3399-JD4/spi_interface.jpg" width="900">
</center>
...
The hardware connection between Core-3399-JD4 and W25Q128FV is shown in the following table:

<center>

<img alt="" src="../../../rk3399_img/Core-3399-JD4/spi_hardware_connection.jpg" width="700">
</center>
...
* **spi-max-frequency :** set the highest frequency used by spi here. Core-3399-JD4 supports up to 48000000.
...
Linux provides a SPI user interface with limited functionality. If IRQ or other kernel driver interfaces are not required, consider using `spidev` interface to write user-level programs to control SPI devices. The corresponding path in the Core-3399-JD4 development board is `/dev/spidev0.0`.

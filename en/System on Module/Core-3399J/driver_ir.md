...
The infrared transceiver sensor IR (between the mic interface and speaker interface) is used to realize the remote control function on the AIO-3399J development board, and the infrared receiver is connected to the IR interface. This paper mainly describes how to configure infrared remote control on the development board.

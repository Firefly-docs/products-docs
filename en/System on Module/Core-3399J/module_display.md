...
**Note :** the AIO-3399J motherboard does not carry the mipi_dsi interface by default, and the hardware needs to be modified if this function is needed. Please refer to [LCD driver section](https://wiki.t-firefly.com/en/AIO-3399J/driver_lcd.html) for details.
...
* Note: The official firmware name supporting the 10.1 screen has the word "LVDS". Below is the link to the firmware: [Firmware link](https://community.t-firefly.com/en/doc/download/31)

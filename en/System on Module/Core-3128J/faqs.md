...
You can change MAC address of the Firefly-RK3128 by yourself, and you can program MAC address by UpgradeDllTool (RKTools/windows/UpgradeDllTool_v1.35.zip in SDK).

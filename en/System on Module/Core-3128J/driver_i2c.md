...
## Introduction
There are 4 on-chip I2C controllers in Firefly-RK3128 development board, whose configuration and usage will be introduced below.  
...
```  
Note:
msgs[0] is the command that the host sends to the client, telling what info the host needs.  
msgs[1] is the data received from the client.  

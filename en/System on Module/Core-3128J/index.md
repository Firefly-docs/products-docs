...
- [Customize the Android firmware](customize_android.md)
# Linux
- [Build Kernel](compile_kernel.md)
- [Build Ubuntu Rfs](build_ubuntu_rootfs.md)
- [Ubuntu Server Note](ubuntu_server.md)
# Accessories
- [Cases](module_shell.md)
- [Power Adapter](module_power.md)
- [Serial Module](module_serial.md)
...
- [GPIO Use](driver_gpio.md)
- [I2C Use](driver_i2c.md)
- [IR Use](driver_ir.md)
- [LED Use](driver_led.md)
- [MIPI DSI Use](driver_mipi_dsi.md)
- [PWM Use](driver_pwm.md)
- [SPI Use](driver_spi.md)
- [UART Use](driver_uart.md)
# Other

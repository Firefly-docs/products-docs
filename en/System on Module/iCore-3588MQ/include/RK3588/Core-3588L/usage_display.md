...
## AIO-3588MQ  Displays the configuration of the interface
 ...
 AIO-3588MQ   There are three display output interfaces, namely HDMI, Display Port and MIPI DSI, which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* HDMI0/ HDMI1/ Display Port 
![](../../../rk3588_img/iCore-3588MQ/usage_display_interface.png)  

* MIPI DSI0/ MIPI DSI1
![](../../../rk3588_img/iCore-3588MQ/usage_display_dsi_interface.png) 

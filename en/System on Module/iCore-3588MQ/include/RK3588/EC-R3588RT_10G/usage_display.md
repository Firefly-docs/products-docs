...
## AIO-3588MQ  Displays the configuration of the interface
 ...
 AIO-3588MQ   There are two display output interfaces, namely HDMI and Display Port , which can achieve Dual-screen simultaneous display/exclusive display. The interface diagram is as follows:
...
## AIO-3588MQ   Dual scene configuration

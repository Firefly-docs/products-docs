...
* [Firmware](https://community.t-firefly.com/en/doc/download/161)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/161). There are two types of firmware files:
...
<img alt="" src="../../../rk3588_img/Core-3588L/upgrade_maskrom_key.png" width="800">
</center>
...
[Core-3588L firmware]: https://community.t-firefly.com/en/doc/download/161

...
Run yolov5 demo on the AIO-3588L as follows:
```shell
...
#### Run on AIO-3588L NPU connected to the PC

RKNN Toolkit2 runs on the PC and connects to the AIO-3588L through the PC's USB. RKNN Toolkit2 transfers the RKNN model to the NPU device of AIO-3588L to run, and then obtains the inference results, performance information, etc. from the AIO-3588L


* First prepare AIO-3588L environment: update librknnrt.so and run rknn_server

...
The ROC-RK3506B-CC is installed with the one kind of operating system by default. If users want to run other operating systems, they need to download the corresponding firmware to the mainboard.

ROC-RK3506B-CC has a flexible startup mode. Generally, the ROC-RK3506B-CC development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/297)


## Upgrade method
ROC-RK3506B-CC supports firmware update through the following two methods:
...
ROC-RK3506B-CC has three startup modes:

...
AIO-3576JQ has a MIPI DSI display output interface, support DPHY2.0 and 4 Lane data output.
...
AIO-3576JQ has a LVDS display output interface，and resolution can support up to 2K by TTL to LVDS .
...
AIO-3576JQ  Hardware reserve an eDP display output interface 40Pin / 30Pin (default hardware used as HDMI function) :

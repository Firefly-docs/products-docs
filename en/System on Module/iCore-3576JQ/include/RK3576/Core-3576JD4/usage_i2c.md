...
AIO-3576JQ board exported 2 I2C for user.

![](../../../rk3576_img/iCore-3576JQ/usage_i2c_interface.jpg)

I2C0 (which is I2C5 in picture)and I2C3 (which is I2C4 in picture)

Why the actual I2Cs does not match the prints on PCB ? Because this motherboard supports different core boards.

When it match with iCore-3576JQ, the actual I2Cs are I2C0 and I2C3.
...
### Q3: How to deal with a peripheral requires a stop signal in the middle of a read sequence rather than a repeat start signal ?

...
<img alt="" src="../../../bm1684_img/Core-1684XJD4/rs232_connection.png" width="700">
</center>

### Serial parameter configuration

Core-1684XJD4 uses the following serial port parameters:
...
**Note:** The default baud rate for Core-1684XJD4 is 115200.

...
Core-1684XJD4 uses TF card to upgrade firmware, users need to strictly follow the steps below.
...
(3) Insert the TF card into the TF card slot of Core-1684XJD4, and then turn on the power;

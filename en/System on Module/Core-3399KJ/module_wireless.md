...
Ensure that the firmware is the latest [public firmware](https://en.t-firefly.com/doc/download/31.html). The firmware turns off the GPS function by default and needs to be enabled manually. The following is the modification method:

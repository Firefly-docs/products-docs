...
The AIO-3399J is installed with the Android operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIO-3399J has a flexible startup mode. Generally, the AIO-3399J development board will not turn brick unless the hardware is damaged.
...
[Firmware download link](https://community.t-firefly.com/en/doc/download/31)

## Upgrade method

AIO-3399J supports firmware update through the following two methods:
...
AIO-3399J  has three startup modes:

...
The AIO-3399J development board is equipped with two LCD screen interfaces, one is EDP and the other is LVDS. The positions of the interfaces on the board are as follows:

<center>

<img alt="" src="../../../rk3399_img/AIO-3399J/lcd_interface.jpg" width="900">
</center>
...
AIO-3399J SDK has LVDS DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399-firefly-aio-lvds.dts, we can see the following statement from this file:
```
/ {
...
<img alt="" src="../../../rk3399_img/AIO-3399J/lcd_back_light.jpg" width="700">
</center>

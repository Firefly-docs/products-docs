...
**Note:** The Core-1684JD4 all-in-one machine requires a 12V/5A power supply for normal operation. If the current is lower than 5A, it may restart abnormally due to insufficient current. To ensure normal operation of the development board, use a power supply with 12V voltage and 5A current. Firefly official power accessories are recommended.

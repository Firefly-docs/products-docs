...
After obtaining the installation package, transfer it to Core-1684JD4 and run the following command to install it:
...
After obtaining the model file, transfer it to Core-1684JD4 and run the following command to import it:

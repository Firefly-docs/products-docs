...
2. Make sure the dip switch is set to "1"

3. Use Type-A to Tyep-C USB cable to connected device's download port with PC.

4. Press download button and hold.

5. Insert the DC power supply.

6. After 2 sec, release the download button.

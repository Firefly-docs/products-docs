...
The Core-3399-JD4 development board has two kinds of AD interface, respectively: Temperature Sensor and Successive Approximation Register. Among them:
...
### Configure DTS nodes
The SAR-ADC nodes of Core-3399-JD4 defined in `kernel/arch/arm64/boot/dts/rockchip/rk3399.dtsi` file, as showm below:
...
Demo is a driver that detects the status of Core-3399-JD4's fan. First, define the `of_device_id` structure array in the driver file:
...
Compile the kernel, upgrade the kernel to Core-3399-JD4 development board, and then plug out the fan, the kernel log information will be printed as follows:

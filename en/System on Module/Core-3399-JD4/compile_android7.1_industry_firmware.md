...
Google Drive[[bundle download]](https://community.t-firefly.com/en/doc/download/134#other_230)




## Core-3399-JD4 industry version product compilation method
...
* Modify `device/rockchip/rk3399/rk3399_firefly_aiojd4.mk`
```
...
### Compile step by step Core-3399-JD4
...
[Android7.1 industry SDK]: https://community.t-firefly.com/en/doc/download/134#other_230

...
**Note:** the Core-3399-JD4 motherboard does not carry the mipi_dsi interface by default, and the hardware needs to be modified if this function is needed. Please refer to [LCD driver section](https://wiki.t-firefly.com/en/Core-3399-JD4/driver_lcd.html) for details.
...
Note: The default Core-3399-JD4 motherboard does not have a mipi_dsi interface. If you need this function, you need to modify the hardware. For details, please refer to [LCD Driver Chapter](driver_lcd.md)

...
## Core-3399-JD4 interface definition

Core-3399-JD4is a mini PC motherboard, the size is only the size of a small mobile phone, but it provides a rich interface, including:

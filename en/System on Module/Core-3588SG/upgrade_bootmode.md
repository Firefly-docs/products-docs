...
The AIO-3588SG is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIO-3588SG has a flexible startup mode. Generally, the AIO-3588SG development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/201)


## Upgrade method
AIO-3588SG supports firmware update through the following two methods:
...
AIO-3588SG has three startup modes:

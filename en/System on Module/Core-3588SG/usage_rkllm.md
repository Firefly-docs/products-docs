...
## RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto AIO-3588SG.
...
```
#### Deploy And Run The RKLLM Model On AIO-3588SG.
...
./build-linux.sh
```
##### Running Inference On AIO-3588SG

...
AIO-3588SG development board includes an integrated, on-chip watchdog. This section will show you how to manage it.

## DTS configuration

The watchdog node of AIO-3588SG defined in `kernel-5.10/arch/arm64/boot/dts/rockchip/rk3588s.dtsi`, as showm below:

...
Currently Core-3588SG only supports 1 Gigabit port (Ethernet0), but a second Gigabit port (Ethernet1) can be extended via the 164 Pin interface.  


![](../../../rk3588_img/Core-3588SG/usage_ethernet_interface.jpg)

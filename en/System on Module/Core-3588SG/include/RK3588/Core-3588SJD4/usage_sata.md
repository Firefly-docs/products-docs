...
## Introduction
There are 1 SATA ports and 1 M.2 SATA port on the AIO-3588SG development board.

![](../../../rk3588_img/Core-3588SG/usage_sata_interface.jpg)
![](../../../rk3588_img/Core-3588SG/usage_sata2_interface.jpg)
...
The 1 SATA ports and 1 M.2 SATA port on the AIO-3588SG development board are all ports extended by the `USB3.0` expansion chip.
### DTS configuration

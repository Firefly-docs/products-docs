# HDMI-IN  
AIO-3588SG has an HDMI-IN interface, which supports the standard HDMI2.0 protocol, It  supports the following features：  
...
![](../../../rk3588_img/Core-3588SG/usage_hdmiin_interface.jpg)  

Currently, there are APK and command methods to debug HDMI-IN functions.

## Android uses HDMI-IN

By default, the Android system of AIO-3588SG have two APKs,one named **Live Tv**, another named **RockchipCamera2**,as shown below:
![](../../../rk3588_img/common/usage_hdmiin_rk3588_apk.png)  

Directly click on the APK to display the video input of HDMI-IN, and the audio input of HDMI-IN will be output from the AIO-3588SG headphone, HDMI, Display Port and other interfaces.

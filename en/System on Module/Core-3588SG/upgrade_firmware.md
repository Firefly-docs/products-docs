...
* AIO-3588SG development board
* [Firmware](https://community.t-firefly.com/en/doc/download/201)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/201). There are two types of firmware files:
...
<img alt="" src="../../../rk3588_img/Core-3588SG/upgrade_recovery_reset.png" width="800">
</center>
...
2. Hold the MaskRom button on AIO-3588SG or tweeze the two test points on Core-3588SG (both shown below)  
...
<img alt="" src="../../../rk3588_img/Core-3588SG/upgrade_maskrom_test_points_key.jpg" width="800">
</center>
...
<img alt="" src="../../../rk3588_img/Core-3588SG/upgrade_maskrom_test_points_core.jpg" width="800">
</center>

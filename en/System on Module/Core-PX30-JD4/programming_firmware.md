...
* You can find the compiled unified [AIO-PX30-JD4 firmware](https://community.t-firefly.com/en/doc/download/67) here, download it and unpack it. You can also refer to the instructions for compiling firmware to compile by yourself.
...
Download [AndroidTool](https://community.t-firefly.com/en/doc/download/67). AndroidTool defaults to display in Chinese. We need to change it to English. Open `config.ini` with an text editor (like notepad). The starting lines are:
...
Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/65), And install it into the system as follows for easy invocation:

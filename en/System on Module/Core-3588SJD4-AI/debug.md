...
<font color=#ff0000>**Note:** The default baud rate of AIO-3588SJD4-AI is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
AIO-3588SJD4-AI serial port connection diagram:

![](../../../rk3588_img/Core-3588SJD4-AI/debug_connection.jpg)

## Parameter Setting

AIO-3588SJD4-AI use the following serial parameters:
...
![](../../../rk3588_img/common/debug_find_com.jpg)
...
![](../../../rk3588_img/common/debug_set_moba_xterm1.png)
![](../../../rk3588_img/common/debug_set_moba_xterm2.png)

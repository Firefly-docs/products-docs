...
AIO-3588SJD4-AI has one RS232 interfaces and one RS485 interface

The serial interface diagram of the AIO-3588SJD4-AI development board is as follows:

![](../../../rk3588_img/Core-3588SJD4-AI/usage_uart_interface.jpg)
...
Users can use different host's USB-to-serial adapters to send and receive data to the serial port of the development board according to different interfaces. For example, the debugging steps of RS485 are as follows(AIO-3588SJD4-AI RS485 is half-duplex and requires gpio to control transmission and reception):

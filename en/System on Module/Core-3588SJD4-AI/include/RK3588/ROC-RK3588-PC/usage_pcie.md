...
## Introduction
There is one PCIe3.0 x 4 interface on the Core-3588SJD4-AI development board, as shown in the figure:
...
The PCIe3.0 x 4 interface on the Core-3588SJD4-AI development board uses the `PCIe Gen3 x 4 lane` set of resources of the RK3588.
### DTS configuration

...
## AIO-3588SJD4-AI Displays the configuration of the interface
 ...
 AIO-3588SJD4-AI  There are five display output interfaces, namely HDMI, Display Port, VGA ,EDP and MIPI DSI, which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:
...
AIO-3588SJD4-AI There are one EDP display output interfaces,and can output up to 4096x2304@60Hz (depending on the connected Portx).

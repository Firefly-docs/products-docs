...
## AIO-3588SJD4-AI Displays the configuration of the interface
 ...
 AIO-3588SJD4-AI  There are three display output interfaces, namely eDP, Display Port and MIPI DSI, which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* eDP/ Display Port/ MIPI DSI1
![](../../../rk3588_img/Core-3588SJD4-AI/usage_display_interface-B.png)   
...
AIO-3588SJD4-AI has a Display Port display output interface, supports DP TX 1.4a protocol, and resolution can support up to 7680x4320@30Hz.<br>
...
AIO-3588SJD4-AI has one EDP display output interface, up to 4096x2304@60Hz

#### Software configuration

EDP software configuration, external screen is 15.6 inch NV156FHM-T06 screen (name needs to be discussed).
* EDP interface<br>
![](../../../rk3588_img/Core-3588SJD4-AI/usage_display_edp_1080_interface.png)

* screen power-on/power-down timing<br>
![](../../../rk3588_img/Core-3588SJD4-AI/usage_display_edp_NV156FHM-T06.png)

...
* `kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588sjd4-mipi101-M101014-BE45-A1.dts`  


### HDMI

AIO-3588SJD4-AI There are one HDMI display output interfaces on the hardware:
...
--- a/kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588sjd4.dtsi
+++ b/kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588sjd4.dtsi
@@ -94,7 +94,7 @@ &dp0 {
...
```
diff --git a/kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588sjd4.dtsi b/kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588sjd4.dtsi
...
Combining AIO-3588SJD4-AI  DSI1 interface and screen timing
...
backlight: backlight {
	...
        ...
        enable-gpios = <&pca9555 PCA_IO1_1 GPIO_ACTIVE_HIGH>;
        pwms = <&pwm3 0 50000 1>;
...
&dsi1 {
	...
	enable-gpios = <&pca9555 PCA_IO1_0 GPIO_ACTIVE_HIGH>;

	//sets the LCD reset pin
	reset-gpios = <&pca9555 PCA_IO1_2 GPIO_ACTIVE_LOW>;
...
&i2c6{
	...
	//set the reset pin for the touch function
        himax,rst-gpio =  <&pca9555 PCA_IO1_3 GPIO_ACTIVE_HIGH>;

	//sets the interrupt pin for the touch function
        himax,irq-gpio = <&gpio4 RK_PB2 IRQ_TYPE_LEVEL_HIGH>;
        pinctrl-names = "default";

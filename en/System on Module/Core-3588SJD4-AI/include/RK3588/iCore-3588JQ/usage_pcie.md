...
## Introduction
There is 1 PCIe3.0 x 4 interface on the AIO-3588JQ development board, as shown in the figure:

![](../../../rk3588_img/Core-3588SJD4-AI/usage_pcie_interface.jpg)
...
![](../../../rk3588_img/Core-3588SJD4-AI/usage_pcie_to_m2.png)
...
![](../../../rk3588_img/Core-3588SJD4-AI/usage_pcie_phy_en.jpg)

The PCIe3.0 x 4 interface on the AIO-3588JQ development board uses the `PCIe Gen3 x 4 lane` set of resources of the RK3588.
### DTS configuration

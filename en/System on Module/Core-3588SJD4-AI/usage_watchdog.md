...
AIO-3588SJD4-AI development board includes an integrated, on-chip watchdog. This section will show you how to manage it.

## DTS configuration

The watchdog node of AIO-3588SJD4-AI defined in `kernel-5.10/arch/arm64/boot/dts/rockchip/rk3588s.dtsi`, as showm below:

...
* EXT-iCore-3576Q38 development board
* [Firmware](https://community.t-firefly.com/en/doc/download/page/id/341.html)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/page/id/341.html). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/page/id/341.html#other_11), extract, and then run the DriverInstall.exe inside . 
...
You can also download [AndroidTool](https://community.t-firefly.com/en/doc/download/page/id/341.html#other_500) separately, unzip it, and run `RKDevTool.exe` in the `RKDevTool_Release_v2.xx` directory (note that if you are running Windows 7/8, you need to right-click and select Run as administrator), as shown below:
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/page/id/341.html#other_502)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/page/id/341.html#other_502), And install it into the system as follows for easy invocation:
...
* [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/page/id/341.html#other_565)

Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/page/id/341.html#other_565), And install it into the system as follows for easy invocation:
...
EXT-iCore-3576Q38 does not able to enter loader mode in hardware way.

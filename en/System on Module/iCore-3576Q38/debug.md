...
<font color=#ff0000>**Note:** The default baud rate of EXT-iCore-3576Q38 is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
EXT-iCore-3576Q38 serial port connection diagram:

![](../../../rk3576_img/iCore-3576Q38/debug_connection.jpg)

## Parameter Setting

EXT-iCore-3576Q38 use the following serial parameters:
...
![](../../../rk3576_img/common/debug_find_com.jpg)
...
![](../../../rk3576_img/common/debug_set_moba_xterm1.png)
![](../../../rk3576_img/common/debug_set_moba_xterm2.png)

...
* USB Card Reader 
* MIrcoSD card
* [**SD_Firmware_Tool**](https://community.t-firefly.com/en/doc/download/page/id/341.html#other_499)
## Operation Steps
...
* Choose firmware we want to upgrade into the EXT-iCore-3576Q38
* Click  button `Create` to make it and wait until it is finshed


<center>

![](../../../rk3576_img/common/upgrade_firmware_sd_tool_zh.png)

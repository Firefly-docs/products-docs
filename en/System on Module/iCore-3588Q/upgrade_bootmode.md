...
The AIO-3588Q  is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIO-3588Q  has a flexible startup mode. Generally, the AIO-3588Q  development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/181)


## Upgrade method
AIO-3588Q  supports firmware update through the following two methods:
...
AIO-3588Q  has three startup modes:

...
iCore-3588Q The following figure shows the serial port of the hardware version：

![](../../../rk3588_img/iCore-3588Q/usage_adc_interface.jpg)

## Introduction

The AIO-3588Q  development board has two kinds of AD interface, respectively: Temperature Sensor and Successive Approximation Register. Among them:
...
### Configure DTS nodes
The SAR-ADC nodes of AIO-3588Q  defined in `kernel/arch/arm64/boot/dts/rockchip/rk3588s.dtsi` file, as showm below:
...
The user driver can refer to Firefly adc demo: `kernel/drivers/iio/adc/adc-firefly-demo.c`, which is a driver that detects the status of AIO-3588Q 's fan. First, define the `of_device_id` structure array in the driver file:
...
Compile the kernel, upgrade the kernel to AIO-3588Q  development board, and then plug out the fan, the kernel log information will be printed as follows:

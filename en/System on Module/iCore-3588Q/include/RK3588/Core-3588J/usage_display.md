...
## AIO-3588Q  Displays the configuration of the interface

 AIO-3588Q   There are four display output interfaces, namely HDMI, Display Port, VGA and MIPI DSI, which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:
...
AIO-3588Q  There are two HDMI display output interfaces on the hardware:
...
AIO-3588Q  has a Display Port display output interface, supports DP TX 1.4a protocol, and resolution can support up to 7680x4320@30Hz.
...
AIO-3588Q  has a VGA display output interface, which is implemented by DP to VGA chip. Limited by the VGA protocol, the resolution can support up to 1080p@60Hz.
...
AIO-3588Q  There are two MIPI DSI display output interfaces, both support DPHY2.0 and 4 Lane data output, and can output up to 4096x2304@60Hz (depending on the connected Portx).
...
Combining AIO-3588Q   DSI0 interface and screen timing
...
## AIO-3588Q   Multiscreen scene configuration

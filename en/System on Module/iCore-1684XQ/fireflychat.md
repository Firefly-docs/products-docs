...
After obtaining the installation package, transfer it to iCore-1684XQ and run the following command to install it:
...
After obtaining the model file, transfer it to iCore-1684XQ and run the following command to import it:

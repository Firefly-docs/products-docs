...
# Upgrade Firmware
- [Use TF card to upgrade firmware](fw-upgrade-by-sdcard.md)
- [Upgrade and downgrade between old and new firmware](fw-upgrade-and-downgrade.md)
# Linux
- [Sophon SDK development](sophon-sdk.md)
# Driver
- [GPIO](driver_gpio.md)
- [LED](driver_led.md)
- [RELAY](driver_relay.md)
- [SATA ](driver_sata.md)
- [RTC](driver_rtc.md)
- [UART](driver_uart.md)
# Accessories

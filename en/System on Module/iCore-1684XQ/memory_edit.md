...
A portion of the memory of iCore-1684XQ is allocated to NPU, VPP, and VPU devices. So the memory data obtained using commands such as `free -h` is inconsistent with the actual memory of iCore-1684XQ.
...
Obtain the memory allocation tool package from [Download Center] and transfer it to iCore-1684XQ. Run the following command to decompress the package:

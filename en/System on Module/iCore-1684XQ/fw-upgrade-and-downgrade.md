...
Download `sophgo-bsp-mcu-sm7mini_20230906_arm64.deb` and upload it to the board. Then run the following command on the board:

    sudo dpkg -i sophgo-bsp-mcu-sm7mini_20230906_arm64.deb
...
[Download Center]: https://community.t-firefly.com/en/doc/download/184.html
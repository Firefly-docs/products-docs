...
The Core-1126-JD4 is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

Core-1126-JD4 has a flexible startup mode. Generally, the Core-1126-JD4 development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/101)


## Upgrade method
Core-1126-JD4 supports firmware update through the following two methods:
...
Core-1126-JD4 loads the system from the following memory:
...
Core-1126-JD4 has three startup modes:

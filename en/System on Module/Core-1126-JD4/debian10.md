...
1. The system does not have built-in rockchip supporting IPC applications. There is no built-in ArcSoft Facial_Gate and UVC demo sample applications. If you need to use the above supporting resources, please download the corresponding buildroot firmware on the [Resource Download](https://community.t-firefly.com/en/doc/download/88) page.

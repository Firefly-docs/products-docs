...
Linux provides three user-space call interfaces. The corresponding path in the AIO-3562JQ development board is:
...
You can use `ioctl` to control `/dev/rtc0` in C programs.

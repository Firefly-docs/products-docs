...
![](../../../bm1688_img/Core-1688JD4/vnc-01.png)

(3) Enter the `$bm1688_ip:0` address of Core-1688JD4:

![](../../../bm1688_img/Core-1688JD4/ubuntu-vnc-02.png)

(4) Click the circular button next to the linaro username, select xfce, and enter the username and password, both are `linaro`:

![](../../../bm1688_img/Core-1688JD4/ubuntu-vnc-03.png)

(5) Successfully enter the xfce4 desktop:

![](../../../bm1688_img/Core-1688JD4/ubuntu-vnc-04.png)
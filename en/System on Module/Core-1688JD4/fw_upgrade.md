...
Core-1688JD4 uses a TF card to upgrade the firmware, and users must strictly follow the steps below.
...
(3) Insert the TF card into the TF card slot of the Core-1688JD4, then power on;

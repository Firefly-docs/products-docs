...
Download Firefly_Linux_SDK sub-volume compressed package: [rk356x_linux5.10_release_20241220_v1.4.0c](https://community.t-firefly.com/en/doc/download/150), follow the README document:
...
Under `device/rockchip/rk3566_rk3568/` , in addition to firefly_rk3568_itx-3568q_buildroot_defconfig, there are other configuration files that come with different accessories
...
* Download: [Ubuntu rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/150)，put in SDK path
...
```bash
MACHINE=itx-3568jq-kernel5-10 bitbake core-image-minimal
MACHINE=itx-3568jq-kernel5-10 bitbake core-image-minimal-xfce
MACHINE=itx-3568jq-kernel5-10 bitbake core-image-x11
MACHINE=itx-3568jq-kernel5-10 bitbake core-image-sato
```
...
```bash
MACHINE=itx-3568jq-kernel5-10 bitbake core-image-weston
```
...
```bash
MACHINE=itx-3568jq-kernel5-10 bitbake core-image-minimal -c clean
MACHINE=itx-3568jq-kernel5-10 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=itx-3568jq-kernel5-10 bitbake linux-rockchip
        
# u-boot
MACHINE=itx-3568jq-kernel5-10 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=itx-3568jq-kernel5-10 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=itx-3568jq-kernel5-10 bitbake rockchip-librga
        
# See more compilation objects
MACHINE=itx-3568jq-kernel5-10 bitbake -s
```
...
```bash
MACHINE=itx-3568jq-kernel5-10 bitbake <target> <paramater>
# e.g
MACHINE=itx-3568jq-kernel5-10 bitbake u-boot-rockchip -c clean
MACHINE=itx-3568jq-kernel5-10 bitbake u-boot-rockchip
```

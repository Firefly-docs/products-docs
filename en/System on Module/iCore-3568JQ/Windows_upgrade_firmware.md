[Linux_adb_fastboot]: https://en.t-firefly.com/doc/download/150.html#other_536
[Androidtool_xxx (version number)]: https://en.t-firefly.com/doc/download/150.html#other_365
[Release_DriverAssistant.zip]: https://en.t-firefly.com/doc/download/150.html#other_366
[Linux_Upgrade_Tool]: https://en.t-firefly.com/doc/download/150.html#other_367# Upgrading firmware on Windows

## Preface

This article describes how to burn the firmware file on the host computer to the flash memory of the iCore-3568JQ development board through 双公头USB数据线. When upgrading, you need to choose an appropriate upgrade method according to the host operating system and firmware type.

## Preparatory work

* iCore-3568JQ development board
* Firmware
* Host computer

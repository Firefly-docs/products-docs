...
<font color=#ff0000>**Note:** The default baud rate of ITX-3568Q is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
![](../../img/iCore-3568JQ/debug_connection.jpg)

## Parameter Setting

ITX-3568Q use the following serial parameters:

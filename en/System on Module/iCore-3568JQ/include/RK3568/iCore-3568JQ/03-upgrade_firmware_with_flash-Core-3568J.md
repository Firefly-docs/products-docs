...
#### The Method from Firefly
This method needs to burn the unified firmware twice. For the first time, directly burn the repair firmware [RK356x_NorFlash2eMMC-Loader_xxx.img](https://en.t-firefly.com/doc/download/150.html#other_480) provided by Firefly under Maskrom, the firmware will automatically erase Nor-Flash and switch to the loader mode of EMMC. 
For the second time, directly burn the firmware you need to upgrade 

##### Operating under Windows system 
* upgrade RK356x_NorFlash2eMMC-Loader_xxx.img
![](../../img/Core-3568J/firefly_nor2emmc_1.png)

* wait for about 20s after burning successfully, and the system enters loader mode 
![](../../img/Core-3568J/firefly_nor2emmc_2.PNG)

* Click `Firmware` button again to select the firmware to be updated, such as update.img, and then click `Upgrade` button to upgrade 
![](../../img/Core-3568J/firefly_nor2emmc_3.PNG)

##### Operating under Linux system 
```shell
...
```shell
#Android SDK
rockdev/Image-rk3568_firefly_itx_3568q/MiniLoaderAll.bin

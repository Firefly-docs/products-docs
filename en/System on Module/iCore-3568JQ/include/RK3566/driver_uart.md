...
ITX-3568Q supports  UART3, UART5(disabled by default, Serial port and SPI multiplexing), RS232(UART9), and RS485(UART0). Each UART has a 256-byte FIFO buffer for data receiving and sending. Among them:
...
* UART
![](../../img/iCore-3568JQ/uart1_interface.jpg)
* RS232
![](../../img/iCore-3568JQ/rs232_interface.jpg)
* RS485
![](../../img/iCore-3568JQ/rs485_interface.jpg)

...
Download Firefly_Linux_SDK sub-volume compressed package: [Linux SDK](https://community.t-firefly.com/en/doc/download/149.html), follow the README document:
...
# Kernel dts
export RK_KERNEL_DTS=aio-3588sjd4.dts
...
* Download: [Ubuntu rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/149.html)，put in SDK path
...
```bash
MACHINE=aio-3588sjd4 bitbake core-image-minimal
MACHINE=aio-3588sjd4 bitbake core-image-minimal-xfce
MACHINE=aio-3588sjd4 bitbake core-image-x11
MACHINE=aio-3588sjd4 bitbake core-image-sato
```
...
```bash
MACHINE=aio-3588sjd4 bitbake core-image-weston
```
...
```bash
MACHINE=aio-3588sjd4 bitbake core-image-minimal -c clean
MACHINE=aio-3588sjd4 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=aio-3588sjd4 bitbake linux-rockchip
        
# u-boot
MACHINE=aio-3588sjd4 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=aio-3588sjd4 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=aio-3588sjd4 bitbake rockchip-librga
        
# See more compilation objects
MACHINE=aio-3588sjd4 bitbake -s
```
...
```bash
MACHINE=aio-3588sjd4 bitbake <target> <paramater>
# e.g
MACHINE=aio-3588sjd4 bitbake u-boot-rockchip -c clean
MACHINE=aio-3588sjd4 bitbake u-boot-rockchip
```
...
```bash
./build.sh aio-3588sjd4-debian.mk
```
...
* Download: [Debian rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/149.html)，put in SDK path
...
```bash
./build.sh aio-3588sjd4-buildroot.mk
```

...
The dts configuration reference in the Android SDK: `kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588sjd4.dtsi`
```
&i2c2 {
    status = "okay";
...
Linux provides three user-space call interfaces. The corresponding path in the AIO-3588SJD4  development board is:

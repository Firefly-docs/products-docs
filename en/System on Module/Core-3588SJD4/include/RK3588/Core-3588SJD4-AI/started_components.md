...
**Core-3588SJD4** uses Rockchip's flagship AIoT chip RK3588S, built on an advanced 8nm LP process. It features an octa-core 64-bit CPU with a clock speed of up to 2.4GHz, an intergrated ARM Mali-G610 MP4 quad-core GPU, and a built-in AI-accelerator NPU delivering 6 TOPS of computing power. RK3588S optimizes performance for diverse AI applications.

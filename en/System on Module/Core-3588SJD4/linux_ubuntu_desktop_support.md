...
Core-3588SJD4 The Ubuntu Desktop system is based on the Ubuntu 64bit system. Currently, Ubuntu 18.04 has been released. Has the following characteristics:

...
<font color=#ff0000>**Note:** The default baud rate of AIO-3588SJD4  is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
AIO-3588SJD4  serial port connection diagram:

![](../../../rk3588_img/Core-3588SJD4/debug_connection.jpg)

## Parameter Setting

AIO-3588SJD4  use the following serial parameters:

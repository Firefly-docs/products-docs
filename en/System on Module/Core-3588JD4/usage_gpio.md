...
AIO-3588JD4 have 5  GPIO bank：GPIO0~GPIO4，Each group was numbered A0~A7, B0~B7, C0~C7, and D0~D7, the following formulas are often used to calculate GPIO Pin:
...
| --- | --- | --- | --- |
| GPIO0_B4 | I2C1_SDA | PCIE20_BUTTONRSTn | MCU_JTAG_TCK |

...
The dts configuration reference in the Android SDK: `kernel-5.10/arch/arm64/boot/dts/rockchip/rk3588-diff.dtsi` and
...
Linux provides three user-space call interfaces. The corresponding path in the AIO-3588JQ  development board is:

...
AIO-3588JQ  has one RS232 interfaces and one RS485 interface

The serial interface diagram of the AIO-3588JQ  development board is as follows:
...
Users can use different host's USB-to-serial adapters to send and receive data to the serial port of the development board according to different interfaces. For example, the debugging steps of RS485 are as follows(AIO-3588JQ  RS485 is half-duplex and requires gpio to control transmission and reception):

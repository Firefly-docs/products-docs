...
Currently iCore-3588JQ only supports 1 Gigabit port (Ethernet0), but a second Gigabit port (Ethernet1) can be extended via the 164 Pin interface.  


![](../../../rk3588_img/iCore-3588JQ/usage_ethernet_interface.jpg)

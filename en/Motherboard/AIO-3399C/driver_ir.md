...
The infrared transceiver sensor IR (between the headphone interface and recovery) is used to realize the remote control function on the AIO-3399C development board, and the infrared receiver is connected to the IR interface. This paper mainly describes how to configure infrared remote control on the development board.

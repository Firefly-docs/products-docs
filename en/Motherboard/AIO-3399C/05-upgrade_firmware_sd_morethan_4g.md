...
Go to [SD Firmware Tool Download Page](https://community.t-firefly.com/en/doc/download/52#other_125) to download `SD_Firmware_Tool` and unzip it.

### Run `SD_Firmware_Tool.exe`
![](../../../rk3399_img/sdfirmwaretool.en.jpg)

1. Download the SD card maker tool: [SD_Firmware_Tool](https://community.t-firefly.com/en/doc/download/52#other_125)

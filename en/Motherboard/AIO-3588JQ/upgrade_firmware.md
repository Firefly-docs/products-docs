...
* AIO-3588JQ  development board
* [Firmware](https://community.t-firefly.com/en/doc/download/184)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/184). There are two types of firmware files:
...
<img alt="" src="../../../rk3588_img/iCore-3588JQ/upgrade_otg_interface.jpg" width="900">
</center>

* Press the `RECOVERY` button on the device and hold.
<center>

<img alt="" src="../../../rk3588_img/iCore-3588JQ/upgrade_recovery_reset.jpg" width="800">
</center>
...
2. Hold the MaskRom button on AIO-3588JQ  or tweeze the two test points on iCore-3588JQ (both shown below)  
...
* the button of  AIO-3588JQ 
<center>

<img alt="" src="../../../rk3588_img/iCore-3588JQ/upgrade_maskrom_test_points_key.jpg" width="800">
</center>
  
  
*  two test points of iCore-3588JQ
<center>

<img alt="" src="../../../rk3588_img/iCore-3588JQ/upgrade_maskrom_test_points_core.jpg" width="800">
</center>
...
[iCore-3588JQ firmware]: https://community.t-firefly.com/en/doc/download/184
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/184#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/184#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/184#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/184#linux_12

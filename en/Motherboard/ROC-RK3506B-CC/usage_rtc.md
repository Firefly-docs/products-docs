...
ROC-RK3506B-CC development BOARD uses TT8563RH as RTC(*Real Time Clock*), TT8563RH is a low power CMOS real-time Clock/calendar chip, it provides a programmable Clock output, an interrupt Output and a power down detector, all addresses and data are passed serially through the I2C bus interface.
...
Linux provides three user-space call interfaces. The corresponding path in the ROC-RK3506B-CC development board is:
...
<font color=red>**Attention: ROC-RK3506B-CC not support scheduled power-on.**</font>

...
* ROC-RK3506B-CC development board
* [Firmware](https://community.t-firefly.com/en/doc/download/310.html)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/310.html). There are two types of firmware files:

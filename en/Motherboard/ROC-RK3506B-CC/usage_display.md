...
## ROC-RK3506B-CC Display interface configuration
...
ROC-RK3506B-CC has one MIPI DSI display output interface, supports 2 Lane data output, and can output up to 1280x1280@60Hz.

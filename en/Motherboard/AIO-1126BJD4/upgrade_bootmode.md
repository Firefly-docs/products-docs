...
The CORE-1126BJD4 is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

CORE-1126BJD4 has a flexible startup mode. Generally, the CORE-1126BJD4 development board will not turn brick unless the hardware is damaged.
...
## Upgrade method
CORE-1126BJD4 supports firmware update through the following two methods:
...
CORE-1126BJD4 loads the system from the following memory:
...
CORE-1126BJD4 has three startup modes:

...
Run yolov5 demo on the CORE-1126BJD4 as follows:
```shell
...
#### Run on CORE-1126BJD4 NPU connected to the PC

RKNN Toolkit2 runs on the PC and connects to the CORE-1126BJD4 through the PC's USB. RKNN Toolkit2 transfers the RKNN model to the NPU device of CORE-1126BJD4 to run, and then obtains the inference results, performance information, etc. from the CORE-1126BJD4


* First prepare CORE-1126BJD4 environment: update librknnrt.so and run rknn_server

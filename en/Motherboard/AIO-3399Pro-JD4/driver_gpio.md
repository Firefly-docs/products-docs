...
From the above information, we can see that the kernel lists the current state of GPIO. Take GPIO1 group as example, gpio-33 (GPIO1_A1) is the power control pin (vcc3v3_3g) of 3G module, and output high level (out hi).

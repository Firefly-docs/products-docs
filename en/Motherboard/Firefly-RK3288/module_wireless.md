...
For DELICOMM series, VCC (red wire), GND (black wire), TX (white wire), connect with Firefly-RK3288 UART3 3.3V, GND, RX.
...
For Module UBLOX, VCC(white wire), GND(black wire), TX(blue wire), connect with Firefly-RK3288 UART3 3.3V, GND, RX.

...
This article describes how to upgrade the firmware file on the host to the flash memory of the development board through the Micro USB data cable. When upgrading, you need to choose the appropriate upgrade mode according to the host operating system and firmware type.
...
1. Connect the equipment and host machine with Micro USB data cable.
1. Use metal tweezers to connect and hold the two test points as shown in the following figure on Firefly-RK3288 (as shown in the figure below).

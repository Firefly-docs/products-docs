...
Standard Linux specially defines LED subsystem for LED equipment. Two LEDs on Firefly-RK3288 development board are defined in the form of equipment.
...
Define LED node in `kernel/arch/arm/boot/dts/firefly-rk3288.dts` file; the specific definition is as follows:

...
<font color=#ff0000>**Note:** The default baud rate of AIO-3399J is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
<img alt="" src="../../../rk3399_img/AIO-3399J/debug_connection.jpg" width="800">
</center>


## Parameter Setting

AIO-3399J use the following serial parameters:

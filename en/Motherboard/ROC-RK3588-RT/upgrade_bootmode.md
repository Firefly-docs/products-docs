...
The ROC-RK3588-RT is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

ROC-RK3588-RT has a flexible startup mode. Generally, the ROC-RK3588-RT development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/233)


## Upgrade method
ROC-RK3588-RT supports firmware update through the following two methods:
...
ROC-RK3588-RT has three startup modes:

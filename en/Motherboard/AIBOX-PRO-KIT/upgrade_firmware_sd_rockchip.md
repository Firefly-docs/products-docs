...
* USB Card Reader 
* MIrcoSD card
* [**SD_Firmware_Tool**](https://community.t-firefly.com/en/doc/download/414)
## Operation Steps
...
* Choose firmware we want to upgrade into the AIBOX-PRO-KIT
* Click  button `Create` to make it and wait until it is finshed


<center>

![](../../../aibox_img/AIBOX-PRO-KIT/upgrade_firmware_sd_tool_zh.png)

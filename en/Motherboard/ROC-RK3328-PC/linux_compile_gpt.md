...
[Firefly_Linux_SDK Source]: https://community.t-firefly.com/en/doc/download/53#other_144
...
The configuration file `roc-rk3399-pc-ubuntu.mk`:
...
**Note :** `roc-rk3399-pc-ubuntu.mk` is configuration file after compiled ubuntu firmware. At the same time, users can also generate new configuration files by referring to this configuration to adapt the firmware they need.
...
#Kernel dts
export RK_KERNEL_DTS=firefly_roc-rk3399-pc_defconfig                     # Compile the DTS used by kernel
...
[18.04 FS]: https://community.t-firefly.com/en/doc/download/53#other_117
[Download the Ubuntu root filesystem image]: https://community.t-firefly.com/en/doc/download/53#other_117

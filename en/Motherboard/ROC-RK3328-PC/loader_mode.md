...
The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/53).There are two types of firmware files:
...
Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/53#other_367), And install it into the system as follows for easy invocation:

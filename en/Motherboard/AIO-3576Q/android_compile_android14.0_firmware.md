...
Google Driver [Android14.0 Bundle](https://community.t-firefly.com/en/doc/download/242.html#other_713)。
...
## iCore-3576Q product compilation method

### The overall compilation

#### HDMI Firmware Compilation
```
./FFTools/make.sh -j8 -l rk3576_firefly_aio_3576q-userdebug
./FFTools/mkupdate/mkupdate.sh -l rk3576_firefly_aio_3576q-userdebug
```

#### 10.1‘ MIPI V3S Firmware Compilation：
```
./FFTools/make.sh -j8 -l rk3576_firefly_aio_3576q_mipi-userdebug
./FFTools/mkupdate/mkupdate.sh -l rk3576_firefly_aio_3576q_mipi-userdebug
```
<!--
...
* Compile
```
./FFTools/make.sh -d  -j8 -l rk3576_firefly_aio_3576q-userdebug
./FFTools/mkupdate/mkupdate.sh -l rk3576_firefly_aio_3576q-userdebug
```
...
lunch rk3576_firefly_aio_3576q-userdebug
make installclean
make -j8
./mkimage.sh
```
...
./FFTools/mkupdate/mkupdate.sh -l rk3576_firefly_aio_3576q-userdebug
```
After packaging, it will be in rockdev// Generate unified firmware under the directory: (product name )XXX_XXX_date XXX.img

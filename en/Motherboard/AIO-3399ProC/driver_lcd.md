...
The AIO-3399ProC development board supports two LCD screen interfaces by default, one is LVDS and the other is EDP. The position of the interface on the board is as follows:
...
AIO-3399ProC SDK has LVDS DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399pro-firefly-aioc-lvds-HSX101H40C.dts, we can see the following statement from this file:
```
/ {
...
The AIO-3399ProC development board has an external backlight interface to control the screen backlight, as shown in the following figure:
...
### DTS configuration
#### Pin configuration
AIO-3399ProC SDK has EDP DSI DTS file: kernel/arch/arm64/boot/dts/rockchip/rk3399pro-firefly-aioc-edp.dts, from this file we can see the following statement:
```
{
        panel: panel {

...
The default firmware of the AIO-3399ProC is a dual-screen display that supports LVDS+HDMI 1080P. The HDMI resolution can only be up to 1080P. HDMI to support 4K resolution needs to re-upgrade the [default firmware](https://community.t-firefly.com/en/doc/download/54), or recompile the kernel `make ARCH=arm64 rk3399pro-firefly-aioc.img`, re-upgrade `resource.img`.
...
* Install RKDevInfoWriteTool
    * [Download link](https://community.t-firefly.com/en/doc/download/76#other_297)

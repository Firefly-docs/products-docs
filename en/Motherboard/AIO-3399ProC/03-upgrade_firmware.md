...
* AIO-3399ProC development board
* Firmware
* Host computer
* Type-C data cable
...
4. Use metal tweezers to connect and hold the two test points as shown in the following figure on AIO-3399ProC (as shown in the figure below).
...
[AIO-3399ProC firmware]: https://community.t-firefly.com/en/doc/download/76

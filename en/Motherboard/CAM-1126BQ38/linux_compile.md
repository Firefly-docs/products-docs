...
```bash
MACHINE=cam-1126bq38 bitbake core-image-minimal
MACHINE=cam-1126bq38 bitbake core-image-minimal-xfce
MACHINE=cam-1126bq38 bitbake core-image-x11
MACHINE=cam-1126bq38 bitbake core-image-sato
```
...
```bash
MACHINE=cam-1126bq38 bitbake core-image-weston
```
...
```bash
MACHINE=cam-1126bq38 bitbake core-image-minimal -c clean
MACHINE=cam-1126bq38 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=cam-1126bq38 bitbake linux-rockchip
        
# u-boot
MACHINE=cam-1126bq38 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=cam-1126bq38 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=cam-1126bq38 bitbake rockchip-librga
        
# See more compilation objects
MACHINE=cam-1126bq38 bitbake -s
```
...
```bash
MACHINE=cam-1126bq38 bitbake <target> <paramater>
# e.g
MACHINE=cam-1126bq38 bitbake u-boot-rockchip -c clean
MACHINE=cam-1126bq38 bitbake u-boot-rockchip
```
...
Download the root filesystem: [Debian Root Filesystem (64-bit)](https://community.t-firefly.com/en/doc/download/346.html#other_623). Please use the filesystem located in the kernel-6.1 directory of the cloud drive.
...
**Enter the board type by entering the board number: firefly_rv1126b_cam-1126bq38_debian_defconfig.**
...
**Enter the board type by entering the board number: firefly_rv1126b_cam-1126bq38_buildroot_defconfig.**

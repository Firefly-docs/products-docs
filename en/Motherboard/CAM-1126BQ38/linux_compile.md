...
Download the root filesystem: [Debian Root Filesystem (64-bit)](https://community.t-firefly.com/en/doc/download/333). Please use the filesystem located in the kernel-6.1 directory of the cloud drive.

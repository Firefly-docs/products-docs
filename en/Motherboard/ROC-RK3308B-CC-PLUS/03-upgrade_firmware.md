...
* Tool: [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/97)

### Install RK USB drive

Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/97), extract, and then run the DriverInstall.exe inside .
...
Download [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/97). AndroidTool defaults to display in Chinese. We need to change it to English. Open `config.ini` with an text editor (like notepad). The starting lines are:
...
1. Use metal tweezers to connect and hold the two test points as shown in the following figure on ROC-RK3308B-CC-PLUS (as shown in the figure below).
...
* Tool : [upgrade_tool_xxx (version number)](https://community.t-firefly.com/en/doc/download/97)


### Upgrade_tool

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/97), And install it into the system as follows for easy invocation:
...
[ROC-RK3308B-CC-PLUS firmware]: https://community.t-firefly.com/en/doc/download/97
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/97#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/97#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/97#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/97#linux_12

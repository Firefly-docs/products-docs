...
* Tool: [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/84)

### Install RK USB drive

Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/84), extract, and then run the DriverInstall.exe inside .
...
Download [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/84). AndroidTool defaults to display in Chinese. We need to change it to English. Open `config.ini` with an text editor (like notepad). The starting lines are:
...
* Tool : [upgrade_tool_xxx (version number)](https://community.t-firefly.com/en/doc/download/84)


### Upgrade_tool

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/84), And install it into the system as follows for easy invocation:
...
[ROC-RK3308B-CC-PLUS firmware]: https://community.t-firefly.com/en/doc/download/84
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/84#windows_12

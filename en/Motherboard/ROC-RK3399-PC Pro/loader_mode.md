...
* Type-C data cable connect the device and the host.
    ...
    <img alt="" src="../../../rk3399_img/ROC-RK3399-PC-Pro/upgrade_otg_interface.png" width="900">
    </center>
* Press and hold the RECOVERY button on the device.

    <center>

    <img alt="" src="../../../rk3399_img/ROC-RK3399-PC-Pro/upgrade_recovery_reset.png" width="800">
    </center>
* plug in

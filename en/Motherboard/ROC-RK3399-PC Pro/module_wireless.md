...
<img alt="" src="../../../rk3399_img/ROC-RK3399-PC-Pro/module_wireless_usb.jpg" width="700">
</center>
...
* Connect the VCC, GND, TX and RX of the module to 3.3V, GND, RX and TX of ROC-RK3399-PC Pro **UART?**(<font color = "red">the corresponding node is `/dev/tty*`</font>) respectively. Pay attention to avoid<font color="red"> burning the module </font> due to wrong connection of VCC, GND, TX and RX.

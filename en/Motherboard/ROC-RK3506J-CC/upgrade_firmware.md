...
* ROC-RK3506J-CC development board
* [Firmware](https://community.t-firefly.com/en/doc/download/309.html)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/309.html). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/309.html#other_762), extract, and then run the DriverInstall.exe inside . 
...
![](../../../rk3506_img/common/upgrade_firmware_install_rk_usb.jpg)
</center>
...
You can also download [AndroidTool](https://community.t-firefly.com/en/doc/download/309.html#other_763) separately, unzip it, and run `RKDevTool.exe` in the `RKDevTool_Release_v2.xx` directory (note that if you are running Windows 7/8, you need to right-click and select Run as administrator), as shown below:
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/309.html#other_765)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/309.html#other_765), And install it into the system as follows for easy invocation:
...
![](../../../rk3506_img/ROC-RK3506J-CC/upgrade_otg_interface.jpg)

* Press and hold the RECOVERY button on the device

![](../../../rk3506_img/ROC-RK3506J-CC/upgrade_recovery_reset.jpg)

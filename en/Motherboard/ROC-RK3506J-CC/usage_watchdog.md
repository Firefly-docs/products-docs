...
This section will show you how to use watchdog on ROC-RK3506J-CC. 

## DTS Configuration

The watchdog node of ROC-RK3506J-CC defined in `kernel/arch/arm/boot/dts/rk3502.dtsi`, as showm below:
...
ROC-RK3506J-CC also has an external watchdog,device node in system is `/dev/wdt_crl`.

...
The official MIPI firmware default support MIPI_DSI0+HDMI display, MIPI screen connected to ROC-RK3568-PC MIPI_DSI0 interfacei. Below is the link to the firmware: [Firmware link](https://community.t-firefly.com/en/doc/download/109)

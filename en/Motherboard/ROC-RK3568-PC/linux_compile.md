...
Download Firefly_Linux_SDK sub-volume compressed package: [Firefly_Linux_SDK Source](https://community.t-firefly.com/en/doc/download/94)
...
Under `device/rockchip/rk356x/` , in addition to roc-rk3568-pc-ubuntu.mk, there are other configuration files that come with different accessories
...
* Download: [Ubuntu rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/94)，put in SDK path
...
```bash
MACHINE=roc-rk3568-pc bitbake core-image-minimal
MACHINE=roc-rk3568-pc bitbake core-image-minimal-xfce
MACHINE=roc-rk3568-pc bitbake core-image-x11
MACHINE=roc-rk3568-pc bitbake core-image-sato
```
...
```bash
MACHINE=roc-rk3568-pc bitbake core-image-weston
```
...
```bash
MACHINE=roc-rk3568-pc bitbake core-image-minimal -c clean
MACHINE=roc-rk3568-pc bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=roc-rk3568-pc bitbake linux-rockchip
        
# u-boot
MACHINE=roc-rk3568-pc bitbake u-boot-rockchip
        
# rkmpp
MACHINE=roc-rk3568-pc bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=roc-rk3568-pc bitbake rockchip-librga
        
# See more compilation objects
MACHINE=roc-rk3568-pc bitbake -s
```
...
```bash
MACHINE=roc-rk3568-pc bitbake <target> <paramater>
# e.g
MACHINE=roc-rk3568-pc bitbake u-boot-rockchip -c clean
MACHINE=roc-rk3568-pc bitbake u-boot-rockchip
```
...
* Download ：[Debian rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/94)，and put it in the SDK
...
Under `device/rockchip/rk356x/` , in addition to roc-rk3568-pc-buildroot.mk, there are other configuration files that come with different accessories

...
Run yolov5 demo on the AIO-3576Q38 as follows:
```shell
...
#### Run on AIO-3576Q38 NPU connected to the PC

RKNN Toolkit2 runs on the PC and connects to the AIO-3576Q38 through the PC's USB. RKNN Toolkit2 transfers the RKNN model to the NPU device of AIO-3576Q38 to run, and then obtains the inference results, performance information, etc. from the AIO-3576Q38


* First prepare AIO-3576Q38 environment: update librknnrt.so and run rknn_server

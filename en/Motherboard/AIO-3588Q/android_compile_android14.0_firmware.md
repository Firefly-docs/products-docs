...
* The SDK can be obtained by email. Send the order number to <font color=red>sales@t-firefly.com</font> and indicate the required SDK name [firefly_rk3588_android14_git_20240822](https://community.t-firefly.com/en/doc/download/158.html)
...
Google Driver [Android14.0 Bundle](https://community.t-firefly.com/en/doc/download/158.html#other_768)。


## iCore-3588Q product compilation method
...
```
./FFTools/make.sh -d rk3588-firefly-aio-3588q-mipi101-BSD1218-A101KL68 -j8 -l rk3588_firefly_aio_3588q_mipi-userdebug

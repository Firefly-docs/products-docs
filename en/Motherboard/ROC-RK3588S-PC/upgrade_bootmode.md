...
The ROC-RK3588S-PC is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

ROC-RK3588S-PC has a flexible startup mode. Generally, the ROC-RK3588S-PC development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/164)


## Upgrade method
ROC-RK3588S-PC supports firmware update through the following two methods:
...
ROC-RK3588S-PC has three startup modes:

...
ROC-RK3399-PC-PLUS is installed with Android7.1(industry) system by default. 

ROC-RK3399-PC-PLUS may officially support multiple systems, so it is possible to upgrade firmware for different systems.
...
* [Androidtool_xxx](https://community.t-firefly.com/en/doc/download/131#other_343)
...
ROC-RK3399-PC-PLUS upgraded Android7.1(industry) firmware by default when it is delivered, and the customer needs to upgrade Android10.0 firmware for example:
...
[RK3399_Android7.1_EraseIDB.7z]: https://community.t-firefly.com/en/doc/download/131#windows_341

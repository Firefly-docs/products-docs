...
The ROC-RK3399-PC-PLUS is installed with the Android operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

ROC-RK3399-PC-PLUS has a flexible startup mode. Generally, the ROC-RK3399-PC-PLUS development board will not turn brick unless the hardware is damaged.
...
[Firmware download link](https://community.t-firefly.com/en/doc/download/131)

## Upgrade method

ROC-RK3399-PC-PLUS supports firmware update through the following two methods:
...
ROC-RK3399-PC-PLUS  has three startup modes:
...
***To forcibly enter `MaskRom mode`, please refer to the chapter ["MaskRom mode"](03-upgrade_firmware.md).***

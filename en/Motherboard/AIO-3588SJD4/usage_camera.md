...
<img alt="" src="../../../rk3588_img/Core-3588SJD4/usage_camera_mipicsi.jpg" width="800">
</center>
...
**Core-3588SJD4 only support one physical hardware DPHY and two physical hardware DCPHY**

## DCPHY
### Full Mode
* csi2_dcphy0,csi2_dcphy1 respectively corresponds to interface MIPI_DCPHY_CSI0/MIPI_DCPHY_CSI1;
* Maximum 4 data lanes;
* Maximum speed 2.5Gbps/lanes;

### Split Mode
* DCPHY do not support Split mode
...
**Specific reference "kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588sjd4-cam-dcphy-8ms1m.dtsi"**
...
### Configure Sensor
We need to check the MIPI CSI interface in schematic to find out which I2C bus is used for camera sensor. And configure the camera under that I2C node, correctly set the properties like I2C device address, pins, etc. For example, there's a configuration for xc7160 in Core-3588SJD4:
...
### Configure Sensor
We need to check the MIPI CSI interface in schematic to find out which I2C bus is used for camera sensor. And configure the camera under that I2C node, correctly set the properties like I2C device address, pins, etc. For example, there's a configuration for gc2053/gc2093 in Core-3588SJD4:
...
```shell
diff --git a/kernel/arch/arm64/boot/dts/rockchip/aio-3588sjd4.dts b/kernel/arch/arm64/boot/dts/rockchip/aio-3588sjd4.dts
index 7e2a8b2..14fa027 100755
--- a/kernel/arch/arm64/boot/dts/rockchip/aio-3588sjd4.dts
+++ b/kernel/arch/arm64/boot/dts/rockchip/aio-3588sjd4.dts
@@ -7,6 +7,15 @@

...
The AIO-3588SJD4  is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIO-3588SJD4  has a flexible startup mode. Generally, the AIO-3588SJD4  development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/172)


## Upgrade method
AIO-3588SJD4  supports firmware update through the following two methods:
...
AIO-3588SJD4  has three startup modes:

...
* [Firmware](https://community.t-firefly.com/en/doc/download/149)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/149). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/149), extract, and then run the DriverInstall.exe inside . 
...
You can also download [AndroidTool](https://community.t-firefly.com/en/doc/download/149) separately, unzip it, and run `RKDevTool.exe` in the `RKDevTool_Release_v2.xx` directory (note that if you are running Windows 7/8, you need to right-click and select Run as administrator), as shown below:
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/149)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/149), And install it into the system as follows for easy invocation:
...
* [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/149)

Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/149), And install it into the system as follows for easy invocation:
...
[Core-3588SJD4 firmware]: https://community.t-firefly.com/en/doc/download/149
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/149#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/149#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/149#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/149#linux_12

...
The AIO-3288C development board can be connected to the infrared transceiver sensor IR to realize the remote control function.


The AIO-3288C IR wiring position is shown in the red box below:

<center>

![](../../../rk3288_img/AIO-3288C/ir_interface.png)
</center>

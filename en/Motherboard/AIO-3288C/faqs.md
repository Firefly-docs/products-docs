...
Users may change the MAC address of the AIO-3288C. Please use the dynamic library tool `RKTools/windows/UpgradeDllTool_v1.3.tar.gz` under the SDK to write the MAC address.

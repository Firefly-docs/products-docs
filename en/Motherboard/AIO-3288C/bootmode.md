...
The AIO-3288C is installed with the Android operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the motherboard.

AIO-3288C has a flexible startup mode. Generally, the AIO-3288C development board does not brick unless the hardware is damaged.
...
* [Firmware download link](https://community.t-firefly.com/en/doc/download/51)

## Upgrade method

AIO-3288C supports firmware update through the following two methods:
...
AIO-3288C has three startup modes:
...
***Forcibly enter MaskRom mode, please refer to the chapter [MaskRom Mode](upgrade_firmware.md).***
...
[Firefly_Linux_SDK Source]: https://community.t-firefly.com/en/doc/download/3#other_144
...
The configuration file `firefly-rk3399-ubuntu.mk`:

```
./build.sh firefly-rk3399-ubuntu.mk

#The file path: `device/rockchip/rk3399/firefly-rk3399-ubuntu.mk`
```
...
**Note :** `firefly-rk3399-ubuntu.mk` is configuration file after compiled ubuntu firmware. At the same time, users can also generate new configuration files by referring to this configuration to adapt the firmware they need.
...
#Kernel dts
export RK_KERNEL_DTS=rk3399-firefly                     # Compile the DTS used by kernel
...
[18.04 FS]: https://community.t-firefly.com/en/doc/download/3#other_117
[Download the Ubuntu root filesystem image]: https://community.t-firefly.com/en/doc/download/3#other_117

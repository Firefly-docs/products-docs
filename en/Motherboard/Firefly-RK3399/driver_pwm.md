...
## Introduction
Firefly-RK3399 development board has 4 PWMs, namely PWM0 ~ PWM3. 4 PWMs use for EDP backlight, MIPI backlight, VDDLOG power supply , infrared IR.


This chapter describes how to configure PWM.

The PWM driver of Firefly-RK3399 is `kernel/drivers/pwm/pwm-rockchip.c`

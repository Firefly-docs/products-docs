...
Download rootfs here [Ubuntu rootfs](https://community.t-firefly.com/doc/download/341.html), in general, choose the filesystem with latest date.
...
```bash
MACHINE=cam-3576q38 bitbake core-image-minimal
MACHINE=cam-3576q38 bitbake core-image-minimal-xfce
MACHINE=cam-3576q38 bitbake core-image-x11
MACHINE=cam-3576q38 bitbake core-image-sato
```
...
```bash
MACHINE=cam-3576q38 bitbake core-image-weston
```
...
```bash
MACHINE=cam-3576q38 bitbake core-image-minimal -c clean
MACHINE=cam-3576q38 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=cam-3576q38 bitbake linux-rockchip
        
# u-boot
MACHINE=cam-3576q38 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=cam-3576q38 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=cam-3576q38 bitbake rockchip-librga
        
# See more compilation objects
MACHINE=cam-3576q38 bitbake -s
```
...
```bash
MACHINE=cam-3576q38 bitbake <target> <paramater>
# e.g
MACHINE=cam-3576q38 bitbake u-boot-rockchip -c clean
MACHINE=cam-3576q38 bitbake u-boot-rockchip
```

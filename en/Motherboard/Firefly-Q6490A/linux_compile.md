...
This tutorial introduces how to compile programs for Firefly-Q6490A.

## Local Compile

Firefly-Q6490A runs Ubuntu system, so you can use apt to install tools on device for software development:
```bash
sudo apt update

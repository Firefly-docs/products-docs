...
Google Drive[[bundle download]](https://community.t-firefly.com/en/doc/download/51#other_230)




## ROC-RK3399-PC industry version product compilation method
...
```
Overall compilation:
./FFTools/make.sh -j8 -d rk3399-roc-pc -l rk3399_roc_pc-userdebug
./FFTools/mkupdate/mkupdate.sh -l rk3399_roc_pc-userdebug
```
### Compile step by step ROC-RK3399-PC
...
[Android7.1 industry SDK]: https://community.t-firefly.com/en/doc/download/51#other_230

...
AIO-3128C development board has 4 PWMs, namely PWM0 ~ PWM3:
...
This chapter mainly describes how to configure PWM. The PWM driver of AIO-3128C is:
```
...
To use PWM0, you need to add to file kernel/arch/arm/boot/dts/aio-3128c.dts:
```
&pwm0 {
       status = "okay";
};

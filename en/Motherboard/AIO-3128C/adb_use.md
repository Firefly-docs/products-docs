...
If TARGET_BUILD_VARIANT is userdebug, you need to switch adb by:

```
adb root
```

The adb daemon in device will restart in root mode, in order to make 'adb remount' and other root permission demanded commands work.

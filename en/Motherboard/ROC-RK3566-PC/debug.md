...
<font color=#ff0000>**Note:** The default baud rate of ROC-RK3566-PC is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
ROC-RK3566-PC serial port connection diagram:

<center>

<img alt="" src="../../../rk356x_img/ROC-RK3566-PC/debug_connection.jpg" width="800">
</center>

## Parameter Setting

ROC-RK3566-PC use the following serial parameters:

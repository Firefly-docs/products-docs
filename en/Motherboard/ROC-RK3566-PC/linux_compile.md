...
Download Firefly_Linux_SDK sub-volume compressed package: [Firefly_Linux_SDK Source](https://community.t-firefly.com/en/doc/download/93)
...
Under `device/rockchip/rk356x/` , in addition to roc-rk3566-pc-ubuntu.mk, there are other configuration files that come with different accessories
...
* Download ：[Debian rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/93)，and put it in the SDK
...
Under `device/rockchip/rk356x/` , in addition to roc-rk3566-pc-buildroot.mk, there are other configuration files that come with different accessories

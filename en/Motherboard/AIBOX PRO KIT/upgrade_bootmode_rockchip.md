...
The AIBOX PRO KIT is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIBOX PRO KIT has a flexible startup mode. Generally, the AIBOX PRO KIT development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/414)


## Upgrade method
AIBOX PRO KIT supports firmware update through the following two methods:
...
AIBOX PRO KIT has three startup modes:

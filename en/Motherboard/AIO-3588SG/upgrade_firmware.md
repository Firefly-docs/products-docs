...
* [Firmware](https://community.t-firefly.com/en/doc/download/176.html)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/176.html). There are two types of firmware files:
...
![](../../../rk3588_img/Core-3588SG/upgrade_recovery_reset.png)

...
AIO-3588SG have 5  GPIO bank：GPIO0~GPIO4，Each group was numbered A0~A7, B0~B7, C0~C7, and D0~D7, the following formulas are often used to calculate GPIO Pin:
...
......
```
When GPIO3_B2 pin is not reused by other peripherals, we can export this pin to use
```shell
:/ # ls /sys/class/gpio/
export  gpiochip0  gpiochip128  gpiochip200  gpiochip32  gpiochip509  gpiochip64  gpiochip96  unexport
:/ # echo 106 > /sys/class/gpio/export
:/ # ls /sys/class/gpio/
export  gpio106  gpiochip0  gpiochip128  gpiochip200  gpiochip32  gpiochip509  gpiochip64  gpiochip96  unexport
:/ # ls /sys/class/gpio/gpio106
...
/{
    gpio_demo: gpio_demo{
        ...
        pinctrl-0 = <&pin106_111_gpio>;
        firefly-gpio = <&gpio3 RK_PB2 GPIO_ACTIVE_HIGH>;             /*GPIO3_B2*/
        firefly-irq-gpio = <&gpio3 RK_PB7 IRQ_TYPE_EDGE_RISING>;    /*GPIO3_B7*/
    };
};

&pinctrl {
    gpio{
        pin106_111_gpio: pin106_111_gpio{
            rockchip,pins =
            <3 RK_PB2 0 &pcfg_pull_none>,
            <3 RK_PB7 0 &pcfg_pull_none>;	
        };
    };
};
```

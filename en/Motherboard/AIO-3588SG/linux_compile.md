...
Download Firefly_Linux_SDK sub-volume compressed package: [Linux SDK](https://community.t-firefly.com/en/doc/download/176.html), follow the README document:
...
# Kernel dts
export RK_KERNEL_DTS=rk3588s-firefly-aio-3588sg-mipi101-M101014-BE45-A1.dts
...
* Download: [Ubuntu rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/142.html)，put in SDK path
...
```bash
MACHINE=aio-3588sg bitbake core-image-minimal
MACHINE=aio-3588sg bitbake core-image-minimal-xfce
MACHINE=aio-3588sg bitbake core-image-x11
MACHINE=aio-3588sg bitbake core-image-sato
```
...
```bash
MACHINE=aio-3588sg bitbake core-image-weston
```
...
```bash
MACHINE=aio-3588sg bitbake core-image-minimal -c clean
MACHINE=aio-3588sg bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=aio-3588sg bitbake linux-rockchip
        
# u-boot
MACHINE=aio-3588sg bitbake u-boot-rockchip
        
# rkmpp
MACHINE=aio-3588sg bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=aio-3588sg bitbake rockchip-librga
        
# See more compilation objects
MACHINE=aio-3588sg bitbake -s
```
...
```bash
MACHINE=aio-3588sg bitbake <target> <paramater>
# e.g
MACHINE=aio-3588sg bitbake u-boot-rockchip -c clean
MACHINE=aio-3588sg bitbake u-boot-rockchip
```
...
* Download: [Debian rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/176.html)，put in SDK path
...
* Download: [Debian rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/142.html)，put in SDK path
...
```bash
./build.sh aio-3588sg-buildroot.mk
```

...
## AIO-3588L Displays the configuration of the interface
 ...
 AIO-3588L  There are three display output interfaces, namely HDMI, Display Port and MIPI DSI, which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* HDMI0/ HDMI1/ Display Port 
<center>

<img alt="" src="../../../rk3588_img/Core-3588L/usage_display_interface.png" width="900">
</center>

* MIPI DSI0/ MIPI DSI1
<center>

<img alt="" src="../../../rk3588_img/Core-3588L/usage_display_dsi_interface.png" width="900">
</center>
...
```
diff --git a/kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588l.dtsi b/kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588l.dtsi
index afb176b9f8..099cccbf65 100644
--- a/kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588l.dtsi
+++ b/kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588l.dtsi
@@ -94,7 +94,7 @@ &hdmi1 {
 &hdmi1_sound {
        status = "okay";
 };
...
<img alt="" src="../../../rk3588_img/Core-3588L/usage_display_mipi_v2_interface.png" width="900">
</center>

...
Download rootfs here [Ubuntu rootfs](https://community.t-firefly.com/en/doc/download/334), in general, choose the filesystem with latest date.
...
```bash
MACHINE=aio-3576c bitbake core-image-minimal
MACHINE=aio-3576c bitbake core-image-minimal-xfce
MACHINE=aio-3576c bitbake core-image-x11
MACHINE=aio-3576c bitbake core-image-sato
```
...
```bash
MACHINE=aio-3576c bitbake core-image-weston
```
...
```bash
MACHINE=aio-3576c bitbake core-image-minimal -c clean
MACHINE=aio-3576c bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=aio-3576c bitbake linux-rockchip
        
# u-boot
MACHINE=aio-3576c bitbake u-boot-rockchip
        
# rkmpp
MACHINE=aio-3576c bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=aio-3576c bitbake rockchip-librga
        
# See more compilation objects
MACHINE=aio-3576c bitbake -s
```
...
```bash
MACHINE=aio-3576c bitbake <target> <paramater>
# e.g
MACHINE=aio-3576c bitbake u-boot-rockchip -c clean
MACHINE=aio-3576c bitbake u-boot-rockchip
```

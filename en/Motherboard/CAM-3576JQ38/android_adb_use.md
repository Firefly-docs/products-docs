...
Where is OTG? See [Hardware Interfaces](interface_definition.md).


When using `adb`, you need to:
1. Connect the PC and EXT-iCore-3576Q38's OTG port with Type-C data cable. 
...
check the iCore-3576Q38 IP address, Use command under the PC:
...
First, please reference [Install RK USB driver](upgrade_firmware.md#install-the-upgrade-tool) to get the driver ready.

Download the [adb.zip](https://drive.google.com/file/d/1ySJ4De-Lmo3MhsXLfGc28yfXihW3ahtP/view?usp=sharing), uncompress it to `C:\adb` to ease later use.

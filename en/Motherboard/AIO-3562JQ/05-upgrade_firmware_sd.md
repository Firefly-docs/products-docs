...
* USB Card Reader 
* MIrcoSD card
* [**SD_Firmware_Tool**](https://community.t-firefly.com/en/doc/download/222.html#other_675)
## Operation Steps
...
* Choose firmware we want to upgrade into the AIO-3562JQ
* Click  button `Create` to make it and wait until it is finshed


<center>

![](../../../rk3562_img/SD_Firmware_Tool_en.png)

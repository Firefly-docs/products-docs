...
The AIO-3576JD4 is installed with the one kind of operating system by default. If users want to run other operating systems, they need to download the corresponding firmware to the mainboard.

AIO-3576JD4 has a flexible startup mode. Generally, the AIO-3576JD4 development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/255)


## Upgrade method
AIO-3576JD4 supports firmware update through the following two methods:
...
AIO-3576JD4 has three startup modes:

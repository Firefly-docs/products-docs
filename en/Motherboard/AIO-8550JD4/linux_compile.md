...
This tutorial introduces how to compile programs for AIO-8550JD4.

## Local Compile

AIO-8550JD4 runs Ubuntu system, so you can use apt to install tools on device for software development:
```bash
sudo apt update

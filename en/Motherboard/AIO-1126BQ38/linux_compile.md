...
```bash
MACHINE=aio-1126bq38 bitbake core-image-minimal
MACHINE=aio-1126bq38 bitbake core-image-minimal-xfce
MACHINE=aio-1126bq38 bitbake core-image-x11
MACHINE=aio-1126bq38 bitbake core-image-sato
```
...
```bash
MACHINE=aio-1126bq38 bitbake core-image-weston
```
...
```bash
MACHINE=aio-1126bq38 bitbake core-image-minimal -c clean
MACHINE=aio-1126bq38 bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=aio-1126bq38 bitbake linux-rockchip
        
# u-boot
MACHINE=aio-1126bq38 bitbake u-boot-rockchip
        
# rkmpp
MACHINE=aio-1126bq38 bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=aio-1126bq38 bitbake rockchip-librga
        
# See more compilation objects
MACHINE=aio-1126bq38 bitbake -s
```
...
```bash
MACHINE=aio-1126bq38 bitbake <target> <paramater>
# e.g
MACHINE=aio-1126bq38 bitbake u-boot-rockchip -c clean
MACHINE=aio-1126bq38 bitbake u-boot-rockchip
```
...
**Enter the board type by entering the board number: firefly_rv1126b_aio-1126bq38_debian_defconfig.**

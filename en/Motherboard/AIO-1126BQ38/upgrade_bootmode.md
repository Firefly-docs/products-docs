...
The AIO-1126BQ38 is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIO-1126BQ38 has a flexible startup mode. Generally, the AIO-1126BQ38 development board will not turn brick unless the hardware is damaged.
...
## Upgrade method
AIO-1126BQ38 supports firmware update through the following two methods:
...
AIO-1126BQ38 loads the system from the following memory:
...
AIO-1126BQ38 has three startup modes:

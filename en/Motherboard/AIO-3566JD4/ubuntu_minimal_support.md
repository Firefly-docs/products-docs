...
Core-3566JD4 The Ubuntu MINIMAL system is based on the Ubuntu 64bit system. Currently, we mainly maintain Ubuntu 20.04. Compared with Ubuntu Desktop, it has the following features:

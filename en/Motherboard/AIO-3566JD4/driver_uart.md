...
AIO-3566JD4 supports  UART3, UART5(disabled by default, Serial port and SPI multiplexing), RS232(UART9), and RS485(UART0). Each UART has a 256-byte FIFO buffer for data receiving and sending. Among them:

...
The official firmware name supporting the 10.1 screen has the word `MIPI`. Below is the link to the firmware: [Dual MIPI Firmware link](https://community.t-firefly.com/en/doc/download/125)  

...
* AIO-3588MQ  development board
* [Firmware](https://community.t-firefly.com/en/doc/download/196)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/196). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/196), extract, and then run the DriverInstall.exe inside . 
...
You can also download [AndroidTool](https://community.t-firefly.com/en/doc/download/196) separately, unzip it, and run `RKDevTool.exe` in the `RKDevTool_Release_v2.xx` directory (note that if you are running Windows 7/8, you need to right-click and select Run as administrator), as shown below:
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/196)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/196), And install it into the system as follows for easy invocation:
...
* [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/196)

Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/196), And install it into the system as follows for easy invocation:
...
<img alt="" src="../../../rk3588_img/iCore-3588MQ/upgrade_otg_interface.jpg" width="900">
</center>

* Press the `RECOVERY` button on the device and hold.
<center>

<img alt="" src="../../../rk3588_img/iCore-3588MQ/upgrade_recovery_reset.jpg" width="800">
</center>
...
2. Hold the MaskRom button on AIO-3588MQ  or tweeze the two test points on iCore-3588MQ (both shown below)  
...
* the button of  AIO-3588MQ 
<center>

<img alt="" src="../../../rk3588_img/iCore-3588MQ/upgrade_maskrom_test_points_key.jpg" width="800">
</center>
  
  
*  two test points of iCore-3588MQ
<center>

<img alt="" src="../../../rk3588_img/iCore-3588MQ/upgrade_maskrom_test_points_core.jpg" width="800">
</center>
...
[iCore-3588MQ firmware]: https://community.t-firefly.com/en/doc/download/196
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/196#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/196#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/196#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/196#linux_12

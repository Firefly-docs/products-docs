...
## AIO-3588MQ  Displays the configuration of the interface
 ...
 AIO-3588MQ   There are five display output interfaces, namely HDMI, Display Port, VGA ,EDP and MIPI DSI, which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* HDMI0/ HDMI1/ Display Port/ VGA
<center>

<img alt="" src="../../../rk3588_img/iCore-3588MQ/usage_display_interface.jpg" width="900">
</center>

* MIPI DSI0/ MIPI DSI1 / EDP
<center>

<img alt="" src="../../../rk3588_img/iCore-3588MQ/usage_display_dsi_interface.jpg" width="900">
</center>
...
<img alt="" src="../../../rk3588_img/iCore-3588MQ/usage_display_mipi_v2_interface.png" width="900">
</center>
...
AIO-3588MQ  There are one EDP display output interfaces,and can output up to 4096x2304@60Hz (depending on the connected Portx).

...
The AIO-3588MQ  is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIO-3588MQ  has a flexible startup mode. Generally, the AIO-3588MQ  development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/196)


## Upgrade method
AIO-3588MQ  supports firmware update through the following two methods:
...
AIO-3588MQ  has three startup modes:

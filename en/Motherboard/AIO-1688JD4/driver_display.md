...
The AIO-1688JD4 features an HDMI interface (supports 4K\@60fps) and a MIPS DSI interface (maximum output capability of 1440P (2560 \* 1440)@60fps,[The interface location is shown in the figure](interface_definition.md)  。
...
After booting, the AIO-1688JD4 does not have a built-in desktop environment and only runs a display program:

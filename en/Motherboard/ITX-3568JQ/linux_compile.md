...
Download Firefly_Linux_SDK sub-volume compressed package: [Firefly_Linux_SDK Source](https://community.t-firefly.com/en/doc/download/150)
...
# Kernel dts
export RK_KERNEL_DTS=rk3568j-firefly-itxq # dts file
...
Under `device/rockchip/rk356x/` , in addition to itx-3568q-ubuntu.mk, there are other configuration files that come with different accessories
...
```bash
MACHINE=itx-3568jq bitbake core-image-minimal
MACHINE=itx-3568jq bitbake core-image-minimal-xfce
MACHINE=itx-3568jq bitbake core-image-x11
MACHINE=itx-3568jq bitbake core-image-sato
```
...
```bash
MACHINE=itx-3568jq bitbake core-image-weston
```
...
```bash
MACHINE=itx-3568jq bitbake core-image-minimal -c clean
MACHINE=itx-3568jq bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=itx-3568jq bitbake linux-rockchip
        
# u-boot
MACHINE=itx-3568jq bitbake u-boot-rockchip
        
# rkmpp
MACHINE=itx-3568jq bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=itx-3568jq bitbake rockchip-librga
        
# See more compilation objects
MACHINE=itx-3568jq bitbake -s
```
...
```bash
MACHINE=itx-3568jq bitbake <target> <paramater>
# e.g
MACHINE=itx-3568jq bitbake u-boot-rockchip -c clean
MACHINE=itx-3568jq bitbake u-boot-rockchip
```

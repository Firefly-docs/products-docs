...
* AIO-3588JD4 development board
* [Firmware](https://community.t-firefly.com/en/doc/download/290)
* host computer
* Type-C data cable

## Prepare Firmware

The firmware can be obtained by compiling the SDK, or you can download the public firmware (unified firmware) from the [Resource download](https://community.t-firefly.com/en/doc/download/290). There are two types of firmware files:
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/181), extract, and then run the DriverInstall.exe inside . 
...
You can also download [AndroidTool](https://community.t-firefly.com/en/doc/download/181) separately, unzip it, and run `RKDevTool.exe` in the `RKDevTool_Release_v2.xx` directory (note that if you are running Windows 7/8, you need to right-click and select Run as administrator), as shown below:
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/181)

Download [Linux_Upgrade_Tool](https://community.t-firefly.com/en/doc/download/181), And install it into the system as follows for easy invocation:
...
* [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/181)

Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/181), And install it into the system as follows for easy invocation:
...
2. Hold the MaskRom button on AIO-3588JD4 or tweeze the two test points on Core-3588JD4 (both shown below)  
...
* the button of  AIO-3588JD4
<center>

<img alt="" src="../../../rk3588_img/Core-3588JD4/upgrade_maskrom_test_points_key.jpg" width="800">
</center>
  
  
*  two test points of Core-3588JD4
<center>

<img alt="" src="../../../rk3588_img/Core-3588JD4/upgrade_maskrom_test_points_core.jpg" width="800">
</center>
...
[Core-3588JD4 firmware]: https://community.t-firefly.com/en/doc/download/290
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/290#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/290#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/290#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/290#linux_12

...
<font color=#ff0000>**Note:** The default baud rate of Face-RK3399 is 1500000, some USB to serial chip baud rate can not reach 1500000. The same chip may have different series, so be sure to confirm whether to support before purchasing.</font>
...
Face-RK3399 serial port connection diagram:
...
Face-RK3399 use the following serial parameters:

...
The drive current, pull-up and pull-down and initial states after resetting of each GPIO port are different. For details, please refer to [TRM document](https://community.t-firefly.com/en/doc/download/16).
...
First, you need to add a resource description of driver in the firefly-rk3288-aio-3288j.dts:

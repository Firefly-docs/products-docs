...
The ROC-RK3588-PC is installed with the an operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

ROC-RK3588-PC has a flexible startup mode. Generally, the ROC-RK3588-PC development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/160.html)


## Upgrade method
ROC-RK3588-PC supports firmware update through the following two methods:
...
ROC-RK3588-PC has three startup modes:

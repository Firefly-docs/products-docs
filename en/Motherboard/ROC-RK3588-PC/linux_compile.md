...
Download Firefly_Linux_SDK sub-volume compressed package: [Linux SDK](https://community.t-firefly.com/en/doc/download/160.html), follow the README document:
...
# Kernel dts
export RK_KERNEL_DTS=roc-rk3588-pc.dts
...
```bash
./build.sh roc-rk3588-pc-ubuntu.mk
```
...
* Download: [Ubuntu rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/160.html)，put in SDK path
...
```bash
MACHINE=roc-rk3588-pc bitbake core-image-minimal
MACHINE=roc-rk3588-pc bitbake core-image-minimal-xfce
MACHINE=roc-rk3588-pc bitbake core-image-x11
MACHINE=roc-rk3588-pc bitbake core-image-sato
```
...
```bash
MACHINE=roc-rk3588-pc bitbake core-image-weston
```
...
```bash
MACHINE=roc-rk3588-pc bitbake core-image-minimal -c clean
MACHINE=roc-rk3588-pc bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=roc-rk3588-pc bitbake linux-rockchip
        
# u-boot
MACHINE=roc-rk3588-pc bitbake u-boot-rockchip
        
# rkmpp
MACHINE=roc-rk3588-pc bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=roc-rk3588-pc bitbake rockchip-librga
        
# See more compilation objects
MACHINE=roc-rk3588-pc bitbake -s
```
...
```bash
MACHINE=roc-rk3588-pc bitbake <target> <paramater>
# e.g
MACHINE=roc-rk3588-pc bitbake u-boot-rockchip -c clean
MACHINE=roc-rk3588-pc bitbake u-boot-rockchip
```
...
```bash
./build.sh roc-rk3588-pc-debian.mk
```
...
* Download: [Debian rootfs(64-bit)](https://community.t-firefly.com/en/doc/download/160.html)，put in SDK path

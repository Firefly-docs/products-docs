...
The AIO-1126BJD4V0 is installed with the Linux operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.

AIO-1126BJD4V0 has a flexible startup mode. Generally, the AIO-1126BJD4V0 development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/333)


## Upgrade method
AIO-1126BJD4V0 supports firmware update through the following two methods:
...
AIO-1126BJD4V0 loads the system from the following memory:
...
AIO-1126BJD4V0 has three startup modes:

...
ROC-RK3568-PC-SE has 2 working modes. Under normal circumstances, boot directly into `Normal mode` to start the system normally. If you need to upgrade the board subsystem, you can choose the appropriate `Upgrade mode` to upgrade the firmware according to the situation.

* Note: The ROC-RK3568-PC-SE is installed with the Android operating system by default. If users want to run other operating systems, they need to use the corresponding firmware to program to the mainboard.You can go to the [Firmware download page](https://community.t-firefly.com/en/doc/download/157.html) to download more firmware.


![](../../../rk356x_img/working_mode_en.png)

**ROC-RK3568-PC-SE is classified according to the working mode and can be divided into two working modes:**

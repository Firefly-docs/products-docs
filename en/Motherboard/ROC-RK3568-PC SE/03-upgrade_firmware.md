...
Download [Linux_adb_fastboot](https://community.t-firefly.com/en/doc/download/180#other_536), And according to the following method to install into the system, easy to call：

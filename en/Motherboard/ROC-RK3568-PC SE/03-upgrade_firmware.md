...
* ROC-RK3568-PC-SE development board
* Firmware
* host computer
* Type-C data cable
...
* Tool: Use tools in the firmware package or download here [Androidtool_xxx (version number)](https://community.t-firefly.com/en/doc/download/180)
...
Download [Release_DriverAssistant.zip](https://community.t-firefly.com/en/doc/download/180), extract, and then run the DriverInstall.exe inside .
...
* Tool : Use tools in the firmware package or download here [upgrade_tool_xxx (version number)](https://community.t-firefly.com/en/doc/download/180)
...
<img alt="" src="../../../rk356x_img/ROC-RK3568-PC-SE/maskrom_test_points.jpg" width="700">
</center>
...
<img alt="" src="../../../rk356x_img/ROC-RK3568-PC-SE/maskrom_test_points_flash.jpg" width="700">
</center>
...
2. Press and hold the Recovery hole on ROC-RK3568-PC-SE with a pin tool
3. The device is plugged into the power supply and powered on
The device will then enter Recovery mode.

The Recovery hole position is shown in the figure below:
...
Determine the board ROC-RK3568-PC-SE before upgrading unified firmware update.img whether has Nor Flash, as shown in the figure below: 

<center>

<img alt="" src="../../../rk356x_img/ROC-RK3568-PC-SE/nor_flash-position.jpg" width="700">
</center>
...
[ROC-RK3568-PC-SE firmware]: https://community.t-firefly.com/en/doc/download/180
[Androidtool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/180#windows_12
[Release_DriverAssistant.zip]: https://community.t-firefly.com/en/doc/download/180#windows_341
[Linux_Upgrade_Tool]: https://community.t-firefly.com/en/doc/download/180#linux_12
[upgrade_tool_xxx (version number)]: https://community.t-firefly.com/en/doc/download/180#linux_12

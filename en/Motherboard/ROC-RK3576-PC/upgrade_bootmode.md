...
The ROC-RK3576-PC is installed with the one kind of operating system by default. If users want to run other operating systems, they need to download the corresponding firmware to the mainboard.

ROC-RK3576-PC has a flexible startup mode. Generally, the ROC-RK3576-PC development board will not turn brick unless the hardware is damaged.
...
*   [Firmware download link](https://community.t-firefly.com/en/doc/download/254)


## Upgrade method
ROC-RK3576-PC supports firmware update through the following two methods:
...
ROC-RK3576-PC has three startup modes:

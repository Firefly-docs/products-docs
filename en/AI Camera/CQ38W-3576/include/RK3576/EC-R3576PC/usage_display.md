...
## CQ38W-3576 Displays the configuration of the interface
 ...
 CQ38W-3576  There are three display output interfaces, namely HDMI, Display Port , which can achieve multi-screen simultaneous display/exclusive display. The interface diagram is as follows:

* HDMI/ Display Port/ MIPI DSI 

![](../../../rk3576_img/CQ38W-3576/usage_display_interface.png)

...
- [编译第三方驱动](linux_compile_driver.md)
# 配件
- [转换模块](module_transform.md)
- [屏幕模组](module_display.md)
- [摄像头模组](module_camera.md)
- [无线模块](module_wireless.md)
- [[电源适配器](https://store.t-firefly.com/goods.php?id=4)](module_power_adapter.md)
# NPU 开发指南
- [NPU开发简介](npu_intro.md)

...
![](../../../rk3308_img/Core-3308Y/iot_client/into_aliyun_1.png)

![](../../../rk3308_img/Core-3308Y/iot_client/into_aliyun_2.png)

- 公共实例->产品->创建产品

![](../../../rk3308_img/Core-3308Y/iot_client/into_aliyun_3.png)

![](../../../rk3308_img/Core-3308Y/iot_client/start.png)

- 新建产品，输入自定义产品名称，设置为网关设备，联网采用蜂窝网络

![](../../../rk3308_img/Core-3308Y/iot_client/add_product.png)

- 配置产品功能

点击刚刚创建的产品

![](../../../rk3308_img/Core-3308Y/iot_client/product_config_1.png)

点击：功能定义->编辑草稿

![](../../../rk3308_img/Core-3308Y/iot_client/product_config_2.png)

点击：添加模块

![](../../../rk3308_img/Core-3308Y/iot_client/product_config_3.png)

添加模块：创建温湿度传感器1

![](../../../rk3308_img/Core-3308Y/iot_client/product_config_4.png)

添加模块：创建温湿度传感器2

![](../../../rk3308_img/Core-3308Y/iot_client/product_config_5.png)

点击：温湿度传感器1->添加自定义功能

![](../../../rk3308_img/Core-3308Y/iot_client/product_config_6.png)

添加属性：温度检测

![](../../../rk3308_img/Core-3308Y/iot_client/module_config_1.png)

添加属性：湿度检测

![](../../../rk3308_img/Core-3308Y/iot_client/module_config_2.png)

同理，给温度传感器2添加同样的属性，这里略

最后，发布上线即可。

![](../../../rk3308_img/Core-3308Y/iot_client/module_config_3.png)

- 新建设备

![](../../../rk3308_img/Core-3308Y/iot_client/add_device_1.png)

![](../../../rk3308_img/Core-3308Y/iot_client/add_device_2.png)

![](../../../rk3308_img/Core-3308Y/iot_client/add_device_3.png)

- 复制产品ProductKey，设备名DeviceName，设备秘钥DeviceSecret，后面网关需要用到。

![](../../../rk3308_img/Core-3308Y/iot_client/set_device_config.png)
...
![](../../../rk3308_img/Core-3308Y/iot_client/aliyun_data.png)

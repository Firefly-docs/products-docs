...
* 可以在这里找到已编译好的统一[AIO-PX30-JD4固件](http://www.t-firefly.com/doc/download/67.html#other_268)，下载后解压。也可以参考编译固件的说明自行编译。
...
下载 [ Release_DriverAssistant.zip](http://www.t-firefly.com/doc/download/67.html#other_263) ，解压，然后运行里面的 DriverInstall.exe 。   
...
下载 [AndroidTool](http://www.t-firefly.com/doc/download/67.html#other_261)，解压，运行 AndroidTool_Release_xx 目录里面的 AndroidTool.exe（注意，如果是 Windows 7/8,需要按鼠标右键，选择以管理员身份运行），如下图：   
...
下载 [Linux_Upgrade_Tool](http://www.t-firefly.com/doc/download/67.html#other_262), 并按以下方法安装到系统中，方便调用：   
```

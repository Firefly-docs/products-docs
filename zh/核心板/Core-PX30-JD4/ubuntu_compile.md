...
# rootfs image path
export RK_ROOTFS_IMG=ubuntu_rootfs/px30_ubuntu_rootfs.img       # 根文件系统路径
```
...
* 下载根文件系统：[Ubuntu 根文件系统](https://community.t-firefly.com/doc/download/67)，放到 SDK 路径下
...
路径：`device/rockchip/px30/parameter-ubuntu.txt`
...
路径：`tools/linux/Linux_Pack_Firmware/rockdev/px30-ubuntu-package-file`

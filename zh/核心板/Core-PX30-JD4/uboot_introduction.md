...
PX30使用二级Loader，编译生成的镜像为：
```
u-boot/uboot.img
u-boot/trust.img
u-boot/px30_loader_v1.10.115.bin
```
其中V1.10是发布的版本号，rockchip 定义U-Boot loader 的版本，其中1.10是根据存储版本定义的，客户务必不要修改这个版本。 uboot.img 是U-Boot作为二级loader 的打包。 trust.img 是U-Boot作为二级loader 的打包。
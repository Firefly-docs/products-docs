...
本章节主要介绍 ICORE-1126BQ38 开发板内部看门狗的使用。


## DTS配置

ICORE-1126BQ38的 watchdog 的 DTS 节点在 `kernel-6.1/arch/arm64/boot/dts/rockchip/rv1126b.dtsi` 文件中定义，如下所示：
...
参考文档：SDK/docs/cn/Common/WATCHDOG/

...
* SD卡
* USB读卡器
* [**SD_Firmware_Tool**](https://www.t-firefly.com/doc/download/247.html#other_778)

## 操作步骤
* 下载需要升级到主板上的统一固件。
* 打开SD_Firmware_Tool，勾选`Upgrade Firmware`框，点击`Firmware`选择正确升级固件。
...
![](../../../rk3562_img/SD_Firmware_Tool_zh.png)
</center>
...
前往[SD固件工具下载页面](http://www.t-firefly.com/doc/download/page/id/66.html#other_541)下载`SD_Firmware_Tool`并解压。

## 运行`SD_Firmware_Tool.exe`
![](../../../rk3399_img/sdfirmwaretool.zh_CN.jpg)

1. 下载SD卡制作工具：[SD_Firmware_Tool](http://www.t-firefly.com/doc/download/page/id/66.html#other_541)

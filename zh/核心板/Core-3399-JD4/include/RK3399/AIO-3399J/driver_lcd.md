...
Core-3399-JD4开发板外置了两个LCD屏接口，一个是EDP，一个是LVDS，接口对应板子上的位置如下图：
...
Core-3399-JD4的SDK有LVDS DSI的DTS文件：kernel/arch/arm64/boot/dts/rockchip/rk3399-firefly-aio-lvds.dts，从该文件中我们可以看到以下语句：
```
/ {

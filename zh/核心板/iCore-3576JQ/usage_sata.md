...
<img alt="" src="../../../rk3576_img/iCore-3576JQ/usage_sata_interface.jpg" width="900">
</center>
...
选择需要生效的选项SATA 或 PCIe
 ...
 <img alt="" src="../../../rk3576_img/iCore-3576JQ/swtich_sata_pcie.jpg" width="700">
...
在 `kernel/arch/arm64/boot/dts/rockchip/rk3576-firefly-aio-3576q.dts` 以及 `kernel/arch/arm64/boot/dts/rockchip/rk3576-firefly-aio-3576q.dtsi`中有如下配置：
```
#define SATA            1
#define PCIE            0
```

...
AIO-3576JQ开发板采用 TT8563RH 作为RTC(*Real Time Clock*)，TT8563RH 是一款低功耗CMOS实时时钟/日历芯片,它提供一个可编程的时钟输出,一个中断
...
AIO-3576JQ 存在电容给RTC供电，可以在短时间内保证RTC运行。

![](../../../rk3576_img/iCore-3576JQ/usage_rtc_capacitor.jpg)

## RTC驱动

DTS配置参考: `kernel/arch/arm64/boot/dts/rockchip/rk3576-firefly-aio-3576jq.dtsi`

驱动参考：`kernel/drivers/rtc/rtc-hym8563.c`

## 接口使用

Linux 提供了三种用户空间调用接口。在 AIO-3576JQ开发板中对应的路径为：

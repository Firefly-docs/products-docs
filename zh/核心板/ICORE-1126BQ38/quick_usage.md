...
![](../../../rv1126b_img/ICORE-1126BQ38/iptool.png)
6. 在浏览器上输入设备 IP 地址可以进入管理页面，默认帐号密码都为 `admin`。
![](../../../rv1126b_img/ICORE-1126BQ38/login.png)
7. 使用 RTSP 流播放器可以预览摄像头。
![](../../../rv1126b_img/ICORE-1126BQ38/vlc.png)
...
1. 准备一条公对公的 USB 线
![](../../../rv1126b_img/ICORE-1126BQ38/usb.jpeg)
2. USB 线一端接电脑的 USB 口，另一端接 RV1126/RV1109 底板的 USB OTG 调试接口。接线如下图：
![](../../../rv1126b_img/ICORE-1126BQ38/usb_connect.jpeg)
3. 基于你的系统安装 ADB。
...
3. 例：设置如下图所示：
	![](../../../rv1126b_img/ICORE-1126BQ38/set_path.png)
4. 注：路径需要改成你解压的自定义目录
...
![](../../../rv1126b_img/ICORE-1126BQ38/DEBUG.jpg)
...
ICORE-1126BQ38 开发板上的 AD 接口有两种，分别为：温度传感器 (Temperature Sensor)、逐次逼近ADC (Successive Approximation Register)。其中：
...
ICORE-1126BQ38 SAR-ADC 的 DTS 节点在 `kernel-6.1/arch/arm64/boot/dts/rockchip/rv1126b.dtsi` 文件中定义，如下所示：

...
![](../../../bm1684_img/Core-1684XJD4/vnc-01.png)

（3）输入 Core-1684XJD4 的 `$bm1684_ip:0` 地址：

![](../../../bm1684_img/Core-1684XJD4/ubuntu-vnc-02.png)

（4）点击linao用户名右侧的圆形按钮，选择xfce， 输入用户与密码，均为 `linaro`：

![](../../../bm1684_img/Core-1684XJD4/ubuntu-vnc-03.png)

（5）成功进入 xfce4 桌面：

![](../../../bm1684_img/Core-1684XJD4/ubuntu-vnc-04.png)

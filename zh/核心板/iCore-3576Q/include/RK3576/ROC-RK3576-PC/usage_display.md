...
AIO-3576Q 有三种显示输出接口，分别是 HDMI、Display Port 以及 MIPI DSI，可以做到多屏同显/异显，接口图如下所示：  

* HDMI/ Display Port/ MIPI DSI

![](../../../rk3576_img/iCore-3576Q/usage_display_interface.jpg)  
...
AIO-3576Q 有一路 MIPI DSI 显示输出接口，支持 DPHY2.0 和 4 Lane 的数据输出，最高可输出 2560x1600@120Hz（取决于连接的 Portx）。  

#### 软件配置

外接的屏幕是 [Firefly V2 版本屏幕](https://wiki.t-firefly.com/DM-M10R800-V2/dm-m10r800-v2.html)，

结合 AIO-3576Q 的 DSI 接口和屏幕时序

...
前往[SD固件工具下载页面](https://community.t-firefly.com/doc/download/66#other_541)下载`SD_Firmware_Tool`并解压。

## 运行`SD_Firmware_Tool.exe`
![](../../../rk3399_img/sdfirmwaretool.zh_CN.jpg)

1. 下载SD卡制作工具：[SD_Firmware_Tool](https://community.t-firefly.com/doc/download/66#other_541)

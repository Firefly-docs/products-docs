...
ROC-RK3506J-CC 开发板上的 AD 接口有两种，分别为：温度传感器 (Temperature Sensor)、逐次逼近ADC (Successive Approximation Register)。其中：
...
<img alt="" src="../../../rk3506_img/ROC-RK3506J-CC/usage_saradc_in.png" width="800">
</center>
...
ROC-RK3506J-CC SAR-ADC 的 DTS 节点在 `kernel/arch/arm/boot/dts/rk3502.dtsi` 文件中定义，如下所示：

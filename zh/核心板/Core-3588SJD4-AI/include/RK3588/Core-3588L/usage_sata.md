...
## 简介
AIO-3588SJD4-AI 开发板上有 1 个 M.2 SATA 接口
...
![](../../../rk3588_img/Core-3588SJD4-AI/usage_sata_interface.png)
...
选择需要生效的选项SATA 或 PCIe
 ...
 ![](../../../rk3588_img/Core-3588SJD4-AI/swtich_sata_pcie.jpg)
...
在 `kernel-5.10/arch/arm64/boot/dts/rockchip/aio-3588l.dtsi` 中有下面一段配置：
```

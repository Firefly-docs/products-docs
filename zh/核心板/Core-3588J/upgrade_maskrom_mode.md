...
1. 设备断开电源
2. 按住 ITX-3588J  的 BOOT 按键或者使用镊子短接 Core-3588J 上的两个测试点（均如下图所示）
3. 设备插入电源上电
此时设备就会进入 MaskRom 模式。


* 以下为 ITX-3588J  上相应的按键  
![](../../../rk3588_img/Core-3588J/upgrade_maskrom_test_points_key.jpg)
  
  
* 以下为 Core-3588J 上的两个测试点  
![](../../../rk3588_img/Core-3588J/upgrade_maskrom_test_points_core.jpg)

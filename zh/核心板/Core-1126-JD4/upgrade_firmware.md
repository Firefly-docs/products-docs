...
## 准备工具
* Core-1126-JD4 开发板
* [固件](https://community.t-firefly.com/doc/download/101)
* 主机
* 良好的USB 数据线

## 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](https://community.t-firefly.com/doc/download/101)处下载公版固件（统一固件）。固件文件一般有两种：
...
<img alt="" src="../../../rv1126_img/Core-1126-JD4/upgrade_otg_interface.jpg" width="900">
</center>
...
<img alt="" src="../../../rv1126_img/Core-1126-JD4/upgrade_maskrom_test_points_core.png" width="800">
</center>

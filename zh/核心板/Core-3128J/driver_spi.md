...
![](../../../rk3128_img/Core-3128J/SPI_work.jpg)
...
- 属性：
    ...
    +spi-cpha，spi-cpol：SPI的工作模式在此设置，本例所用的模块SPI工作模式为
SPI_MODE_1，故设：spi-cpha = <1>，如果您所用设备工作模式为SPI_MODE0，则需在此把这两个注释掉，如果用SPI_MODE3，则设：spi-cpha = <1>;spi-cpol = <1>。

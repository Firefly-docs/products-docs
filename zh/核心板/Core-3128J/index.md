...
- [定制 Android 固件](customize_android.md)
# Linux 开发
- [编译内核  ](compile_kernel.md)
- [创建 Ubuntu 根文件系统  ](build_ubuntu_rootfs.md)
- [Ubuntu Server 使用  ](ubuntu_server.md)
- [双系统启动的设计和实现  ](dual_system.md)
# 配件
- [串口模块](module_serial.md)
- [外壳](module_shell.md)
- [无线模块](module_wireless.md)
- [电源适配器](module_power.md)
- [红外遥控器](module_ir.md)
# 硬件资料
...
- [MIPI DSI 使用](driver_mipi_dsi.md)

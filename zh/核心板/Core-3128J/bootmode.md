...
Firefly-RK3128 有灵活的启动方式。一般情况下，除非硬件损坏，Firefly-RK3128 开发板是不会变砖的。  
...
也就是说，除了支持从 Nand Flash、SPI Flash、eMMC Flash 启动外，还支持 SD 卡启动。  
另外 Firefly-RK3128 支持从 USB OTG 接口下载系统代码。  

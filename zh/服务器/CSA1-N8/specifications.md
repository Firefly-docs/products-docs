...
| **显示接口** | 1080P HDMI 接口 |
| **USB** | - 2 × USB3.0 HOST <br/> - 1 × Type-C（USB3.0 OTG，处理器核心板调试用） |
| **网络接口** | 2 × 10Gbps万兆网（SFP+）、2 × 千兆以太网（RJ45，管理网口 1 个，普通网口 1 个） |
...
| **能耗** | 整机因搭载的计算单元数量和种类不同，能耗存在差异。以下为参考值：<br/>- 典型能耗：300W W<br/>- 最大能耗：450 W |
...
<img alt="perspective view" src="../../../servers_img/CSA1-N8/hw_logical_topology.png" width="700">
</center>
...
| 标识 | 指示灯/按钮 | 状态说明 |
| :--- | :--- | :--- |
| 1-8,M | 计算节点状态指示灯和BMC状态指示灯 | - 绿色（常亮）：表示节点已经正常开机。<br/>- 熄灭：表示节点未上电。 |
| | OTG Type-C（下方） | 可使用 U 盘对 BMC 进行 OTG 升级。 |

### 网络接口

| 标识 | 接口名称 | 说明 |
| :--- | :--- | :--- |
| SFP+1 / SFP+2 | SFP+ 端口 | - 万兆光口 10000/1000/100/10 Mbps 自适应 |
| GE | RJ45 | - 千兆以太网口，1000/100/10 Mbps 自适应。 |
| GEM | RJ45 | - 用作 BMC 管理网络。<br/>- 1000/100/10 Mbps 自适应。 |
### 显示接口
...
<img alt="perspective view" src="../../../servers_img/CSA1-N8/harddisk_location.png" width="700">
</center>
#### 硬盘配置
...
<img alt="SATA Hard Disk Indicator Location Diagram" src="../../../servers_img/CSA1-N8/sata_hdd_indicator.png" width="700">
</center>

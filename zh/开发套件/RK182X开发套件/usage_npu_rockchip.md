# RK3588/RK3588S/RK3576 - 人工智能算法部署
> **适用范围：** 本文介绍安装在 RK182X 开发套件上的 RK3588/RK3588S/RK3576 主模组的 AI 能力，不介绍在 RK1820/RK1828 加速模组上运行这些算法的方法。
...
## 1.1 NPU使用
RK3588/RK3588S/RK3576 主模组内置 NPU，处理性能最高可达 6 TOPS。使用该 NPU 需要下载 [RKNN SDK](https://github.com/airockchip/rknn-toolkit2)。RKNN SDK 提供 C++/Python 编程接口，能够帮助用户部署 RKNN-Toolkit2 导出的 RKNN 模型。RKNN 的整体开发流程主要分为三个部分：模型转换、模型评估和板端部署运行。

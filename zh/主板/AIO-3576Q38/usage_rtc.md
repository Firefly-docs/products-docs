...
AIO-3576Q38开发板采用 TT8563RH 作为RTC(*Real Time Clock*)，TT8563RH 是一款低功耗CMOS实时时钟/日历芯片,它提供一个可编程的时钟输出,一个中断
...
DTS配置参考: `kernel/arch/arm64/boot/dts/rockchip/rk3576-firefly-aio-3576q38.dtsi`

驱动参考：`kernel/drivers/rtc/rtc-hym8563.c`

## 接口使用

Linux 提供了三种用户空间调用接口。在 AIO-3576Q38开发板中对应的路径为：

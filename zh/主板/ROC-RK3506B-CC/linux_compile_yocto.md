...
```bash
MACHINE=roc-rk3506b-cc bitbake core-image-minimal
MACHINE=roc-rk3506b-cc bitbake core-image-minimal-xfce
MACHINE=roc-rk3506b-cc bitbake core-image-x11
MACHINE=roc-rk3506b-cc bitbake core-image-sato
```
...
```bash
MACHINE=roc-rk3506b-cc bitbake core-image-weston
```
...
```bash
MACHINE=roc-rk3506b-cc bitbake core-image-minimal -c clean
MACHINE=roc-rk3506b-cc bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=roc-rk3506b-cc bitbake linux-rockchip
        
# u-boot
MACHINE=roc-rk3506b-cc bitbake u-boot-rockchip
        
# rkmpp
MACHINE=roc-rk3506b-cc bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=roc-rk3506b-cc bitbake rockchip-librga
        
# 参看更多编译对象
MACHINE=roc-rk3506b-cc bitbake -s
```
...
```bash
MACHINE=roc-rk3506b-cc bitbake <target> <paramater>
# e.g
MACHINE=roc-rk3506b-cc bitbake u-boot-rockchip -c clean
MACHINE=roc-rk3506b-cc bitbake u-boot-rockchip
```

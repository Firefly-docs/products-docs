...
<img alt="" src="../../../rk3506_img/ROC-RK3506B-CC/usage_gpio_interface.png" width="900">
</center>
...
GPIO0_C2 对应的设备树属性描述为:<&gpio0 18 GPIO_ACTIVE_HIGH>,由`kernel/include/dt-bindings/pinctrl/rockchip.h`的宏定义可知，也可以将GPIO0_C2 描述为<&gpio0 RK_PC2 GPIO_ACTIVE_HIGH>。

...
## 详细开发文档
ROC-RK3568-PC NPU 及 Toolkit 详细使用方法请参考RKNN SDK下《Rockchip_RK356X_User_Guide_RKNN_API_\*.pdf》、《Rockchip_User_Guide_RKNN_Toolkit2_\*.pdf》文档。
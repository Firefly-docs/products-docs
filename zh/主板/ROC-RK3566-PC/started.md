...
[规格书]() | [购买链接](https://store.t-firefly.com//goods.php?id=149) | [下载资料](https://community.t-firefly.com/doc/download/)
...
* USB 电源5V/2A
* SD卡
* [串口模块](https://store.t-firefly.com/goods.php?id=24)
* 显示设备
...
**注意**：开发板使用USB电源供电(5V/2A)，请搭配合适的电源使用,可以参考[《USB电源》](module_usb_adapter.md)。

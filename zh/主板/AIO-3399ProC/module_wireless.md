...
* 将模组的VCC、GND、TX、RX分别接到 AIO-3399ProC **UART0**(<font color = "red">对应节点为`/dev/ttysWK2`</font>)的3.3V、GND、RX、TX，注意避免接错VCC、GND、TX、RX<font color = "red">导致烧坏模组</font>
...
确保固件为最新[公版固件](https://community.t-firefly.com/doc/download/69.html)，固件默认关闭GPS功能，需要手动使能，以下是修改方法：

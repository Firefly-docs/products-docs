...
AIO-3399ProC 开发板默认外置支持了两个LCD屏接口，一个是MIPI（兼容10.1寸以及8寸），一个是EDP，接口对应板子上的位置如下图：

10.1 寸 MIPI
![](../../../rk3399_img/AIO-3399ProC/pc+_mipi101_1.jpg)

8寸 MIPI
![](../../../rk3399_img/AIO-3399ProC/panel_mipi8.jpg)
...
AIO-3399ProC 开发板外置了一个背光接口用来控制屏幕背光。
...
### 引脚配置
###### EDP屏
AIO-3399ProC 的SDK有EDP DSI的DTS文件：kernel/arch/arm64/boot/dts/rockchip/rk3399-roc-pc-plus-edp.dts，从该文件中我们可以看到以下语句：
```

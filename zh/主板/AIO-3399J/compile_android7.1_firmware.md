...
百度云下载[[bundle压缩包]](https://community.t-firefly.com/doc/download/3)
...
1.HDMI显示编译
```
 ./FFTools/make.sh  -d rk3399-firefly-aio -j8 -l rk3399_firefly_aio_box-userdebug
./FFTools/mkupdate/mkupdate.sh -l rk3399_firefly_aio_box-userdebug
```

### HDMI+lvds编译
* 双LVDS
```
./FFTools/make.sh  -d rk3399-firefly-aio-lvds -j8 -l rk3399_firefly_aio_lvds_box-userdebug
...
根据不同的-l XXX-userdebug参数，打包生成统一固件有会存放在不同目录下（rockdev/Image-XXX/）： product名XXX_XXX_日期XXX.img
...
[下载链接]: https://community.t-firefly.com/doc/download/31
[Android7.1 源码包]: https://community.t-firefly.com/doc/download/31#other_18

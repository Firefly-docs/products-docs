...
下载根文件系统：[Debian 根文件系统(64位)](https://community.t-firefly.com/doc/download/346.html)，请使用网盘中 kernel-6.1 目录下的文件系统。
...
Which would you like? [1]:
```
**输入编号选择板型： firefly_rv1126b_aio-1126bq38_debian_defconfig。**
...
**输入编号选择板型： firefly_rv1126b_aio-1126bq38_buildroot_defconfig。**

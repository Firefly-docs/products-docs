...
* [AIO-3128C 开发板](https://store.t-firefly.com/goods.php?id=75)
* [固件](http://www.t-firefly.com/doc/download/page/id/37.html#other_96)
* 双公头USB数据线
...
下载[ Release_DriverAssistant.zip](http://www.t-firefly.com/doc/download/page/id/37.html#other_94) ，解压，然后运行里面的 DriverInstall.exe 。  
...
下载 [AndroidTool](http://www.t-firefly.com/doc/download/page/id/37.html#windows_134)，解压，运行 AndroidTool_Release_v2.35 目录里面的 AndroidTool.exe（注意，如果是 Windows 7/8,需要按鼠标右键，选择以管理员身份运行），如下图：
...
下载 [Linux_Upgrade_Tool](http://www.t-firefly.com/doc/download/page/id/37.html#linux_134), 并按以下方法安装到系统中，方便调用：
...
如果板子进入不了 Loader 模式，SD 卡启动也失效，此时可以尝试强行进入 MaskRom 模式。操作方法见[《如何进入 MaskRom 模式》](maskrom_mode.md)。
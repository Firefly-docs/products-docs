...
下载根文件系统：[Ubuntu 根文件系统](https://community.t-firefly.com/doc/download/230)，一般选择日期最新的文件系统。
...
下载根文件系统：[Debian 根文件系统](https://community.t-firefly.com/doc/download/230)，一般选择日期最新的文件系统。

...
本文介绍了如何将固件，通过 Type-A 转 C USB 数据线 烧录到 Firefly-Q6490A 开发板的存储器中。
...
### 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](TODO)处下载公版固件（完整固件）。
...
2. 使用 Type-A 转 C USB 数据线 连接设备的 Download 口和电脑。

3. 使用针或其他细小物品伸入耳机孔，按住里面的烧录按钮。

...
### 引脚配置
###### MIPI屏
ROC-RK3399-PC-PLUS MIPI DSI文件路径 
...
ROC-RK3399-PC-PLUS 开发板外置了一个背光接口用来控制屏幕背光。
...
### 引脚配置
###### EDP屏
ROC-RK3399-PC-PLUS 的SDK有EDP DSI的DTS文件：kernel/arch/arm64/boot/dts/rockchip/rk3399-roc-pc-plus-edp.dts，从该文件中我们可以看到以下语句：
```

...
ROC-RK3506J-CC开发板采用 TT8563RH 作为RTC(*Real Time Clock*)，TT8563RH 是一款低功耗CMOS实时时钟/日历芯片,它提供一个可编程的时钟输出,一个中断
...
Linux 提供了三种用户空间调用接口。在 ROC-RK3506J-CC开发板中对应的路径为：
...
<font color=red>**注意:ROC-RK3506J-CC不支持定时开机**</font>

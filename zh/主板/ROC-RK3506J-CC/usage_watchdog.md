...
本章节主要介绍 ROC-RK3506J-CC 开发板看门狗的使用。


## DTS配置

ROC-RK3506J-CC 有两个 watchdog 。 watchdog 的 DTS 节点在 `kernel/arch/arm/boot/dts/rk3502.dtsi` 文件中定义，如下所示：
...
ROC-RK3506J-CC 还有 1 个外部看门狗，对应 /dev/wdt_crl

...
DEBIAN 包下载链接：[linux-headers](https://www.t-firefly.com/doc/download/296.html#other_485)
...
- Host:  x86-64 / Ubuntu 18.04- Target:  Firefly RK3506 RK3588 RK3328 PX30 / Ubuntu 18.04 Minimal&Desktop
...
### 二次打包完整固件
* 工具下载：[firefly-linux-repack](https://www.t-firefly.com/doc/download/296.html#other_479)
...
2.  由于Xorg使用的Driver modesettings 默认会加载libglx.so(禁用glx会导致某些通过检测glx环境的应用启动失败)， libglx.so会搜索系统中的dri实现库。但是RK3506 Xorg 2D加速是直接基于DRM实现， 并未实现dri库，所以启动过程中，libglx.so会报告如下的错误 。

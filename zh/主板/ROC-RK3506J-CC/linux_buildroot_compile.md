...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rk3506_defconfig # u-boot 配置文件
# Kernel defconfig
export RK_KERNEL_DEFCONFIG= # kernel 配置文件
# Kernel dts
export RK_KERNEL_DTS=rk3506b-firefly-roc-rk3506b-cc # dts 文件
# Buildroot config
export RK_CFG_BUILDROOT=rockchip_rk3506_defconfig # Buildroot 配置
# Recovery config

...
在 `kernel/arch/arm64/boot/dts/rockchip/rk3576-firefly-aio-3576c.dts` 以及 `kernel/arch/arm64/boot/dts/rockchip/rk3576-firefly-aio-3576c.dtsi`中有如下配置：
```
#define SATA            1
#define PCIE            0
```

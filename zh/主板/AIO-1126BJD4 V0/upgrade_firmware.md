...
## 准备工具
* AIO-1126BJD4V0 开发板
* [固件](https://community.t-firefly.com/doc/download/346)
* 主机
* 良好的USB 数据线

## 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](https://community.t-firefly.com/doc/download/346)处下载公版固件（统一固件）。固件文件一般有两种：
...
下载 [Release_DriverAssistant.zip](https://community.t-firefly.com/doc/download/346)，解压，然后运行里面的 DriverInstall.exe 。为了所有设备都使用更新的驱动，请先选择`驱动卸载`，然后再选择`驱动安装`。
<center>
...
* [Linux_Upgrade_Tool](https://community.t-firefly.com/doc/download/346)工具

下载 [Linux_Upgrade_Tool](https://community.t-firefly.com/doc/download/346), 并按以下方法安装到系统中，方便调用：

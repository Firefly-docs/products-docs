...
ROC-RK3328-PC 支持 SPI 桥接/扩展 4 个增强功能串口（UART）的功能，分别为 UART1，UART2，RS232，RS485。每个 UART 都拥有 256 字节的 FIFO 缓冲区，用于数据接收和发送。其中：
...
ROC-RK3328-PC 开发板的串口接口图如下：

![](../../../rk3399_img/ROC-RK3328-PC/uart_interface.jpg)

...
Firefly-RK3288 开发板有 MIPI 摄像头接口，摄像头图像处理能力达到 4416x3312 像素，支持 4K 视频录制。此外，开发板还支持 USB 摄像头。
...
!INCLUDE "include/Firefly-RK3288/driver_mipi_csi_interface.mdpp"

## 配置步骤

### 配置 Android

修改 `hardware/rockchip/camera/Config/cam_board.xml` 来注册摄像头：

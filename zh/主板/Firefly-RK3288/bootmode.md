...
Firefly-RK3288 出厂默认安装 Android 操作系统，如果用户要运行其他操作系统，需要使用对应的固件烧写到主板。

Firefly-RK3288 有灵活的启动方式。一般情况下，除非硬件损坏，Firefly-RK3288 开发板是不会变砖的。
...
* [固件下载链接](https://community.t-firefly.com/doc/download/4)

## 升级方式

Firefly-RK3288 支持通过以下两种方式更新固件：
...
***要强行进入 MaskRom 模式，请参阅[《MaskRom模式》](upgrade_firmware.md)一章。***
...
**Firefly_Linux_SDK 源码包比较大，可以通过如下方式获取 Firefly_Linux_SDK 源码包：**[下载链接](https://community.t-firefly.com/doc/download/4)
...
* 下载根文件系统：[Ubuntu 根文件系统(32位)](https://community.t-firefly.com/doc/download/4)，放到 SDK 路径下

...
每个 GPIO 口的驱动电流、上下拉和重置后的初始状态都不尽相同，详细情况请参考[TRM 文档](http://www.t-firefly.com/doc/download/4.html#other_143)。
...
首先需要在 dts (Device Tree) 文件 firefly-rk3288.dts 中增加驱动的资源描述：

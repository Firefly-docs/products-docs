...
ROC-RK3576-PC SAR-ADC 的 DTS 节点在 `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi` 文件中定义，如下所示：
...
用户驱动可参考 Firefly adc demo :`kernel/drivers/iio/adc/adc-firefly-demo.c`，这是一个侦测风扇状态的驱动，但实际 ROC-RK3576-PC 的 SARADC通道4 并没有用在风扇中，所以驱动只是示例 。
...
编译内核，烧录内核到 ROC-RK3576-PC 开发板上，然后插拔风扇时，会打印内核 log 信息如下：

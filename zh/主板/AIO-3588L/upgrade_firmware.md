...
## 准备工具
* AIO-3588L 开发板
* [固件](https://community.t-firefly.com/doc/download/209.html)
* 主机
* 良好的Type-C 数据线

## 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](https://community.t-firefly.com/doc/download/209.html)处下载公版固件（统一固件）。固件文件一般有两种：

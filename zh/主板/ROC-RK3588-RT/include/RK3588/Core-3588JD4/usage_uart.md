...
ROC-RK3588-RT 有一个 RS232 和一个 RS485 接口

ROC-RK3588-RT 开发板的串口接口图如下：
...
用户可以根据不同的接口使用不同的主机的 USB 转串口适配器向开发板的串口收发数据，例如 RS485 的调试步骤如下(ROC-RK3588-RT RS485 是半双工，需要 gpio 控制收发)：

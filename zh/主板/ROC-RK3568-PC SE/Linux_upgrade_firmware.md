[Linux_adb_fastboot]: https://community.t-firefly.com/doc/download/180#other_615
[RKDevTool]: https://community.t-firefly.com/doc/download/180#other_431
[Androidtool_xxx(版本号)]: https://community.t-firefly.com/doc/download/180#other_431
[Release_DriverAssistant.zip]: https://community.t-firefly.com/doc/download/180#other_432
[Linux_Upgrade_Tool]: https://community.t-firefly.com/doc/download/180#other_433# Linux 上升级固件

## 前言

本文介绍了如何将主机上的固件文，通过Type-C 数据线烧录到 ROC-RK3568-PC-SE 开发板的闪存中。升级时，需要根据主机操作系统和固件类型来选择合适的升级方式。
...
如果板子进入不了 Loader 模式，此时可以尝试强行进入 MaskRom 升级模式。操作方法见[《MaskRom 升级模式》](03-upgrade_firmware.md)。

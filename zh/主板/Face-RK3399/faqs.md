...
### 怎么烧写MAC地址？
Face-RK3399 的MAC地址可以让用户自己更改，请先进入升级模式（参照升级固件中连接设备的方法），后使用工具 [WNpctool](https://pan.baidu.com/s/1kU727kF#list/path=%2F) 烧写MAC地址。
...
* 安装RKDevInfoWriteTool
    * [下载地址](https://community.t-firefly.com/doc/download/66.html#other_379)

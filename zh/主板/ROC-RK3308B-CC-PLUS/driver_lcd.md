...
ROC-RK3308B-CC-PLUS的SDK下`kernel/arch/arm64/configs/firefly_defconfig`已经把LCD相关的配置设置好了，如果自己做了修改，请注意把以下配置加上：
```
...
ROC-RK3308B-CC-PLUS的SDK有MIPI DSI的DTS文件：
...
## EDP DTS配置
### 引脚配置
ROC-RK3308B-CC-PLUS的SDK有EDP的DTS文件：`kernel/arch/arm64/boot/dts/rockchip/rk3568-firefly-roc-pc-edp_M156X40.dts`，从该文件中我们可以看到以下语句：
```
    edp_panel: edp-panel {

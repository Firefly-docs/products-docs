...
**SDK 源码存放于 gitlab，国内用户可能下载完整的 SDK 仓库速度比较慢，所以我们提供了一个 SDK 基础包([Linux SDK](https://community.t-firefly.com/doc/download/140))，国内用户只需要在此基础包上同步 gitlab 上的代码就可以了**
...
* 下载根文件系统：[Ubuntu 根文件系统(64位)](https://community.t-firefly.com/doc/download/140)，放到 SDK 路径下
...
```bash
MACHINE=itx-3588j bitbake core-image-minimal
MACHINE=itx-3588j bitbake core-image-minimal-xfce
MACHINE=itx-3588j bitbake core-image-x11
MACHINE=itx-3588j bitbake core-image-sato
```
...
```bash
MACHINE=itx-3588j bitbake core-image-weston
```
...
```bash
MACHINE=itx-3588j bitbake core-image-minimal -c clean
MACHINE=itx-3588j bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=itx-3588j bitbake linux-rockchip
        
# u-boot
MACHINE=itx-3588j bitbake u-boot-rockchip
        
# rkmpp
MACHINE=itx-3588j bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=itx-3588j bitbake rockchip-librga
        
# 参看更多编译对象
MACHINE=itx-3588j bitbake -s
```
...
```bash
MACHINE=itx-3588j bitbake <target> <paramater>
# e.g
MACHINE=itx-3588j bitbake u-boot-rockchip -c clean
MACHINE=itx-3588j bitbake u-boot-rockchip
```
...
* 下载根文件系统：[Debian 根文件系统(64位)](https://community.t-firefly.com/doc/download/140)，放到 SDK 路径下
...
```bash
./build.sh itx-3588j-openeuler.mk 
```
...
* 下载根文件系统：[Openeuler 根文件系统(64位)](https://community.t-firefly.com/doc/download/142)，放到 SDK 路径下

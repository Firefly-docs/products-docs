...
## 准备工具
* ITX-3588J  开发板
* [固件](https://www.t-firefly.com/doc/download/161.html)
* 主机
* 良好的Type-C 数据线

## 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](https://www.t-firefly.com/doc/download/161.html)处下载公版固件（统一固件）。固件文件一般有两种：
...
```
也可以单独下载 [AndroidTool](https://www.t-firefly.com/doc/download/160.html#other_570)，解压，运行 `RKDevTool_Release_v2.xx` 目录里面的 `RKDevTool.exe`（注意，如果是 Windows 7/8,需要按鼠标右键，选择以管理员身份运行），如下图：

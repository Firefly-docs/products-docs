...
Firefly-RK3399 出厂默认安装Android操作系统，如果用户要运行其他操作系统，需要使用对应的固件烧写到主板。
...
Firefly-RK3399 支持通过以下两种方式升级固件：

* [使用USB线缆升级固件](loader_mode.md)

使用 Firefly-RK3399 将主板连接到电脑上，通过升级工具将固件烧写到主板上。

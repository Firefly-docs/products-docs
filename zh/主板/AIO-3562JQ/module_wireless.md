...
EC20 模组分带GNSS和不带GNSS两种，Firefly官网售卖的EC20 4G模组是不支持GNSS的，后缀为`SNNS`，支持GNSS功能的EC20 模组一般带有后缀`SGNS`。
...
参考[EC20 4G模组套件](#EC20 4G模组套件)


## 参考固件

公版固件默认支持 EC20 4G 模组、EC200T 4G模组 
[固件下载](https://community.t-firefly.com/doc/download/247)

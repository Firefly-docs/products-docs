...
[firefly_rk3588_android12_git_20240704](https://community.t-firefly.com/doc/download/142.html)
...
下载页面选择云盘下载 [Android12.0 Bundle](https://community.t-firefly.com/doc/download/142.html)。
...
Android12.0的`kernel.img`和`resource.img`包含在`boot.img`中，编译kernel后需要在android根目录下执行`./mkimage.sh`重新打包`boot.img`,然后烧写rockdev/Image-roc_rk3588s_pc/目录下的`boot.img`。

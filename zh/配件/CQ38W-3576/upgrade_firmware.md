...
本文介绍了如何将主机上的固件，通过Type-C 数据线烧录到 CQ38W-3576 开发板的存储器中。升级时，需要根据主机操作系统和固件类型来选择合适的升级方式。

## 准备工具
* CQ38W-3576 开发板
* [固件](https://community.t-firefly.com/doc/download/356.html)
* 主机
* 良好的Type-C 数据线

## 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](https://community.t-firefly.com/doc/download/356.html)处下载公版固件（统一固件）。固件文件一般有两种：
...
* CQ38W-3576 没有硬件进入 Loader 模式的办法

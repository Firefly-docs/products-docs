...
**SDK 源码存放于 gitlab，国内用户可能下载完整的 SDK 仓库速度比较慢，所以我们提供了一个 SDK 基础包([Linux SDK](https://community.t-firefly.com/doc/download/86.html))，国内用户只需要在此基础包上同步 gitlab 上的代码就可以了**
...
* 下载根文件系统：[Debian 根文件系统(32位)](https://community.t-firefly.com/doc/download/88.html)，放到 SDK 路径下

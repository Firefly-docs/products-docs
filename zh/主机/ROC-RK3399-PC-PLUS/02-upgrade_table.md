...
ROC-RK3399-PC-PLUS 出厂时默认安装Android7.1(industry)系统。

ROC-RK3399-PC-PLUS 官方可能支持多种系统，因此会有烧写不同系统的固件的场景出现。
...
#### 举例
以ROC-RK3399-PC-PLUS 出厂时默认烧写Android7.1(industry)固件，客户需要烧写Android10.0固件举例：
...
[RK3399_Android7.1_EraseIDB.7z]: http://www.t-firefly.com/doc/download/page/id/85.html#other_397
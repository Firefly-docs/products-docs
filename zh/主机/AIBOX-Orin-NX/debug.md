...
AIBOX-OrinNX 可以使用 Type-C 线连接到 PC 机进行串口调试：

![](../../../aibox_img/AIBOX-Orin-NX/type-c_connection.png)

请注意，如果需要开启 Type-C 的 debug 口功能，需要把相应的拨码开关拨到指定的位置：

![](../../../aibox_img/AIBOX-Orin-NX/debug_switch.png)
...
**注意：** AIBOX-Orin NX 默认的波特率是 115200。

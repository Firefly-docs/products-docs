...
* 双LVDS
```
./FFTools/make.sh  -d rk3399-firefly-aioc-lvds -j8 -l rk3399_firefly_aioc_lvds-userdebug
...
* 双LVDS
```
./FFTools/make.sh  -d rk3399-firefly-aioc-ai-lvds -j8 -l rk3399_firefly_aioc_ai_lvds-userdebug

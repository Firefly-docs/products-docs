...
![](../../../rk3588_img/EC-R3588SPC-FD/usage_uart_interface.jpg)

如何使用跳帽选择 RS232 或 UART0, RS485 或 UART1：

![](../../../rk3588_img/EC-R3588SPC-FD/usage_uart_jump_cap_interface.jpg)
...
![](../../../rk3588_img/EC-R3588SPC-FD/usage_uart_jump_cap.png)

RS232、RS485 推荐使用<font color=#ff00>官方的 FC10 转 DP9 串口线</font>，不同厂商的串口线线序可能不同，会导致串口无法通信。

![](../../../rk3588_img/EC-R3588SPC-FD/usage_sata_fc10_to_db9.png)
...
(1) 连接硬件
![](../../../rk3588_img/EC-R3588SPC-FD/usage_uart_rs485_connect.jpg)

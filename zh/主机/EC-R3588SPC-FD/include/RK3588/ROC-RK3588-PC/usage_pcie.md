...
## 简介
EC-R3588SPC-FD 开发板上有 1 个 PCIe3.0 x 4 接口,可以插入支持 NVME 协议的 M.2 SSD 进行使用，如图：
...
![](../../../rk3588_img/EC-R3588SPC-FD/usage_pcie_phy.png)

EC-R3588SPC-FD 开发板上的 PCIe3.0 x 4 接口使用了 RK3588 的 `PCIe Gen3 x 4 lane` 这组资源。
### DTS 配置

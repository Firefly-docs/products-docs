### 整体编译
**注意：由于 AIO-3399Pro-JD4 的硬件迭代版本是 [ROC-RK3399-PC-Pro](https://wiki.t-firefly.com/zh_CN/ROC-RK3399-PC-Pro/started.html),所以软件的编译方法是一致。最终生成的固件如：ROC-RK3399-PC-Pro_xxx.img 对 AIO-3399Pro-JD4 也是兼容的。**

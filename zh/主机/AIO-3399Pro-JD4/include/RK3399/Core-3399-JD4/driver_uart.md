...
![](../../../rk3399_img/AIO-3399Pro-JD4/uart_interface.png)
...
可以看到，在 `kernel/arch/arm64/boot/dts/rockchip/rk3399pro-firefly-aioc.dts` 文件中使能该节点即可使用。另外，由于我们板子使用的 SPI 转 UART 串口模块挂到 SPI1 上，所以还要使能 SPI1 节点。如下：

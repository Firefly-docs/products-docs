...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rk3588_defconfig # u-boot 配置文件
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rockchip_linux_defconfig # kernel 配置文件
# Kernel dts
export RK_KERNEL_DTS=rk3588-firefly-aio-3588sjd4-ai.dts # dts 文件
# Buildroot config
export RK_CFG_BUILDROOT=rockchip_rk3588_defconfig # Buildroot 配置
# Recovery config

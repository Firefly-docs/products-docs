...
EC-A3399ProC 出厂默认安装Android操作系统，如果用户要运行其他操作系统，需要使用对应的固件烧写到主板。

EC-A3399ProC 有灵活的启动方式。一般情况下，除非硬件损坏，EC-A3399ProC 开发板是不会变砖的。
...
EC-A3399ProC 支持通过以下两种方式升级固件：

* [使用USB线缆升级固件](loader_mode.md)

使用 EC-A3399ProC 将主板连接到电脑上，通过升级工具将固件烧写到主板上。

...
本章节提供三个可部署于 AIBOX-1684X 上的 RAG 部署案例，分别为 FireflyChat、ChatDoc-TPU 和 LangChain-Chatchat-TPU。
...
CLIP-TPU 项目实现了对 CLIP 的 TPU 算法移植，用户可使用该项目验证 CLIP 在 AIBOX-1684X 上的实际表现。

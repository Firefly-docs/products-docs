...
EC-R3576PC 有四种显示输出接口，分别是 HDMI、Display Port、 MIPI DSI 以及 LVDS，可以做到多屏同显/异显。
...
![](../../../rk3576_img/EC-R3576PC/usage_display_hdmi_interface.jpg)
...
![](../../../rk3576_img/EC-R3576PC/usage_display_dp_interface.jpg)
...
![](../../../rk3576_img/EC-R3576PC/usage_display_mipi_v2_interface.jpg)
...
EC-R3576PC 有一路 LVDS 显示输出接口，它是由 TTL 转的 LVDS，支持最高输出 2K 分辨率。
...
![](../../../rk3576_img/EC-R3576PC/usage_display_lvds_interface.jpg)
...
EC-R3576PC 硬件预留一个 eDP 显示输出接口 40Pin / 30Pin ( 默认硬件用作HDMI功能 )：

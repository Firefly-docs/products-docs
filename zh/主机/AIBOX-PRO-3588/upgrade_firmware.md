...
本文介绍了如何将主机上的固件，通过Type-C 数据线烧录到 AIBOX-PRO-3588 的存储器中。升级时，需要根据主机操作系统和固件类型来选择合适的升级方式。

## 准备工具
* AIBOX-PRO-3588
* [固件](https://www.t-firefly.com/doc/download/304.html)
* 主机
* 良好的Type-C 数据线

## 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](https://www.t-firefly.com/doc/download/304.html)处下载公版固件（统一固件）。固件文件一般有两种：
...
* [Linux_adb_fastboot](https://www.t-firefly.com/doc/download/268.html)工具

下载 [Linux_adb_fastboot](https://www.t-firefly.com/doc/download/268.html), 并按以下方法安装到系统中，方便调用：

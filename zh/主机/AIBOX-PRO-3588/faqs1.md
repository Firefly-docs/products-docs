...
* 烧录过程中会格式化 AIBOX-PRO-3588 内置的存储设备，重要数据请先备份。
...
## AIBOX-PRO-3588 进入烧录模式
* AIBOX-PRO-3588 先断电
* 使用 Type-C 数据线连接 AIBOX-PRO-3588 的 OTG 口和 PC 端
* 长按 AIBOX-PRO-3588 的 Recovery 键
* AIBOX-PRO-3588 供电
* 释放 AIBOX-PRO-3588 的 Recovery 键
* 检查 AIBOX-PRO-3588 是否进入 Recovery 模式

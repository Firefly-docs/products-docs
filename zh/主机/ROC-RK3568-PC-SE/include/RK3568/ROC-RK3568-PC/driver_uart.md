...
ROC-RK3568-PC-SE支持UART、RS232、RS485接口，分别为双扩展接口上的UART9、集成在RJ45接口的两路RS232和一路RS485，其串口接口图如下:
...
RS232_1、RS232_2和RS485分别从主控的UART2、UART3、UART4转换而来，其中由于UART2默认作为DEBUG串口，RS232_1无法直接使用，需要将[UART2配置为普通串口](#ru-he-jiang-uart2-pei-zhi-wei-pu-tong-chuan-kou)后才可使用。相关的硬件连接及定义可以参考[ROC-RK3568-PC-SE原理图](https://www.t-firefly.com/doc/download/107.html#other_465)，以下是RJ45接口的部分PIN脚定义：

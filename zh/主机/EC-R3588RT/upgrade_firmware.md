...
本文介绍了如何将主机上的固件，通过Type-C 数据线烧录到 EC-R3588RT 开发板的存储器中。升级时，需要根据主机操作系统和固件类型来选择合适的升级方式。
...
![](../../../rk3588_img/EC-R3588RT/upgrade_otg_interface.png)
  

* 按住设备上的 RECOVERY （恢复）键并保持
  

![](../../../rk3588_img/EC-R3588RT/upgrade_recovery_reset.png)

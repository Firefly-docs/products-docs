...
固件包可从 Firefly [下载页面](https://community.t-firefly.com/download/233)获取。
...
* AIO-OrinNX 先断电
* 使用 Type-C 数据线连接 AIO-OrinNX 的 OTG 口和 PC 端
* 长按 AIO-OrinNX 的 Recovery 键
* AIO-OrinNX 供电
* 释放 AIO-OrinNX 的 Recovery 键

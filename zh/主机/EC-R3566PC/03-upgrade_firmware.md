...
## 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](https://www.t-firefly.com/doc/download/109.html)处下载公版固件（统一固件）。固件文件一般有两种：
...
* [Linux_adb_fastboot](https://www.t-firefly.com/doc/download/109.html#other_615)工具

下载 [Linux_adb_fastboot](https://www.t-firefly.com/doc/download/109.html#other_615), 并按以下方法安装到系统中，方便调用：

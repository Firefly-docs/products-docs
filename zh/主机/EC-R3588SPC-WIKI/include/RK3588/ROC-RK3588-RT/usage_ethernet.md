...
### 简介
EC-R3588SPC-WIKI 开发板上有3个网口，2个千兆，1个2.5G网口。

另外板子引出PCIe 3.0 接口，可接 4 x 2.5G 网口扩展板或者 2 x 万兆网口 扩展板。
...
```
`vcc3v3_pcie20_eth0`: 2.5G网口供电

`combphy0_ps`: combphy0_ps 控制器

`pcie2x1l2`: pcie2x1l2 控制器

...
## 准备工具
* ROC-RK3576-PC 开发板
* [固件](https://community.t-firefly.com/doc/download/256)
* 主机
* 良好的Type-C 数据线

## 准备固件
固件可以通过编译SDK获得，也可以通过[资源下载](https://community.t-firefly.com/doc/download/256)处下载公版固件（统一固件）。固件文件一般有两种：
...
1. 设备断开电源
2. 用针状物捅住 EC-R3576PC-FD 上的 MaskRom 孔并保持
3. 设备插入电源上电

...
固件包可从 Firefly [下载页面](https://community.t-firefly.com/download/234)获取。
...
* AIO-OrinNano 先断电
* 使用 Type-C 数据线连接 AIO-OrinNano 的 OTG 口和 PC 端
* 长按 AIO-OrinNano 的 Recovery 键
* AIO-OrinNano 供电
* 释放 AIO-OrinNano 的 Recovery 键

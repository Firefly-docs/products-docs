...
Station P1 Pro 整机外壳上没有引出 MaskRom 按键，需要拆开主机后，在主板 ROC-RK3399-PC Pro 上找到如下图所示的 MaskRom 位置，用金属镊子接通其两个触点并保持，然后给设备上电；稍候片刻后松开镊子，此时设备就会进入 MaskRom 模式。

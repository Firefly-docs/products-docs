...
本文介绍了如何将主机上的固件，通过Type-C 数据线烧录到 EC-A3588JD4 开发板的存储器中。升级时，需要根据主机操作系统和固件类型来选择合适的升级方式。
...
EC-A3588JD4 整机外壳上没有预留 recovery 按键，所以没有硬件进入 Loader 模式的办法。
#### 软件方式进入Loader模式
...
1. 设备断开电源
2. 用针状物捅住 EC-A3588JD4 上的 MaskRom 触点/孔位并保持
3. 设备插入电源上电

MaskRom 触点/孔位位置如下图所示：

...
<font color=#FF0000>注意：iCore-3576Q38 默认配置是不包含SATA 或PCIe存储设备</font>

## 简介
iCore-3576Q38 开发板上有 1 个 M.2 接口。
...
在 `kernel-6.1/arch/arm64/boot/dts/rockchip/rk3576-firefly-roc-rk3576-pc.dtsi` 中有下面一段配置：
```
#if M2_SATA_OR_PCIE
&sata0 {

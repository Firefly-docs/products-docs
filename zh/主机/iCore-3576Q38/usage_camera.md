...
**目前iCore-3576Q38硬件引出 1 个 DPHY 和 1 个 CPHY 。**

**但目前EXT-iCore-3576Q38硬件只引出 1 个 DPHY。**

## Full Mode 配置

EXT-iCore-3576Q38 有 1 个摄像头接口，他们的配置链路如下：
```
...
```
更新上述文件到对应目录后重启, EXT-iCore-3576Q38 连接网络后查得IP地址.

...
固件包可从 Firefly [下载页面](https://community.t-firefly.com/download/237)获取。
...
* AIBOX-OrinNX 先断电
* 使用 Type-C 数据线连接 AIBOX-OrinNX 的 OTG 口和 PC 端
* 长按 AIBOX-OrinNX 的 Recovery 键
* AIBOX-OrinNX 供电
* 释放 AIBOX-OrinNX 的 Recovery 键

# HDMI-IN 使用  
EC-R3588RT_2G5 有一个 HDMI-IN 接口, 支持标准的 HDMI2.0 协议，它具备以下的特性：  
...
默认 EC-R3588RT_2G5 的 Android 系统中会带有两个 APK ，一个名为 **Live Tv**，另一个名为 **RockchipCamera2**，如下图所示：
![](../../../rk3588_img/common/usage_hdmiin_rk3588_apk.png)  

直接点击 APK 便可进行 HDMI-IN 的视频输入显示，HDMI-IN 的音频输入会从 EC-R3588RT_2G5 的耳机、HDMI、Display Port 等接口输出。

...
![](../../../rk3399_img/EC-R3399PC/camera_mipi_interface.jpg)

* DVP 接口

![](../../../rk3399_img/EC-R3399PC/camera_dvp_interface.jpg)

* `AF_VDD28` 可不做配置。
* `DOVDD18`、`AVDD28` 由 `DVP_PWR` 控制，`DVP_PWR` 对应 RK3399 的 GPIO1_C7：

![](../../../rk3399_img/EC-R3399PC/camera_dvp_pwr.jpg)

 * `DVDD12` 由 `CIF_POWER` 引脚控制，`CIF_POWER` 对应 RK3399 上的 `GPIO1_C6` 引脚：

![](../../../rk3399_img/EC-R3399PC/camera_cif_pwr.jpg)

 * `MIPI CIF`：PWDN0(共用)、PWDN1、RST 对应 GPIO2_B4、GPIO2_D4、GPIO0_B0 引脚：

![](../../../rk3399_img/EC-R3399PC/camera_mipi_cif.jpg)

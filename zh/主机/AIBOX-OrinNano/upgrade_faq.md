...
固件包可从 Firefly [下载页面](https://community.t-firefly.com/download/236)获取。
...
* AIBOX-OrinNano 先断电
* 使用 Type-C 数据线连接 AIBOX-OrinNano 的 OTG 口和 PC 端
* 长按 AIBOX-OrinNano 的 Recovery 键
* AIBOX-OrinNano 供电
* 释放 AIBOX-OrinNano 的 Recovery 键

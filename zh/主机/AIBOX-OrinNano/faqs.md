...
* 烧录过程中会格式化 AIBOX-Orin Nano 内置的存储设备，重要数据请先备份。
...
## AIBOX-Orin Nano 进入烧录模式
* AIBOX-Orin Nano 先断电
* 使用 Type-C 数据线连接 AIBOX-Orin Nano 的 OTG 口和 PC 端
* 长按 AIBOX-Orin Nano 的 Recovery 键
* AIBOX-Orin Nano 供电
* 释放 AIBOX-Orin Nano 的 Recovery 键
* 检查 AIBOX-Orin Nano 是否进入 Recovery 模式
